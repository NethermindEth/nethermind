...
namespace Cortex.BeaconNode
{
    public class BeaconStateAccessor
    {
        ...
        public BeaconStateAccessor(ICryptographyService cryptographyService, BeaconChainUtility beaconChainUtility, IOptionsMonitor<MiscellaneousParameters> miscellaneousParameterOptions, IOptionsMonitor<InitialValues> initialValueOptions, IOptionsMonitor<TimeParameters> timeParameterOptions, IOptionsMonitor<StateListLengths> stateListLengthOptions)
        {
        ...
        /// </summary>
        public Gwei GetTotalBalance(BeaconState state, IList<ValidatorIndex> validatorIndices)
        {
