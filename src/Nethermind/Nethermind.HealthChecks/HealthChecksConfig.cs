...
namespace Nethermind.HealthChecks
{
    public class HealthChecksConfig : IHealthChecksConfig
    {
        ...
        public string WebhooksRestorePayload { get; set; } = "{\"attachments\":[{\"color\":\"#36a64f\",\"pretext\":\"Health Check Status :+1:\",\"fields\":[{\"title\":\"Details\",\"value\":\"More details available at /healthchecks-ui\",\"short\":false},{\"title\":\"description\",\"value\":\"The HealthCheck `[[LIVENESS]]` is recovered. Everything is up and running.\",\"short\":false}]}]}";
