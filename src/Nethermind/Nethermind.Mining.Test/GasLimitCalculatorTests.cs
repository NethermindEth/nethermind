...
namespace Nethermind.Mining.Test
{
    ...
    {
        [TestCase(1000000UL, 2000000L, 1000975UL)]
        [TestCase(1999999UL, 2000000L, 2000000UL)]
        [TestCase(2000000UL, 2000000L, 2000000UL)]
        [TestCase(2000001UL, 2000000L, 2000000UL)]
        [TestCase(3000000UL, 2000000L, 2997072UL)]
