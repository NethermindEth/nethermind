...
public class XdcDirectTrieCopyTest
{
    ...
    {
        var levelDb = new ReadOnlyLevelDb(dbPath);
    ...
    private sealed class SourceContext : IDisposable
    {
        ...
        public SourceContext(IDb db, Hash256 stateRoot, ulong blockNumber)
        {
            Db = db;
            StateRoot = stateRoot;
            BlockNumber = blockNumber;
            TrieStore = new ReadOnlyScopedHashTrieStore(Db);
