...
public class XdcSpecProviderTests
{
    ...
    {
        List<V2ConfigParams> bad = new List<V2ConfigParams>
        {
            new() { SwitchRound = 2000 }
        };

        XdcChainSpecEngineParameters p = new XdcChainSpecEngineParameters();
    ...
    {
        List<V2ConfigParams> dup = new List<V2ConfigParams>
        {
            new() { SwitchRound = 0 },
            new() { SwitchRound = 2000 },
            new() { SwitchRound = 2000 },
    ...
    {
        List<V2ConfigParams> unsorted = new List<V2ConfigParams>
        {
        ...
        XdcChainSpecEngineParameters p = new XdcChainSpecEngineParameters { V2Configs = unsorted };
    ...
    {
        List<V2ConfigParams> v2Configs = new List<V2ConfigParams>
        {
            new() { SwitchRound = 0 },
            new() { SwitchRound = 2000 },
            new() { SwitchRound = 8000 },
