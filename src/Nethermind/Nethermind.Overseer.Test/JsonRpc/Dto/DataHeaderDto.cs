...
namespace Nethermind.Overseer.Test.JsonRpc.Dto
{
    ...
    {
        // Default ID when adding a new data header (otherwise, will fail for null).
        ...
        public DataHeaderRulesDto Rules { get; set; }
        public DataHeaderProviderDto Provider { get; set; }
