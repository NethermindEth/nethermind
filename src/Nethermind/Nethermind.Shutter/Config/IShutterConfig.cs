...
public interface IShutterConfig : IConfig
{
    ...
    [ConfigItem(Description = "The filename to use for the Shutter P2P key. If this not specified, the key is autogenerated in `shutter.key.plain` file.", IsSensitive = true)]
