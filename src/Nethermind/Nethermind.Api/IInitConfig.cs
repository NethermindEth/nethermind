...
namespace Nethermind.Api
{
    public interface IInitConfig : IConfig
    {
        ...
        [ConfigItem(Description = "[TECHNICAL] Specify the interval to trigger GC.collect(). Generally not recommended, but might help some scenario.", DefaultValue = "null")]
        long? TriggerGCIntervalSec { get; set; }
