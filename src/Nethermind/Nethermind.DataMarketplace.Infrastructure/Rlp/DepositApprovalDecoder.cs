...
namespace Nethermind.DataMarketplace.Infrastructure.Rlp
{
    public class DepositApprovalDecoder : IRlpDecoder<DepositApproval>
    {
        ...
        {
            Nethermind.Core.Serialization.Rlp.Decoders[typeof(DepositApproval)] = new DepositApprovalDecoder();
        }
        ...
        public Nethermind.Core.Serialization.Rlp Encode(DepositApproval item, RlpBehaviors rlpBehaviors = RlpBehaviors.None)
        {
            if (item == null)
            {
            ...
            return Nethermind.Core.Serialization.Rlp.Encode(
                ...
                Nethermind.Core.Serialization.Rlp.Encode(item.AssetId),
                Nethermind.Core.Serialization.Rlp.Encode(item.AssetName),
