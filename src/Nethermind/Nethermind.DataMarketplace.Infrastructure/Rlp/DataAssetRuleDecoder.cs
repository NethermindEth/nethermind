...
namespace Nethermind.DataMarketplace.Infrastructure.Rlp
{
    public class DataAssetRuleDecoder : IRlpDecoder<DataAssetRule>
    {
        ...
        {
            Nethermind.Core.Serialization.Rlp.Decoders[typeof(DataAssetRule)] = new DataAssetRuleDecoder();
        }
        ...
        public Nethermind.Core.Serialization.Rlp Encode(DataAssetRule item, RlpBehaviors rlpBehaviors = RlpBehaviors.None)
        {
            if (item == null)
            {
