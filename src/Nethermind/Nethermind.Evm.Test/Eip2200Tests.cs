...
namespace Nethermind.Evm.Test
{
    ...
    public class Eip2200Tests : VirtualMachineTestsBase
    {
        ...
        [TestCase("0x60006000556000600055", 1612UL, 0, 2300, true)]
        [TestCase("0x60016000556000600055", 20812UL, 0, 2300, true)]
        [TestCase("0x60016000556002600055", 20812UL, 0, 2300, true)]
        [TestCase("0x60016000556001600055", 20812UL, 0, 2300, true)]
        [TestCase("0x60006000556000600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60006000556001600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60026000556000600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60026000556003600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60026000556001600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60026000556002600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60016000556001600055", 1612UL, 1, 2300, true)]
        [TestCase("0x60006000556002600055", 5812UL, 1, 2300, true)]
        [TestCase("0x60016000556000600055", 5812UL, 1, 2300, false)]
        [TestCase("0x60016000556002600055", 5812UL, 1, 2300, false)]
        [TestCase("0x600160005560006000556001600055", 40818UL, 0, 2300, false)]
        [TestCase("0x600060005560016000556000600055", 10818UL, 1, 2300, false)]
        [TestCase("0x60006000556001600055", 20812UL, 0, 2300, false)]
        [TestCase("0x60006000556000600055", 1612UL, 0, 2301, false)]
        [TestCase("0x60016000556001600055", 1612UL, 1, 2301, false)]
        [TestCase("0x60006000556000600055", 1612UL, 0, 2299, true)]
        [TestCase("0x60016000556001600055", 1612UL, 1, 2299, true)]
        public void Test_at_stipend_boundary(string codeHex, ulong gasUsed, byte originalValue, int stipend, bool outOfGasExpected)
        {
            SetupStorage(originalValue);
            TestAllTracerWithOutput receipt = Execute(BlockNumber, 21000 + gasUsed + (ulong)(stipend - 800), Bytes.FromHexString(codeHex));
