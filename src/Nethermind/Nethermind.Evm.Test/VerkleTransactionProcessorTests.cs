...
namespace Nethermind.Evm.Test
{
    ...
    public class VerkleTransactionProcessorTests
    {
        ...
        public VerkleTransactionProcessorTests(bool eip155Enabled)
        {
        ...
        {
            MemDb stateDb = new();
            VerkleStateProvider stateProvider = new(LimboLogs.Instance, new MemDb());
