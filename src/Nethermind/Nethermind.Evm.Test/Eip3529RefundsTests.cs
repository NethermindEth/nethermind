...
namespace Nethermind.Evm.Test
{
    ...
    public class Eip3529Tests : VirtualMachineTestsBase
    {
        ...
        public void After_3529_self_destruct_has_zero_refund(bool eip3529Enabled)
        {
            ...
            _processor.Execute(tx0, new BlockExecutionContext(block.Header, SpecProvider.GetSpec(block.Header)), tracer0);
            ...
            tracer = CreateTracer();
            _processor.Execute(tx3, new BlockExecutionContext(block.Header, SpecProvider.GetSpec(block.Header)), tracer);
