...
public class FrameGasEstimatorTests
{
    ...
    public void EstimateFrameGas_KeepsEveryProbeWithinTheWorkBound()
    {
        ...
        Result<TxFrame[]> result = estimator.EstimateFrameGas(tx, new BlockExecutionContext(header, Eip8141Prototype.Instance), fill, fill, GasCap, 150, CancellationToken.None, out _);
