...
namespace Nethermind.Evm.Test.Tracing
{
    ...
    public class GasEstimationTests
    {
        ...
        public void Does_not_take_into_account_precompiles()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(0);
        }
        ...
        public void Handles_well_serial_calls()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(14L);
        }
        ...
        public void Handles_well_errors()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(24L);
        }
        ...
        public void Handles_well_revert()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(35146L);
        }
        ...
        public void Easy_one_level_case()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(1);
        }
        ...
        public void Handles_well_nested_calls_where_most_nested_defines_excess()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(18);
        }
        ...
        public void Handles_well_nested_calls_where_least_nested_defines_excess()
        {
            ...
            testEnvironment.estimator.Estimate(testEnvironment._stateProvider, tx, block.Header, testEnvironment.tracer).Should().Be(17);
        }
        ...
        public void Estimate_UseErrorMarginOutsideBounds_ThrowArgumentOutOfRangeException(int errorMargin)
        {
            ...
            Assert.That(() => sut.Estimate(stateProvider, tx, block.Header, tracer, errorMargin), Throws.TypeOf<ArgumentOutOfRangeException>());
        }
        ...
        public void Estimate_UseErrorMargin_EstimationResultIsNotExact()
        {
            ...
            long result = sut.Estimate(stateProvider, tx, block.Header, tracer, GasEstimator.DefaultErrorMargin);
        ...
        public void Estimate_UseZeroErrorMargin_EstimationResultIsExact()
        {
            ...
            long result = sut.Estimate(stateProvider, tx, block.Header, tracer, 0);
        ...
        private class TestEnvironment
        {
            ...
            public TestEnvironment()
            {
                ...
                estimator = new(_transactionProcessor, _specProvider, blocksConfig);
            }
        }
    }
}
