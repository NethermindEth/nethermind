...
public class L1SloadPrecompileTests
{
    ...
    public void DataGasCost_With_Invalid_Input_Length_Should_Return_0()
    {
        ...
        // Input too long
        var expectedLength = L1SloadConstants.ExpectedInputLength;
    ...
    {
        var input = CreateValidInput(Address.FromNumber(123), (UInt256)1);
    ...
    private static byte[] CreateValidInput(Address contractAddress, UInt256 storageKey)
    {
        var input = new byte[L1SloadConstants.ExpectedInputLength];
    ...
    private sealed class MockL1StorageProvider : IL1StorageProvider
    {
        ...
        public UInt256? GetStorageValue(Address contractAddress, UInt256 storageKey) => _returnValue;
