...
public class StreamGasFuzzTests : VirtualMachineTestsBase
{
    ...
    private static byte[] Generate(int seed)
    {
        ...
        // A leading counter lets generated loops decrement toward zero instead of spinning.
        ...
        for (int i = 0; i < slots; i++)
        {
            switch (random.Next(12))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    code.AddRange([(byte)Instruction.DUP1, (byte)Instruction.POP]);
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    code.AddRange([(byte)Instruction.PUSH1, 0x01, (byte)Instruction.SWAP1, (byte)Instruction.SUB]);
                    break;
                case 8:
