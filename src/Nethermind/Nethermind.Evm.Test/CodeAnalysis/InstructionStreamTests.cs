    ...
    public void TryBuild_StraightLineArithmetic_SumsTheBlockGasOnce()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(stream.Ops[0].Opcode, Is.EqualTo((byte)Instruction.PUSH32),
                "two const pushes feeding ADD fold into a single pooled push at analysis");
            ...
            Assert.That(stream.Ops, Has.Length.EqualTo(2), "one folded push and the STOP boundary");
