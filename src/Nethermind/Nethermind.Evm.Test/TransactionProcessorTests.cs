...
public class TransactionProcessorTests
{
    ...
    public void Can_estimate_with_refund()
    {
        ...
        var staticGas = IntrinsicGasCalculator.Calculate(tx, MuirGlacier.Instance);
        ...
        actualIntrinsic.Should().Be(staticGas.IntrinsicGas);
    ...
    public void Can_estimate_with_destroy_refund_and_below_intrinsic_pre_berlin()
    {
        ...
        var staticGas = IntrinsicGasCalculator.Calculate(tx, releaseSpec);
