    ...
    public class TransactionProcessorTests
    {
        ...
        public void Can_process_simple_transaction(bool withStateDiff, bool withTrace)
        {
         ...
         public void Can_estimate_simple()
         {
             ...
             tracer.CalculateEstimate(tx, block.Header, _stateProvider, (UInt256)gasLimit, _transactionProcessor, _releaseSpec).Should().Be(21000);
         }
         ...
         public void Can_estimate_with_refund()
         {
             ...
             long estimate = tracer.CalculateEstimate(tx, block.Header, _stateProvider, (UInt256)gasLimit, _transactionProcessor, _releaseSpec);
