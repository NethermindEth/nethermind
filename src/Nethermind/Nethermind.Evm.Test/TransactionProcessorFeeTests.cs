...
public class TransactionProcessorFeeTests
{
    ...
    public void Should_stop_when_cancellation(bool withCancellation)
    {
        ...
        blockTracer.StartNewBlockTrace(block);
        {
            ...
            _transactionProcessor.Execute(tx1, new BlockExecutionContext(block.Header), txTracer);
        ...
        try
        {
            ...
            _transactionProcessor.Execute(tx2, new BlockExecutionContext(block.Header), txTracer);
            blockTracer.EndTxTrace();
    ...
    private void ExecuteAndTrace(Block block, IBlockTracer otherTracer)
    {
        ...
        foreach (Transaction tx in block.Transactions)
        {
            ...
            _transactionProcessor.Execute(tx, new BlockExecutionContext(block.Header), txTracer);
            tracer.EndTxTrace();
        }
