...
namespace Nethermind.Evm.Test
{
    ...
    public class StorageAndSelfDestructTests : VirtualMachineTestsBase
    {
        ...
        public void Load_self_destruct()
        {
            ...
            _processor.Execute(initTx, new BlockExecutionContext(block.Header), initTracer);
            ...
            _processor.Execute(tx1, new BlockExecutionContext(block.Header), tracer1);
            ...
            _processor.Execute(tx2, new BlockExecutionContext(block.Header), tracer2);
            AssertStorage(new StorageCell(contractAddress, 1), 0);
        }
        ...
        public void Destroy_restore_store()
        {
            ...
            _processor.Execute(tx0, new BlockExecutionContext(block.Header), tracer0);
            ...
            _processor.Execute(tx1, new BlockExecutionContext(block.Header), tracer);
            // AssertStorage(new StorageCell(deploymentAddress, 1), 0);
            ...
            _processor.Execute(tx2, new BlockExecutionContext(block.Header), tracer);
            ...
            _processor.Execute(tx3, new BlockExecutionContext(block.Header), tracer);
            // AssertStorage(new StorageCell(deploymentAddress, 1), 0);
            ...
            _processor.Execute(tx4, new BlockExecutionContext(block.Header), tracer);
            // AssertStorage(new StorageCell(deploymentAddress, 1), 0);
            // AssertStorage(new StorageCell(deploymentAddress, 2), 2);

            tracer = new ParityLikeTxTracer(block, tx5, ParityTraceTypes.Trace | ParityTraceTypes.StateDiff);
            _processor.Execute(tx5, new BlockExecutionContext(block.Header), tracer);
            AssertStorage(new StorageCell(deploymentAddress, 1), 1);
            AssertStorage(new StorageCell(deploymentAddress, 2), 2);
        }
        ...
        public void Destroy_restore_store_different_cells_previously_existing()
        {
            ...
            _processor.Execute(tx0, new BlockExecutionContext(block.Header), tracer);
