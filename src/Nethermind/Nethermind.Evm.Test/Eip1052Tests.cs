...
{
    protected override ulong BlockNumber => 10000001;
    ...
    public void Empty_account_that_would_be_cleared_returns_zero()
    {
        ...
        Assert.That(TestState.AccountExists(TestItem.AddressC), Is.False, "did not test the right thing - it was not an empty account + touch scenario");
    }
    ...
    public void Newly_created_empty_account_returns_empty_data_hash()
    {
        ...
        Assert.That(TestState.AccountExists(ContractAddress.From(Recipient, 0)), Is.True,
