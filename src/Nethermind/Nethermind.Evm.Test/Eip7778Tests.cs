...
public class Eip7778Tests : VirtualMachineTestsBase
{
    ...
    private static TestSpecProvider CreateSpecProvider()
    {
        ...
        OverridableReleaseSpec eip7778Spec = new OverridableReleaseSpec(London.Instance) { IsEip7778Enabled = true };
        TestSpecProvider provider = new TestSpecProvider(London.Instance)
        {
    ...
    public void Block_gas_uses_calldata_floor_when_execution_gas_is_lower()
    {
        ...
        OverridableReleaseSpec eip7778And7623Spec = new OverridableReleaseSpec(London.Instance)
        {
        ...
        EthereumTransactionProcessor processor = new EthereumTransactionProcessor(BlobBaseFeeCalculator.Instance, provider, TestState, Machine, CodeInfoRepository, LimboLogs.Instance);
