...
public class TransitionTests
{
    ...
    public void SetUp()
    {
        ...
        _merkleReader = new(merkleStore, _codeDb, Logger);
        _merkleState = new(merkleStore, _codeDb, Logger);
    }
    ...
    public void TestProperSequenceOfReads()
    {
        ...
        var transitionWorldState = new TransitionWorldState(
            _merkleReader, _merkleState.StateRoot, verkleTree, _codeDb, _preImageDb,
            Logger);
