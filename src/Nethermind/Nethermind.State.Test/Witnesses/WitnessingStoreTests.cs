...
namespace Nethermind.Store.Test.Witnesses
{
    ...
    public class WitnessingStoreTests
    {
        ...
        private static readonly byte[] Key1 = TestItem.KeccakA.Bytes.ToArray();

        private static readonly byte[] Key2 = TestItem.KeccakB.Bytes.ToArray();

        private static readonly byte[] Key3 = TestItem.KeccakC.Bytes.ToArray();
