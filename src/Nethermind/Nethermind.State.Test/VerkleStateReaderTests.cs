...
//     public class VerkleStateReaderTests
//     {
...
//             VerkleTrieStore verkleTrieStore =
//                 new (DatabaseScheme.MemoryDb, CommitScheme.TestCommitment, Logger);
//             VerkleStateProvider provider =
//                 new(verkleTrieStore, Logger, Substitute.For<IDb>());
...
//             provider.CommitTree(0);
//
//             VerkleStateReader reader =
//                 new(verkleTrieStore, Substitute.For<IDb>(), Logger);
//
...
//                 new (DatabaseScheme.MemoryDb, CommitScheme.TestCommitment, Logger);
//             VerkleStateProvider provider =
//                 new(verkleTrieStore, Logger, new MemDb());
//             VerkleStorageProvider storageProvider = new(provider, Logger);
//
...
//         }
//
//         private Task StartTask(VerkleStateReader reader, Keccak stateRoot, UInt256 value)
//         {
//             return Task.Run(
//                 () =>
//                 {
...
//         }
//
//         private Task StartStorageTask(VerkleStateReader reader, Keccak stateRoot, StorageCell storageCell, byte[] value)
//         {
//             return Task.Run(
//                 () =>
//                 {
...
//             VerkleTrieStore verkleTrieStore =
//                 new (DatabaseScheme.MemoryDb, CommitScheme.TestCommitment, Logger);
//             VerkleStateProvider state =
//                 new(verkleTrieStore, Logger, dbProvider.CodeDb);
//             VerkleStorageProvider storage = new(state, Logger);
//
...
//             state.CommitTree(2);
//
//             VerkleStateReader reader = new(
//                 verkleTrieStore, dbProvider.CodeDb, Logger);
//
...
//             
//             VerkleStateProvider processorStateProvider =
//                 new(verkleTrieStore, Logger, dbProvider.CodeDb);
//             processorStateProvider.StateRoot = state.StateRoot;
//             VerkleStorageProvider processorStorageProvider = new(processorStateProvider, Logger);
//
