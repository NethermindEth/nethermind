...
namespace Nethermind.Store.Test
{
    ...
    public class StateReaderTests
    {
        ...
        public async Task Can_ask_about_balance_in_parallel()
        {
            ...
            IWorldStateManager worldStateManager = TestWorldStateFactory.CreateForTest(TestMemDbProvider.Init(), LimboLogs.Instance);
        ...
        public async Task Can_ask_about_storage_in_parallel()
        {
            ...
            IWorldStateManager worldStateManager = TestWorldStateFactory.CreateForTest(dbProvider, Logger);
            IWorldState provider = worldStateManager.GlobalWorldState;
