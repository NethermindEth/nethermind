...
public class VerkleTreeTests
{
    ...
    public void TestHiveState()
    {
        ...
        worldState.IncrementNonce(address2, 1);
        ...
        tree.Set(address1, new Account(0, 1, 0, 0, Keccak.EmptyTreeHash, new Hash256("0xdf61faef43babbb1ebde8fd82ab9cb4cb74c240d0025138521477e073f72080a")));
        tree.Commit();
