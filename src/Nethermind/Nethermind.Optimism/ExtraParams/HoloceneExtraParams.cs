...
public readonly struct HoloceneExtraParams
{
    public const int BinaryLength = 9;
    ...
    public static bool TryParse(BlockHeader header, out HoloceneExtraParams parameters, [NotNullWhen(false)] out string? error)
    {
        error = null;
        parameters = default;
    ...
    public static bool TryParse(OptimismPayloadAttributes payloadAttributes, out HoloceneExtraParams parameters, [NotNullWhen(false)] out string? error)
    {
        error = null;
        parameters = default;
