...
namespace Nethermind.Runner.Ethereum.Steps
{
    ...
    public class InitializeBlockchain : IStep
    {
        ...
        private Task InitBlockchain()
        {
            ...
            ThisNodeInfo.AddInfo("Trie mem est :", $"{Trie.MemoryAllowance.TrieNodeCacheSize * 400 / 1024 / 1204}MB");
            ThisNodeInfo.AddInfo("Pool mem est :", $"{(TxPool.MemoryAllowance.TxHashCacheSize * 64 + TxPool.MemoryAllowance.MemPoolSize * 4096) / 1024 / 1204}MB");
