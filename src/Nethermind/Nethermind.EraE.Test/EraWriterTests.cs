...
internal class EraWriterTests
{
    ...
    public async Task Add_FinalizedCalled_ThrowsException()
    {
        ...
        Assert.That(async () => await sut.Add(block, Array.Empty<TxReceipt>()), Throws.TypeOf<Era1.EraException>());
    }
    ...
    public void Finalize_NoBlocksAdded_ThrowsException()
    {
        ...
        Assert.That(async () => await sut.Finalize(), Throws.TypeOf<Era1.EraException>());
    }
