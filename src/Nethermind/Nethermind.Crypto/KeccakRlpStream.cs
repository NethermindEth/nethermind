...
namespace Nethermind.Crypto
{
    ...
    public readonly struct KeccakRlpStream
    {
        ...
        {
            ValueRlpWriter<IValueRlpWriteBackend.KeccakBackend> writer = AsValueWriter();
        ...
        public ValueRlpWriter<IValueRlpWriteBackend.KeccakBackend> AsValueWriter() => RlpWriter.ForKeccak(Hash);
    }
}
