...
public class WorldStateManager : IWorldStateManager
{
    ...
    private readonly IParentHeaderProvider _parentHeaderProvider;
    ...
    )
    {
        ...
        _parentHeaderProvider = parentHeaderProvider;
        ...
        SnapStateServer = trieStore.Scheme == INodeStorage.KeyScheme.Hash
            ...
            : new SnapStateServer(_readOnlyTrieStore, _logManager, _lastNStateRootTracker);
    }
    ...
    public IWorldStateScopeProvider CreateResettableWorldState() => new TrieStoreScopeProvider(_readOnlyTrieStore, _readaOnlyCodeCb, _parentHeaderProvider, _logManager);

    public IReadOnlyTrieStore CreateReadOnlyTrieStore() => _readOnlyTrieStore;

    public IOverridableWorldScope CreateOverridableWorldScope() => new OverridableWorldStateManager(_dbProvider, _readOnlyTrieStore, _parentHeaderProvider, _logManager);
