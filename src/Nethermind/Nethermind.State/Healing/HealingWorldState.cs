...
public class HealingWorldState(ITrieStore trieStore, INodeStorage nodeStorage, IKeyValueStore? codeDb, ILogManager? logManager, PreBlockCaches? preBlockCaches = null, bool populatePreBlockCache = true)
