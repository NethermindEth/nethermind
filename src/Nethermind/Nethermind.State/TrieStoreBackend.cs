...
public class TrieStoreBackend : IWorldStateBackend
{
    ...
    public IWorldStateBackend.IScope BeginScope(BlockHeader? baseBlock)
    {
        ...
        return new TrieStoreWorldStateBackendScope(_backingStateTree, this);
    }
    ...
    private class TrieStoreWorldStateBackendScope(StateTree backingStateTree, TrieStoreBackend backend) : IWorldStateBackend.IScope
    {
        public void Dispose()
        {
            backend.Reset();
