...
namespace Nethermind.State
{
    public class StateProvider
    {
        ...
        protected bool _needsStateRootUpdate;
        ...
        protected void RecreateAsEmpty(Address address)
        {
            _needsStateRootUpdate = true;
        ...
        protected bool HasIntraTxChanges(Address address) => _intraTxCache.ContainsKey(address);
        ...
        protected void PushRecreateEmpty(Address address, Account account, StackList<int> stack)
        {
            stack.Push(_changes.Count);
            _changes.Add(new Change(address, account, ChangeType.RecreateEmpty));
        }

        protected StackList<int> SetupCache(Address address)
        {
