...
public class PreBlockCaches
{
    ...
    private readonly ConcurrentDictionary<Box<Address>, Account> _stateCache = new(LockPartitions, InitialCapacity);
    ...
    public ConcurrentDictionary<Box<Address>, Account> StateCache => _stateCache;
