...
namespace Nethermind.State
{
    public static class StateReaderExtensions
    {
        ...
        public static TrieStats CollectStats(this IStateReader stateProvider, Hash256 root, IKeyValueStore codeStorage, ILogManager logManager, CancellationToken cancellationToken = default, ProgressLogger? progressLogger = null)
        {
            TrieStatsCollector collector = new(codeStorage, logManager, cancellationToken, progressLogger);
