...
public class VerkleSyncFeedTests
{
    ...
    public void WhenAccountRequestEmpty_ReturnNoProgress()
    {
        ...
        Synchronization.VerkleSync.VerkleSyncFeed feed = new(verkleProvider, LimboLogs.Instance);
        ...
        response.SubTreeRangeRequest = new SubTreeRange(Hash256.Zero, Stem.Zero.Bytes);
