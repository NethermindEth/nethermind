...
public class RecreateStateFromAccountRangesTests
{
    ...
    public void Test01()
    {
        ...
        MemDb db = new();
        RawTrieStore fullStore = new RawTrieStore(db);
    ...
    public void CorrectlyDetermineHasMoreChildren()
    {
        ...
        StateTree newTree = new(new RawTrieStore(new MemDb()), LimboLogs.Instance);
    ...
    {
        StateTree tree = new StateTree(new RawTrieStore(new MemDb()), LimboLogs.Instance);
