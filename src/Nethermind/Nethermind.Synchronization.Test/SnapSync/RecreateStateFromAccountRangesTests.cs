...
public class RecreateStateFromAccountRangesTests
{
    ...
    public void Test01()
    {
        ...
        MemDb db = new();
        TrieStore fullStore = TrieStore.ForTest(db, LimboLogs.Instance);
    ...
    public void CorrectlyDetermineHasMoreChildren()
    {
        ...
        StateTree newTree = new(TrieStore.ForTest(new MemDb(), LimboLogs.Instance), LimboLogs.Instance);
    ...
    {
        StateTree tree = new StateTree(TrieStore.ForTest(new MemDb(), LimboLogs.Instance), LimboLogs.Instance);
