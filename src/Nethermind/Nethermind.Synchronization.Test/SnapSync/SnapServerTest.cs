...
public class SnapServerTest
{
    ...
    private Context CreateContext(ILastNStateRootTracker? stateRootTracker = null)
    {
        ...
        using ProgressTracker progressTracker = new(null!, clientStateDb, stateFactory, LimboLogs.Instance);
    ...
    public void TestGetStorageRange()
    {
        ...
        IStateFactory stateFactory = new PaprikaStateFactory();
        using ProgressTracker progressTracker = new(null!, dbProviderClient.StateDb, stateFactory, LimboLogs.Instance);
