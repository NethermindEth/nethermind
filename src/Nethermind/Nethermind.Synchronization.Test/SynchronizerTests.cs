        ...
        public class SyncingContext
        {
            ...
            public SyncingContext(SynchronizerType synchronizerType)
            {
                ...
                BlockTree = new BlockTree(new MemDb(), new MemDb(), blockInfoDb,
                    ...
                    new SingleReleaseSpecProvider(Constantinople.Instance, TestBlockchainIds.NetworkId, TestBlockchainIds.ChainId), NullBloomStorage.Instance, _logManager);
                ...
                PoSSwitcher poSSwitcher = new(mergeConfig, syncConfig, dbProvider.MetadataDb, BlockTree, new SingleReleaseSpecProvider(Constantinople.Instance, TestBlockchainIds.NetworkId, TestBlockchainIds.ChainId), _logManager);
