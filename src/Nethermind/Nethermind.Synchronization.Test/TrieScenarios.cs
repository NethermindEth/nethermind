...
//                    SetStorage(stateDb);
        ...
        private static void SetStorage(StateTree stateTree, ITrieStore trieStore, ValueHash256 address, Account account)
        {
