            ...
            public class ScenarioBuilder
            {
                ...
                public void TheSyncModeShouldBe(SyncMode syncMode)
                {
                    void Test()
                    {
                        ...
                        MultiSyncModeSelector selector = new(SyncProgressResolver, SyncPeerPool, SyncConfig, BeaconSyncStrategy, bestPeerStrategy, Build.A.BlockTree().WithSyncConfig(SyncConfig).TestObject, LimboLogs.Instance);
                        selector.Stop();
                        selector.Update();
