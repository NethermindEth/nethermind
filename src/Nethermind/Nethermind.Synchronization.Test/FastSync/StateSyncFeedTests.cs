...
namespace Nethermind.Synchronization.Test.FastSync
{
    ...
    public class StateSyncFeedTests : StateSyncFeedTestsBase
    {
        ...
        public async Task Big_test((string Name, Action<StateTree, ITrieStore, IDb> SetupTree) testCase)
        {
            ...
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code0).Span] = TrieScenarios.Code0;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code1).Span] = TrieScenarios.Code1;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code2).Span] = TrieScenarios.Code2;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code3).Span] = TrieScenarios.Code3;
