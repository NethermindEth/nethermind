...
namespace Nethermind.Synchronization.Test.FastSync
{
    ...
    public class StateSyncFeedTests
    {
        ...
        private SafeContext PrepareDownloader(DbContext dbContext, ISyncPeer syncPeer)
        {
            ...
            ctx.Pool = new SyncPeerPool(blockTree, new NodeStatsManager(timerFactory, LimboLogs.Instance), new TotalDifficultyBasedBetterPeersStrategy(null, LimboLogs.Instance), 25, LimboLogs.Instance);
            ctx.Pool.Start();
