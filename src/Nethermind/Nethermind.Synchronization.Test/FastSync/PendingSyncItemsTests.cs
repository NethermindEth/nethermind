...
namespace Nethermind.Synchronization.Test.FastSync
{
    ...
    public class PendingSyncItemsTests
    {
        ...
        {
            IPendingSyncItems items = Init();
            StateSyncItem stateSyncItem = new(Commitment.Zero, null, null, NodeDataType.State);
        ...
        {
            StateSyncItem stateSyncItem1 = new(Commitment.Zero, null, null, nodeDataType, level, rightness);
