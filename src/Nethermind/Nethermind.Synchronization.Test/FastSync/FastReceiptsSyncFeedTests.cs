...
namespace Nethermind.Synchronization.Test.FastSync
{
    ...
    public class FastReceiptsSyncFeedTests
    {
        ...
        private SimpleReceiptsSyncFeed _feed;
        ...
        public void Setup()
        {
            ...
            _feed = new SimpleReceiptsSyncFeed(
                _selector,
                _specProvider,
                _blockTree,
                _receiptStorage,
        ...
        public void Returns_same_batch_until_filled()
        {
            ...
            SimpleReceiptsSyncBatch request2 = _feed.PrepareRequest().Result;
        ...
        public void Can_create_receipts_batches_for_all_bodies_inserted_and_then_generate_null_batches_for_other_peers()
        {
            ...
            List<SimpleReceiptsSyncBatch> batches = new List<SimpleReceiptsSyncBatch>();
            for (int i = 0; i < 100; i++)
            {
        ...
        public void If_comes_back_empty_then_it_can_be_reused()
        {
            ...
            SimpleReceiptsSyncBatch batch = _feed.PrepareRequest().Result;
            ...
            SimpleReceiptsSyncBatch batch2 = _feed.PrepareRequest().Result;
        ...
        public void If_only_one_valid_item_comes_back_then_we_create_a_filler_batch()
        {
            ...
            SimpleReceiptsSyncBatch batch2 = _feed.PrepareRequest().Result;
            batch2.Infos.Length.Should().Be(batch.Infos.Length - 1);
        }
        ...
        public void Can_have_many_dependent_batches()
        {
            ...
            SimpleReceiptsSyncBatch batch = _feed.PrepareRequest().Result;
            SimpleReceiptsSyncBatch batch2 = _feed.PrepareRequest().Result;
            SimpleReceiptsSyncBatch batch3 = _feed.PrepareRequest().Result;
