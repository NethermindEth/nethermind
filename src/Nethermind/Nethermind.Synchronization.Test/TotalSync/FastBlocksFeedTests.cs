...
//         private FastHeadersSyncFeed _feed;
//         private long _time;
...
//
//             _feed = new FastHeadersSyncFeed(_localBlockTree, _syncPeerPool, _syncConfig, NullSyncReport.Instance, LimboLogs.Instance);
//         }
//
//         [Test]
//         public async Task One_peer_with_valid_chain_bodies_restarting()
//         {
...
//
//         [Test]
//         public async Task One_peer_with_valid_chain_bodies()
//         {
//             LatencySyncPeerMock syncPeer = new LatencySyncPeerMock(_validTree2048);
//             SetupFeed(true);
//             SetupSyncPeers(syncPeer);
...
//
//         [Test]
//         public async Task One_peer_with_valid_chain()
//         {
//             LatencySyncPeerMock syncPeer = new LatencySyncPeerMock(_validTree2048);
//             SetupSyncPeers(syncPeer);
//             await RunFeed();
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain_bodies()
//         {
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             SetupSyncPeers(syncPeer1, syncPeer2);
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain_and_various_max_response_sizes_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             SetupFeed(true);
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain_and_various_max_response_sizes()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _peerMaxResponseSizes[syncPeer1] = 100;
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_repetition()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_invalid_txs()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_invalid_ommers()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_short_at_start()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_short_at_start_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _maliciousByShortAtStart.Add(syncPeer1);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_shift_forward()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_shift_forward_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _maliciousByShiftedOneForward.Add(syncPeer1);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_shift_back()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_malicious_by_shift_back_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _maliciousByShiftedOneBack.Add(syncPeer1);
...
//
//         [Test]
//         public async Task Two_peers_one_sending_too_short_messages()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_sending_too_short_messages_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _incorrectByTooShortMessages.Add(syncPeer1);
...
//
//         [Test]
//         public async Task Two_peers_one_sending_too_long_messages()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_sending_too_long_messages_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _incorrectByTooLongMessages.Add(syncPeer1);
...
//
//         [Test]
//         public async Task Two_peers_one_timing_out()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_one_timing_out_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             _timingOut.Add(syncPeer1);
...
//
//         [Test]
//         public async Task One_peer_with_valid_one_with_invalid_A()
//         {
...
//
//         [Test]
//         public async Task One_peer_with_valid_one_with_invalid_A_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_badTreeAfter1024);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048, 300);
//             SetupFeed(true);
...
//
//         [Test]
//         public async Task One_peer_with_valid_one_with_invalid_B()
//         {
...
//
//         [Test]
//         public async Task One_peer_with_valid_one_with_invalid_B_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048, 300);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_badTreeAfter1024);
//             SetupFeed(true);
...
//         public async Task Two_valid_one_slower_with_bodies_and_one_restart()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048, 300);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             SetupFeed(true);
...
//
//             await RunFeed();
//             Assert.AreEqual(301, _time);
//
//             AssertTreeSynced(_validTree2048, true);
//         }
//
//         [Test(Description = "Test if receipt dependencies are handled correctly")]
//         public async Task Two_valid_one_slower_with_receipts_and_one_restart()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048, 300);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             SetupFeed(true, true);
...
//
//             Assert.Throws<AggregateException>(() => RunFeed(1000).Wait());
//         }
//
//         [Test]
//         public async Task Receipts_finish_properly_when_the_last_batch_has_no_receipts()
//         {
//             _syncConfig = new SyncConfig();
...
//
//         [Test]
//         public async Task One_valid_one_malicious_with_receipts_and_one_restart()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048, 300);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree2048);
//             SetupFeed(true, true);
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain_one_shorter()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
...
//
//         [Test]
//         public async Task Two_peers_with_valid_chain_one_shorter_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree1024);
//             SetupSyncPeers(syncPeer1, syncPeer2);
...
//
//         [Test]
//         public async Task Short_chain_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             LatencySyncPeerMock syncPeer2 = new LatencySyncPeerMock(_validTree1024);
//             SetupSyncPeers(syncPeer1, syncPeer2);
...
//
//         [Test]
//         public async Task Shorter_responses()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             SetupSyncPeers(syncPeer1);
//
...
//
//         [Test]
//         public async Task Shorter_responses_bodies()
//         {
//             LatencySyncPeerMock syncPeer1 = new LatencySyncPeerMock(_validTree2048);
//             SetupSyncPeers(syncPeer1);
//             SetupFeed(true);
...
//         }
//
//         private async Task RunFeed(int timeLimit = 5000, int restartEvery = 100000)
//         {
//             _feed.Activate();
//             while (true)
//             {
...
//                 {
//                     FastBlocksBatch batch = await _feed.PrepareRequest();
...
//
//             switch (responseBatch)
//             {
//                 case HeadersSyncBatch headersSyncBatch:
//                     PrepareHeadersResponse(headersSyncBatch, syncPeer, tree);
//                     break;
//                 case BodiesSyncBatch bodiesSyncBatch:
//                     PrepareBodiesResponse(bodiesSyncBatch, syncPeer, tree);
//                     break;
//                 case ReceiptsSyncBatch receiptsSyncBatch:
//                     PrepareReceiptsResponse(receiptsSyncBatch, syncPeer, tree);
//                     break;
//                 default:
