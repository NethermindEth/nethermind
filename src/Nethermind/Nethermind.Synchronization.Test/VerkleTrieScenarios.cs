...
public class VerkleTrieScenarios
{
    ...
    private static (string Name, Action<VerkleStateTree, IVerkleTreeStore, IDb> Action)[]? _scenarios;

    public static (string Name, Action<VerkleStateTree, IVerkleTreeStore, IDb> Action)[] Scenarios
        => LazyInitializer.EnsureInitialized(ref _scenarios, InitScenarios);

    private static (string Name, Action<VerkleStateTree, IVerkleTreeStore, IDb> Action)[] InitScenarios()
    {
        return new (string, Action<VerkleStateTree, IVerkleTreeStore, IDb>)[]
        {
            ...
            {
                codeDb[Keccak.Compute(Code0).Bytes] = Code0;
                Hash256 account1 = new("1baaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                Hash256 account2 = new("2baaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
            ...
            {
                Hash256 account1 = new("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeb00000000");
                Hash256 account2 = new("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeb11111111");
                Hash256 account3 = new("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeedddddddddddddddddddddddd");
                tree.InsertStemBatch(account1.Bytes[..31], AccountJustState0.ToVerkleDict());
