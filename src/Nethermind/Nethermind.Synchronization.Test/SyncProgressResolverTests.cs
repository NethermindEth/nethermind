...
namespace Nethermind.Synchronization.Test
{
    ...
    public class SyncProgressResolverTests
    {
        ...
        public void Header_block_is_0_when_no_header_was_suggested()
        {
            ...
            SyncProgressResolver syncProgressResolver = new(blockTree, receiptStorage, stateDb, NullTrieNodeResolver.Instance, null, syncConfig, LimboLogs.Instance);
        ...
        public void Is_fast_block_receipts_finished_returns_false_when_receipts_not_downloaded()
        {
            ...
            SyncProgressResolver syncProgressResolver = new(
                blockTree, receiptStorage, stateDb, NullTrieNodeResolver.Instance, null, syncConfig, LimboLogs.Instance);
