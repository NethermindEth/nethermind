...
namespace Nethermind.BeaconNode.Tests.MockedStart
{
    ...
    {
        private readonly TestData[] _testDataItems = new[]
        {
            new TestData()
            {
            ...
            new TestData()
            {
                PrivateKey = "0x51d0b65185db6989ab0b560d6deed19c7ead0e24b9b6372cbecb1f26bdfad000",
                PublicKey =
                    "0xb89bebc699769726a318c8e9971bd3171297c61aea4a6578a7a4f94b547dcba5bac16a89108b6b6a1fe3695d1a874a0b"
            },
            new TestData()
            {
                PrivateKey = "0x315ed405fafe339603932eebe8dbfd650ce5dafa561f6928664c75db85f97857",
                PublicKey =
        ...
        public async Task TestGenerationOfFirstValidator()
        {
            ...
            // Act
            var quickStart = testServiceProvider.GetService<INodeStart>();
            await quickStart.InitializeNodeAsync();
            
            // Assert
            var storeProvider = testServiceProvider.GetService<IStoreProvider>();
            var store = storeProvider.GetStore();
            store.TryGetBlockState(store.FinalizedCheckpoint.Root, out var state);
            var expectedKey0 = new BlsPublicKey(_testDataItems[0].PublicKey);
        ...
        public async Task TestValidatorKeyGeneration10()
        {
            ...
            {
                var expectedKey = new BlsPublicKey(_testDataItems[index].PublicKey);
