...
namespace Nethermind.BeaconNode.Test
{
    ...
    public class BlockProducerTest
    {
        ...
        public async Task BasicNewBlock()
        {
            ...
            Hash32 expectedParentRoot = new Hash32(Bytes.FromHexString("0x91b06cbcd6dc97b89dc8b95e0b01a497932683b182e6c722ddfa10cd005b2180"));
            ...
            Hash32 expectedStateRoot = new Hash32(Bytes.FromHexString("0xe05ccf6347cac0b0dab0ad0d5c941fe7c7e2ed4c69550ed9a628bc9d62914242"));
