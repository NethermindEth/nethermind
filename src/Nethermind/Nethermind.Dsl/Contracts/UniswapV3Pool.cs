...
namespace Nethermind.Dsl.Contracts
{
    public class UniswapV3Pool : BlockchainBridgeContract
    {
        ...
        public UniswapV3Pool(Address contractAddress, IBlockchainBridge blockchainBridge, AbiDefinition abiDefinition, AbiEncoder abiEncoder) : base(contractAddress, abiDefinition, abiEncoder)
        {
