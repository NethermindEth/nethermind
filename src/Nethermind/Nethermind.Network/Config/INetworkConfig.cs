...
namespace Nethermind.Network.Config
{
    public interface INetworkConfig : IConfig
    {
        ...
        [ConfigItem(DefaultValue = "0", Description = "[TECHNICAL] Introduce a fixed latency for all p2p message send. Useful for testing higher latency network or simulate slower network for testing purpose.")]
