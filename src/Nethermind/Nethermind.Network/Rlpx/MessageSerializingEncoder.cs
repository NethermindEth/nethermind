...
{
    public class MessageSerializingEncoder<T> : MessageToByteEncoder<T> where T : P2PMessage
    {
        ...
        protected override void Encode(IChannelHandlerContext context, T input, IByteBuffer output)
        {
