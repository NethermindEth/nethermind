...
namespace Nethermind.Network.P2P.Subprotocols.Eth
{
    public abstract class HashesMessageSerializer<T> : IZeroInnerMessageSerializer<T> where T : HashesMessage
    {
        ...
        protected static Hash256[] DeserializeHashes(ref RlpReader ctx, RlpLimit? limit = null) =>
            ctx.DecodeArray(static (ref RlpReader c) => c.DecodeKeccakOrNull()!, limit: limit);
        ...
        protected static ArrayPoolList<Hash256> DeserializeHashesArrayPool(ref RlpReader ctx, RlpLimit? limit = null) => ctx.DecodeArrayPoolList(static (ref RlpReader c) => c.DecodeKeccakOrNull()!, limit: limit);
