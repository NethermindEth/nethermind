...
namespace Nethermind.Network.P2P.Subprotocols.Eth.V65
{
    public interface IPooledTxsRequestor
    {
        ...
        void RequestTransactionsEth68(Action<V66.Messages.GetPooledTransactionsMessage> send,
            IReadOnlyList<Keccak> hashes, IReadOnlyList<int> sizes, IReadOnlyList<TxType> types);
    }
}
