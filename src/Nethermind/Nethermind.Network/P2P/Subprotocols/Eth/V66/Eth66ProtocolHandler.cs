...
namespace Nethermind.Network.P2P.Subprotocols.Eth.V66
{
    ...
    public class Eth66ProtocolHandler : Eth65ProtocolHandler
    {
        ...
        private readonly MessageDictionary<GetBlockBodiesMessage, V62.Messages.GetBlockBodiesMessage, (UnmanagedBlockBodies, long)> _bodiesRequests66;
            ...
            : base(session, serializer, nodeStatsManager, syncServer, txPool, pooledTxsRequestor, gossipPolicy, forkInfo, logManager, transactionsGossipPolicy)
        {
            ...
            _bodiesRequests66 = new MessageDictionary<GetBlockBodiesMessage, V62.Messages.GetBlockBodiesMessage, (UnmanagedBlockBodies, long)>(Send);
        ...
        protected override async Task<(UnmanagedBlockBodies, long)> SendRequest(V62.Messages.GetBlockBodiesMessage message, CancellationToken token)
        {
            if (Logger.IsTrace)
            {
