...
namespace Nethermind.Network.P2P.Subprotocols.Eth.V62.Messages
{
    public class GetBlockBodiesMessageSerializer : IZeroInnerMessageSerializer<GetBlockBodiesMessage>
    {
        ...
        public static GetBlockBodiesMessage Deserialize(ref ValueRlpReader ctx)
        {
            Hash256[] hashes = ctx.DecodeArray(static (ref ValueRlpReader c) => c.DecodeKeccak(), false, limit: RlpLimit);
