...
namespace Nethermind.Consensus.AuRa.Contracts
{
    public abstract class VersionedContract<T> : IActivatedAtBlock where T : IVersionedContract
    {
        ...
        private readonly LruCache<ValueCommitment, UInt256> _versionsCache;
        private readonly ILogger _logger;

        protected VersionedContract(IDictionary<UInt256, T> versions, LruCache<ValueCommitment, UInt256> cache, long activation, ILogManager logManager)
        {
