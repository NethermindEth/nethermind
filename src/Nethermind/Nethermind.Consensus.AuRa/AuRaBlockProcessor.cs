...
namespace Nethermind.Consensus.AuRa
{
    public class AuRaBlockProcessor : BlockProcessor
    {
        ...
        protected TxReceipt[] PostMergeProcessBlock(Block block, IBlockTracer blockTracer, ProcessingOptions options, IReleaseSpec spec, CancellationToken token, Action? onTransactionsProcessed = null)
        {
            RewriteContracts(block, spec);
            return base.ProcessBlock(block, blockTracer, options, spec, token, onTransactionsProcessed);
        }
