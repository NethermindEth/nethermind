...
namespace Nethermind.Consensus.AuRa
{
    public class AuRaBlockProcessor : BlockProcessor
    {
        ...
        {
            bool wereChanges = _contractRewriter?.RewriteContracts((long)block.Number, _stateProvider, spec) ?? false;
        ...
        private void ValidateGasLimit(Block block)
        {
            ...
            if (_gasLimitOverride?.IsGasLimitValid(parentHeader, (long)block.GasLimit, out long? expectedGasLimit) == false)
            {
