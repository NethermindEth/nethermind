...
namespace Nethermind.Consensus.AuRa
{
    public class AuRaValidatorFactory : IAuRaValidatorFactory
    {
        ...
        {
            IValidatorContract GetValidatorContract() => new ValidatorContract(_transactionProcessor, _specProvider, _abiEncoder, validator.GetContractAddress(), _stateProvider, _readOnlyTxProcessorSource, _signer);
            IReportingValidatorContract GetReportingValidatorContract() => new ReportingValidatorContract(_specProvider, _abiEncoder, validator.GetContractAddress(), _signer);
