...
public class RegisterAuRaRpcModules : RegisterRpcModules
{
    ...
    protected class AuRaTraceModuleFactory(
        ...
        : TraceModuleFactory(stateFactory, dbProvider, blockTree, jsonRpcConfig, recoveryStep, rewardCalculatorSource,
    ...
    protected class AuRaDebugModuleFactory(
        ...
        ILogManager logManager,
        IAuRaBlockProcessorFactory factory)
        : DebugModuleFactory(stateFactory, dbProvider, blockTree, jsonRpcConfig, blockValidator, recoveryStep,
