...
namespace Nethermind.Synchronization.SyncLimits
{
    public static class NethermindSyncLimits
    {
        ...
        public const int MaxBodyFetch = 2; // Amount of block bodies to be fetched per retrieval request
        public const int MaxReceiptFetch = 2; // Amount of transaction receipts to allow fetching per request
