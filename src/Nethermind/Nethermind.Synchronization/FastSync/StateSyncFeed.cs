...
namespace Nethermind.Synchronization.FastSync
{
    public partial class StateSyncFeed : SyncFeed<StateSyncBatch?>, IDisposable
    {
        ...
        public override ValueTask<SyncResponseHandlingResult> HandleResponse(StateSyncBatch? batch, PeerInfo peer = null)
        {
            return new(_treeSync.HandleResponse(batch, peer));
        }
