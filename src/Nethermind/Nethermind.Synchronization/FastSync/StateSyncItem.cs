...
namespace Nethermind.Synchronization.FastSync
{
    ...
    {
        public StateSyncItem(Commitment hash, byte[]? accountPathNibbles, byte[]? pathNibbles, NodeDataType nodeType, int level = 0, uint rightness = 0)
        {
            Hash = hash;
