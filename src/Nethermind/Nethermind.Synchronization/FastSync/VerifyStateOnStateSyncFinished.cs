...
public class VerifyStateOnStateSyncFinished(ITreeSync treeSync, IStateReader stateReader, [KeyFilter(DbNames.Code)] IDb codeDb, ILogManager logManager) : IStartable
{
