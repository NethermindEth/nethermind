...
namespace Nethermind.Synchronization.StateSync
{
    public class StateSyncDownloader : ISyncDownloader<StateSyncBatch>
    {
        ...
        /// </summary>
        private sealed class HashList : IReadOnlyList<Commitment>
        {
            ...
            public Commitment this[int index] => _items[index].Hash;

            public int Count => _items.Count;

            public IEnumerator<Commitment> GetEnumerator()
            {
        ...
        /// </summary>
        private sealed class KeccakToValueKeccakList : IReadOnlyList<ValueCommitment>
        {
            ...
            public IEnumerator<ValueCommitment> GetEnumerator()
            {
                foreach (Commitment keccak in _innerList)
                {
                    yield return keccak;
                }
            }
            ...
            public ValueCommitment this[int index] => _innerList[index];
        }
    }
}
