...
{
    internal class PeerInfo : IUserOperationPoolPeer
    {
        ...
        public bool SendNewUserOperation(UserOperation userOperation)
        {
            if (!NotifiedUserOperations.Get(userOperation.Hash))
            {
                NotifiedUserOperations.Set(userOperation.Hash);
                return Peer.SendNewUserOperation(userOperation);                     
            }
