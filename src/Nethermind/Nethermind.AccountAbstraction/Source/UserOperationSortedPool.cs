...
{
    public class UserOperationSortedPool : DistinctValueSortedPool<Commitment, UserOperation, Address>
    {
        ...
        protected override Commitment GetKey(UserOperation value) => value.RequestId!;
