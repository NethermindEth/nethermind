...
namespace Nethermind.BeaconNode.OApiClient
{
    public static class BeaconNodeOApiClientServiceCollectionExtensions
    {
        ...
        static IAsyncPolicy<HttpResponseMessage> GetBeaconNodeProxyRetryPolicy(IServiceProvider services, HttpRequestMessage request)
        {
            ...
            return HttpPolicyExtensions
                ...
                .WaitAndRetryForeverAsync(
                    (retryAttempt, context) => TimeSpan.FromMilliseconds(beaconNodeConnectionOptions.Value.ConnectionFailureLoopMillisecondsDelay),
