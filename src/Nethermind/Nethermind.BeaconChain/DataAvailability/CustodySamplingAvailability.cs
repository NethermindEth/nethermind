...
/// checked by name so the rule does not silently rest on that derivation staying true.
/// </summary>
/// <remarks>
...
/// rule that cannot say which columns it needs cannot say a block is available either.
/// </remarks>
public sealed class CustodySamplingAvailability(INodeColumnCustodySource custodySource, IDataColumnSource columns) : IDataAvailabilityRule
{
    /// <inheritdoc/>
