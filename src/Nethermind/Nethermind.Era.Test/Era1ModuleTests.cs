...
public class Era1ModuleTests
{
    ...
    public async Task CreateEraAndVerifyAccumulators()
    {
        ...
        blocks = testBlockchain.BlockProcessor.Process(genesis.StateRoot!, blocks, ProcessingOptions.NoValidation | ProcessingOptions.StoreReceipts, new BlockReceiptsTracer(), default).ToList();
    ...
    public async Task TestBigBlocksExportImportHistory()
    {
        ...
        testBlockchain.BlockProcessor.Process(genesis.StateRoot!, blocks, ProcessingOptions.NoValidation, new BlockReceiptsTracer(), default);
