...
{
    private readonly IAsyncHandler<IReadOnlyList<Hash256>, IEnumerable<ExecutionPayloadBodyV1Result?>> _executionGetPayloadBodiesByHashV1Handler;
    ...
    public Task<ResultWrapper<IEnumerable<ExecutionPayloadBodyV1Result?>>> engine_getPayloadBodiesByHashV1(IReadOnlyList<Hash256> blockHashes)
