...
public class BoostRelay : IBoostRelay
{
    ...
    public Task<IPayloadAttributes> GetPayloadAttributes(IPayloadAttributes payloadAttributes, CancellationToken cancellationToken) =>
        _httpClient.PostJsonAsync<IPayloadAttributes>(GetUri(_relayUrl, GetPayloadAttributesPath), payloadAttributes, cancellationToken);
