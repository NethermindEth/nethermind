...
namespace Nethermind.Merge.Plugin
{
    ...
    public interface IConsensusRpcModule : IRpcModule
    {
        [JsonRpcMethod(
            ...
            IsSharable = true,
            IsImplemented = true)]
        ResultWrapper<BlockRequestResult>  consensus_assembleBlock(
        ...
        [JsonRpcMethod(
            ...
            IsSharable = true,
            IsImplemented = true)]
        ResultWrapper<SuccessResult> consensus_setHead(
            Keccak blockHash);        
        ...
        [JsonRpcMethod(
            ...
            IsSharable = true,
            IsImplemented = true)]
        ResultWrapper<SuccessResult> consensus_finaliseBlock(
            Keccak blockHash);
    }
}
