...
public partial class MergePlugin(IMergeConfig mergeConfig, ChainSpec chainSpec) : IConsensusWrapperPlugin, ISynchronizationPlugin
{
    ...
    public Task InitSynchronization()
    {
        if (MergeEnabled)
        {
            ...
            _api.ConfigureContainerBuilderFromApiWithNetwork(builder)
                ...
                .AddInstance<IBeaconPivot>(_beaconPivot)
                .AddInstance(mergeConfig)
