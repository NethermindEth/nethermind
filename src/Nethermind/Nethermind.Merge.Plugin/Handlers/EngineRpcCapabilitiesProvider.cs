...
public class EngineRpcCapabilitiesProvider(ISpecProvider specProvider) : IRpcCapabilitiesProvider
{
        ...
        out Dictionary<string, RpcCapabilityOptions> ssz)
    {
        ...
        jsonLocal[nameof(IEngineRpcModule.engine_newPayloadWithWitnessV4)] = GateWithWarn(v4);
        ...
        Configure(nameof(IEngineRpcModule.engine_newPayloadWithWitnessV5), SszRestPaths.PostPayloadsWitness, GateWithWarn(spec.IsEip7928Enabled));
