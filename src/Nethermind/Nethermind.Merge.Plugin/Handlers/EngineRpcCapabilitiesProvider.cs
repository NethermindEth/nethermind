...
public class EngineRpcCapabilitiesProvider(ISpecProvider specProvider) : IRpcCapabilitiesProvider
{
        ...
        out Dictionary<string, RpcCapabilityOptions> ssz)
    {
        ...
        jsonLocal[nameof(IEngineRpcModule.engine_newPayloadWithWitness)] = GateWithWarn(spec.IsEip7928Enabled);
        sszLocal[SszRestCapabilities.NewPayloadWithWitness] = GateWithWarn(spec.IsEip7928Enabled);
