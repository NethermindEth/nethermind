...
public partial interface IEngineRpcModule : IRpcModule
{
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<ForkchoiceUpdatedV2RequestWire, ForkchoiceUpdatedResponseWire>(SszRestPaths.Forkchoice)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszGet<PayloadIdRequest, GetPayloadResponseV2Wire>(SszRestPaths.Payloads, "payload_id", noStore: true)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<GetPayloadBodiesByHashRequestWire, PayloadBodiesV1ResponseWire>(SszRestPaths.PayloadBodiesByHash)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<GetPayloadBodiesByRangeRequestWire, PayloadBodiesV1ResponseWire>(SszRestPaths.PayloadBodiesByRange)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<NewPayloadV2RequestWire, PayloadStatusWire>(SszRestPaths.Payloads)]
