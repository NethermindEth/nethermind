...
public partial interface IEngineRpcModule : IRpcModule
{
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<ForkchoiceUpdatedV1RequestWire, ForkchoiceUpdatedResponseWire>]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszGet<PayloadIdRequest, SszExecutionPayloadV1>]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<NewPayloadV1RequestWire, PayloadStatusWire>]
