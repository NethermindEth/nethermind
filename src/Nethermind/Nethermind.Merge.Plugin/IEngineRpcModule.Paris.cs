...
public partial interface IEngineRpcModule : IRpcModule
{
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<ForkchoiceUpdatedV1RequestWire, ForkchoiceUpdatedResponseWire>(SszRestPaths.Forkchoice)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszGet<PayloadIdRequest, SszExecutionPayloadV1>(SszRestPaths.Payloads, "payload_id", noStore: true)]
    ...
    [JsonRpcMethod(
        ...
        IsSharable = true,
        IsImplemented = true)]
    [SszPost<NewPayloadV1RequestWire, PayloadStatusWire>(SszRestPaths.Payloads)]
