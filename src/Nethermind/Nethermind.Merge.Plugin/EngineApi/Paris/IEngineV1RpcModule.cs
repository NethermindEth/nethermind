...
namespace Nethermind.Merge.Plugin.EngineApi.Paris
{
    ...
    public interface IEngineV1RpcModule : IRpcModule
    {
        [JsonRpcMethod(
            Description =
        ...
        [JsonRpcMethod(
            ...
            IsSharable = true,
            IsImplemented = true)]
        Task<ResultWrapper<ForkchoiceUpdatedV1Result>> engine_forkchoiceUpdatedV1(ForkchoiceStateV1 forkchoiceState, PayloadAttributesV1? payloadAttributes = null);
        ...
        [JsonRpcMethod(
            ...
            IsSharable = true,
            IsImplemented = true)]
        ResultWrapper<TransitionConfigurationV1> engine_exchangeTransitionConfigurationV1(TransitionConfigurationV1 transitionConfiguration);
    }
}
