...
/// <summary>Result of <c>engine_forkchoiceUpdatedV5</c> (EIP-7805): mirrors <see cref="ForkchoiceUpdatedV1Result"/>
/// but carries a <see cref="PayloadStatusV2"/> so a <c>VALID</c> head can report inclusion-list compliance.</summary>
public class ForkchoiceUpdatedV2Result
{
    ...
    /// <summary>Maps a base fork-choice result to the V5 shape, attaching the head block's inclusion-list
    /// compliance; <paramref name="inclusionListSatisfied"/> is <c>null</c> when it is unknown.</summary>
