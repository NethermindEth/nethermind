    ...
    : GetPayloadV5Result<ExecutionPayloadV4>(block, blockFees, blobsBundle, executionRequests, shouldOverrideBuilder)
{
    ...
    public override bool ValidateFork(ISpecProvider specProvider, int version) => specProvider.GetSpec(Block.Number, Block.Timestamp).BlockLevelAccessListsEnabled;
}
