...
namespace Nethermind.PerfTest
{
    internal static class Program
    {
        ...
        private class UnprocessedBlockTreeWrapper : IBlockTree
        {
            ...
            public bool TryUpdateMainChain(BlockHeader newHead, bool wereProcessed, bool forceUpdateHeadBlock = false, params ReadOnlySpan<Block> preloadedBlocks) => _blockTree.TryUpdateMainChain(newHead, wereProcessed, forceUpdateHeadBlock, preloadedBlocks);
