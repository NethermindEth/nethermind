...
namespace Nethermind.Specs.ChainSpecStyle
{
    public class ChainSpecBasedSpecProvider : SpecProviderBase, IForkAwareSpecProvider
    {
        ...
        protected virtual ReleaseSpec CreateReleaseSpec(ChainSpec chainSpec, ulong releaseStartBlock, ulong? releaseStartTimestamp = null)
        {
            ...
            releaseSpec.IsEip2935Enabled = BlockOf(chainSpec.Parameters.Eip2935Transition) <= block ||
            ...
            releaseSpec.IsEip7702Enabled = BlockOf(chainSpec.Parameters.Eip7702Transition) <= block ||
            ...
            releaseSpec.IsEip7623Enabled = BlockOf(chainSpec.Parameters.Eip7623Transition) <= block ||
            ...
            releaseSpec.IsEip8304Enabled = (chainSpec.Parameters.Eip8304TransitionTimestamp ?? ulong.MaxValue) <= releaseStartTimestamp;
            releaseSpec.Eip8304ContractAddress = chainSpec.Parameters.Eip8304ContractAddress;
