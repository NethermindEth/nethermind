...
namespace Nethermind.Specs.ChainSpecStyle
{
    public class ChainSpecBasedSpecProvider : SpecProviderBase, IForkAwareSpecProvider
    {
        ...
        protected virtual ReleaseSpec CreateReleaseSpec(ChainSpec chainSpec, long releaseStartBlock, ulong? releaseStartTimestamp = null)
        {
            ...
            releaseSpec.IsOpJovianEnabled = (chainSpec.Parameters.OpJovianTransitionTimestamp ?? ulong.MaxValue) <= releaseStartTimestamp;
            releaseSpec.IsOpKarstEnabled = (chainSpec.Parameters.OpKarstTransitionTimestamp ?? ulong.MaxValue) <= releaseStartTimestamp;
