...
{
    public class SystemTransactionReleaseSpec(IReleaseSpec spec, bool isAura) : IReleaseSpec
    {
        ...
        public bool IsEip158Enabled => !isAura;
        ...
        public bool IsEip158IgnoredAccount(Address address) => isAura && address == Address.SystemUser;
        ...
        public Address Eip1559FeeCollector => spec.Eip1559FeeCollector;
