...
namespace Nethermind.Specs.Forks
{
    ...
    {   
        ...
        public static IReleaseSpec Instance => LazyInitializer.EnsureInitialized(ref _instance, () => new Dao());

        public string Name => "DAO";
        ...
        public bool IsEip3238Enabled => false;
