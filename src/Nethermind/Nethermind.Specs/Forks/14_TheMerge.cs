...
public class TheMerge : IReleaseSpec
{
    ...
    public static IReleaseSpec Instance => LazyInitializer.EnsureInitialized(ref _instance, () => new TheMerge());

    public string Name => "TheMerge";
    ...
    public bool TheMergeEnabled => true;
}
