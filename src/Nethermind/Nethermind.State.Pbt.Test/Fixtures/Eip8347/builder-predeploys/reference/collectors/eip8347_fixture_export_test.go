...
func TestExportEip8347Lifecycle(t *testing.T) {
	...
	if os.Getenv("EIP8347_BUILDER_PREDEPLOYS") == "1" {
		genesis.Alloc[params.BuilderDepositAddress] = types.Account{Nonce: 1, Code: params.BuilderDepositCode, Balance: big.NewInt(0)}
		genesis.Alloc[params.BuilderExitAddress] = types.Account{Nonce: 1, Code: params.BuilderExitCode, Balance: big.NewInt(0)}
	}
	...
	if os.Getenv("EIP8347_BUILDER_PREDEPLOYS") == "1" {
		writeJSON("edition.json", map[string]any{"edition": "builder-predeploys", "referenceCommit": "e31a37fb88c2b75c0897c033bd3f4279dee42268", "eip": 8282, "builderDeposit": params.BuilderDepositAddress, "builderExit": params.BuilderExitAddress, "nonce": 1, "source": "params.BuilderDepositCode and params.BuilderExitCode", "preservesOriginalEdition": true})
	}
