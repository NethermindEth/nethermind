...
public class PbtScannerTests
{
        ...
        PbtGroupFormat format, int fieldsEntries, int storageEntries, int codeEntries)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(sections.Fields.EntryBytes, Is.EqualTo(fieldsEntries * StemLeafBlob.ValueLength), "three leaves over two stems, and the internals this layout keeps");
