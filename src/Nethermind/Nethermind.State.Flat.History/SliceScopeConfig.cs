...
/// (39-3), out of this parser's scope. A range scope (one record covering several addresses), if ever needed
/// (39-6), is a new record kind under its own reserved-key prefix - not a retrofit of this point-scope shape.</summary>
