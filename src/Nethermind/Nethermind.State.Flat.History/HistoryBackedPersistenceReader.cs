...
internal sealed class HistoryBackedPersistenceReader : IPersistence.IPersistenceReader
{
    ...
    /// <summary>What <see cref="Nethermind.State.IStateReader"/> callers expect; JSON-RPC answers resource-unavailable (-32002) for a <see cref="StateNotRetainedException"/> inner and resource-not-found otherwise.</summary>
