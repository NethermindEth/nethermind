...
namespace Nethermind.Consensus.Clique
{
    public class Snapshot : ICloneable
    {
        ...
        internal Snapshot(long number, Commitment hash, SortedList<Address, long> signers, Dictionary<Address, Tally> tally)
        {
            Number = number;
            Hash = hash;
        ...
        internal Snapshot(long number, Commitment hash, SortedList<Address, long> signers)
