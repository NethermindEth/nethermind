...
public class RocksDbConfigFactory(IDbConfig dbConfig, IHardwareInfo hardwareInfo, ILogManager logManager, bool validateConfig = true) : IRocksDbConfigFactory
{
    ...
    public IRocksDbConfig GetForDatabase(string databaseName, string? columnName)
    {
        ...
        return new PerTableDbConfig(dbConfig, databaseName, columnName, validateConfig);
    }
}
