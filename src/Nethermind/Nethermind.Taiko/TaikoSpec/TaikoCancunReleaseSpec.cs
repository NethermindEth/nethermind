...
public class TaikoOntakeReleaseSpec : Shanghai, ITaikoReleaseSpec
{
    ...
    public ReadOnlyMemory<ushort> UnzenOpcodeZkGasMultipliers { get; set; } = ZkGasSchedule.OpcodeMultipliers;
    public ReadOnlyMemory<ushort> UnzenPrecompileZkGasMultipliers { get; set; } = ZkGasSchedule.PrecompileMultipliers;
