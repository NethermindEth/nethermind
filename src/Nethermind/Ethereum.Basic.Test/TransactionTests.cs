...
public class TransactionTests
{
    ...
    {
        EthereumEcdsa ethereumEcdsa = new(TestBlockchainIds.ChainId);
        ...
        Assert.That(decodedUnsigned.Signature.R.ToArray(), Is.EqualTo(decodedSigned.Signature.R.ToArray()), "R");
