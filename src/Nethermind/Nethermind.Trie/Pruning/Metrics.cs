...
namespace Nethermind.Trie.Pruning
{
    public static class Metrics
    {
        ...
        public static long LoadedFromDbNodesCount => Nethermind.Trie.TrieNodeCounters.TotalLoadedFromDb;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void IncrementLoadedFromDbNodesCount() => Nethermind.Trie.TrieNodeCounters.IncrementLoadedFromDb();

        [CounterMetric]
        [Description("Number of reads from the node cache.")]
        public static long LoadedFromCacheNodesCount => Nethermind.Trie.TrieNodeCounters.TotalLoadedFromCache;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void IncrementLoadedFromCacheNodesCount() => Nethermind.Trie.TrieNodeCounters.IncrementLoadedFromCache();
