...
namespace Nethermind.Trie
{
    public static class TrieNodeFactory
    {
        ...
        public static TrieNode CreateLeaf(TreePath path, in CappedArray<byte> value)
        {
            return new(new LeafData(path, in value));
        }

        public static TrieNode CreateExtension(TreePath path)
        {
            return new(new ExtensionData(path));
        }

        public static TrieNode CreateExtension(TreePath path, TrieNode child)
        {
