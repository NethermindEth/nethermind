...
public class ForkInfoTests
{
    ...
    private static void Test(long head, ulong headTimestamp, Commitment genesisHash, string forkHashHex, ulong next, string description, ISpecProvider specProvider, string chainSpec, string path = "../../../../Chains")
    {
    ...
    private static void Test(long head, ulong headTimestamp, Commitment genesisHash, string forkHashHex, ulong next, string description, string chainSpec, string path = "../../../../Chains")
    {
        ChainSpecLoader loader = new ChainSpecLoader(new EthereumJsonSerializer());
    ...
    private static void Test(long head, ulong headTimestamp, Commitment genesisHash, string forkHashHex, ulong next, string description, ISpecProvider specProvider)
    {
