...
public class ForkInfoTests
{
    ...
    [TestCase(15_051_000ul, 1_681_338_455ul, "0xdce96c2d", 1_710_338_135ul, "First Shanghai timestamp")]
    [TestCase(15_051_000ul, 1_710_338_134ul, "0xdce96c2d", 1_710_338_135ul, "Future Shanghai timestamp")]
    [TestCase(15_051_000ul, 1_710_338_135ul, "0x9f3d2254", 1_746_612_311ul, "First Cancun timestamp")]
    [TestCase(15_051_000ul, 1_746_612_310ul, "0x9f3d2254", 1_746_612_311ul, "Future Cancun timestamp")]
    [TestCase(15_051_000ul, 1_746_612_311ul, "0xc376cf8b", 1_764_798_551ul, "First Prague timestamp")]
    [TestCase(15_051_000ul, 1_764_798_550ul, "0xc376cf8b", 1_764_798_551ul, "Future Prague timestamp")]
    [TestCase(15_051_000ul, 1_764_798_551ul, "0x5167e2a6", 1_765_290_071ul, "First Osaka timestamp")]
    [TestCase(15_051_000ul, 1_765_290_070ul, "0x5167e2a6", 1_765_290_071ul, "Future Osaka timestamp")]
    ...
    public void Fork_id_and_hash_as_expected(ulong head, ulong headTimestamp, string forkHashHex, ulong next, string description)
    {
    ...
    [TestCase(20_000_000ul, 1_668_000_000ul, "0x71147644", 0ul, "First Shanghai")]
    [TestCase(21_000_000ul, 1_768_000_000ul, "0x71147644", 0ul, "Future Shanghai")]
    public void Fork_id_and_hash_as_expected_with_timestamps(ulong head, ulong headTimestamp, string forkHashHex, ulong next, string description)
    {
    ...
    [TestCase(0ul, 0ul, "0xFE3366E7", 1735371ul, "Sepolia genesis")]
    [TestCase(1735370ul, 0ul, "0xFE3366E7", 1_735_371ul, "Sepolia Last block before MergeForkIdTranstion")]
    [TestCase(1735371ul, 0ul, "0xb96cbd13", 1_677_557_088ul, "First block - Sepolia MergeForkIdTransition")]
    [TestCase(1735372ul, 1_677_557_088ul, "0xf7f9bc08", 1_706_655_072ul, "Shanghai")]
    [TestCase(1735372ul, 1_706_655_071ul, "0xf7f9bc08", 1_706_655_072ul, "Future Shanghai")]
    [TestCase(1735373ul, 1_706_655_072ul, "0x88cf81d9", 1_741_159_776ul, "First Cancun timestamp")]
    [TestCase(1735374ul, 1_716_655_072ul, "0x88cf81d9", 1_741_159_776ul, "Future Cancun timestamp")]
    [TestCase(1735373ul, 1_741_159_776ul, "0xed88b5fd", 1_760_427_360ul, "First Prague timestamp")]
    [TestCase(1735374ul, 1_751_159_776ul, "0xed88b5fd", 1_760_427_360ul, "Future Prague timestamp")]
    [TestCase(1735373ul, 1_760_427_360ul, "0xe2ae4999", 1_761_017_184ul, "First Osaka timestamp")]
    ...
    public void Fork_id_and_hash_as_expected_on_sepolia(ulong head, ulong headTimestamp, string forkHashHex, ulong next, string description)
    {
    ...
    [TestCase(31735000ul, GnosisSpecProvider.ShanghaiTimestamp, "0x2efe91ba", GnosisSpecProvider.CancunTimestamp, "First Shanghai timestamp")]
    [TestCase(41735000ul, GnosisSpecProvider.CancunTimestamp, "0x1384dfc1", GnosisSpecProvider.PragueTimestamp, "First Cancun timestamp")]
    [TestCase(91735000ul, GnosisSpecProvider.PragueTimestamp - 1, "0x1384dfc1", GnosisSpecProvider.PragueTimestamp, "Future Cancun timestamp")]
    [TestCase(101735000ul, GnosisSpecProvider.PragueTimestamp, "0x2f095d4a", GnosisSpecProvider.BalancerTimestamp, "First Prague timestamp")]
    [TestCase(101735000ul, GnosisSpecProvider.BalancerTimestamp - 1, "0x2f095d4a", GnosisSpecProvider.BalancerTimestamp, "Future Prague timestamp")]
    [TestCase(111735000ul, GnosisSpecProvider.BalancerTimestamp, "0xd00284ad", 0ul, "First Balancer timestamp")]
    [TestCase(111735000ul, GnosisSpecProvider.BalancerTimestamp + 100, "0xd00284ad", 0ul, "First Balancer timestamp")]
    ...
    [TestCase(3945317ul, ChiadoSpecProvider.ShanghaiTimestamp, "0xa15a4252", ChiadoSpecProvider.CancunTimestamp, "First Shanghai timestamp")]
    [TestCase(4_000_000ul, ChiadoSpecProvider.CancunTimestamp, "0x5fbc16bc", 1741254220ul, "First Cancun timestamp")]
    [TestCase(5_000_000ul, 1741254219u, "0x5fbc16bc", 1741254220ul, "Future Cancun timestamp")]
    [TestCase(5_000_000ul, 1741254220u, "0x8ba51786", 0ul, "First Prague timestamp")]
    [TestCase(5_000_000ul, 1741254420u, "0x8ba51786", 0ul, "Future Prague timestamp")]
    ...
    [TestCase(0ul, HoodiSpecProvider.CancunTimestamp, "0xbef71d30", HoodiSpecProvider.PragueTimestamp, "First Cancun timestamp")]
    [TestCase(5_000_000ul, HoodiSpecProvider.PragueTimestamp - 1, "0xbef71d30", HoodiSpecProvider.PragueTimestamp, "Future Cancun timestamp")]
    [TestCase(5_000_000ul, HoodiSpecProvider.PragueTimestamp, "0x929e24e", HoodiSpecProvider.OsakaTimestamp, "First Prague timestamp")]
    [TestCase(5_000_000ul, HoodiSpecProvider.OsakaTimestamp - 1, "0x929e24e", HoodiSpecProvider.OsakaTimestamp, "Future Prague timestamp")]
    [TestCase(6_000_000ul, HoodiSpecProvider.OsakaTimestamp, "0xe7e0e7ff", HoodiSpecProvider.BPO1Timestamp, "First Osaka timestamp")]
    ...
    private static void Test(ulong head, ulong headTimestamp, Hash256 genesisHash, string forkHashHex, ulong next, string description, ISpecProvider specProvider)
    {
        ...
        {
            nextActivation.BlockNumber.Should().Be(next);
        }
    }
