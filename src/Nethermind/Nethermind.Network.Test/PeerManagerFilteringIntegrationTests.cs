...
public class PeerManagerFilteringIntegrationTests
{
    ...
    public async Task PeerManager_CallsShouldContactBeforeConnectAsync()
    {
        ...
        NodesLoader nodesLoader = new(networkConfig, stats, storage, trackingMock, LimboLogs.Instance, new NodesLoaderOptions());
    ...
    private class Context : IAsyncDisposable
    {
        ...
        public Context()
        {
            ...
            NodesLoader nodesLoader = new(networkConfig, stats, storage, RlpxMock, LimboLogs.Instance, new NodesLoaderOptions());
