...
namespace Nethermind.Network.Test.P2P
{
    ...
    public class P2PProtocolHandlerTests
    {
        ...
        private P2PProtocolHandler CreateSession(string? clientIdHiddenParts = null)
        {
        ...
        [Test]
        public void On_init_sends_a_hello_message_with_anonymize_client_id()
        {
            P2PProtocolHandler p2PProtocolHandler = CreateSession(clientIdHiddenParts: "os,runtime");
            p2PProtocolHandler.Init();
