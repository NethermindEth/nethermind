...
public class ProtocolHandlerBaseTests
{
    ...
    {
        public bool TryScheduleTask<TReq>(in TReq request, Func<TReq, CancellationToken, Task> fulfillFunc, TimeSpan? timeout = null, string? source = null) where TReq : notnull => true;
    }
