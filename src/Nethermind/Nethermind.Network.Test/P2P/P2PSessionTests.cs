...
namespace Nethermind.Network.Test.P2P
{
    ...
    public class P2PSessionTests
    {
        ...
        {
            P2PSession session = new P2PSession(TestItem.PublicKeyA, TestItem.PublicKeyB, 30312, ConnectionDirection.In, LimboLogs.Instance, _channel);
            Assert.AreEqual(TestItem.PublicKeyA, session.LocalNodeId);
            Assert.AreEqual(TestItem.PublicKeyB, session.RemoteNodeId);
            Assert.AreEqual(30312, session.LocalPort);
            Assert.AreEqual(ConnectionDirection.In, session.Direction);
        ...
        {
            P2PSession session = new P2PSession(TestItem.PublicKeyA, null, 30312, ConnectionDirection.In, LimboLogs.Instance, _channel);
