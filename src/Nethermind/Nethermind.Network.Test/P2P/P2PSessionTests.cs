...
namespace Nethermind.Network.Test.P2P
{
    ...
    public class P2PSessionTests
    {
        ...
        {
            Session session = new Session(TestItem.PublicKeyB, 30312, ConnectionDirection.Out, LimboLogs.Instance, _channel);
        ...
        {
            Session session = new Session(null, 30312, ConnectionDirection.In, LimboLogs.Instance, _channel);
