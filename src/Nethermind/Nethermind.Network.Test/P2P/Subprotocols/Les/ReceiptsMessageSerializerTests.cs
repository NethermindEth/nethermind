...
namespace Nethermind.Network.Test.P2P.Subprotocols.Les
{
    ...
    public class ReceiptsMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            using Network.P2P.Subprotocols.Eth.V63.Messages.ReceiptsMessage ethMessage = new(data.ToPooledList());
            using ReceiptsMessage receiptsMessage = new(ethMessage, 1, 2000);
            ...
            using ReceiptsMessage deserialized = serializer.Deserialize(bytes);
