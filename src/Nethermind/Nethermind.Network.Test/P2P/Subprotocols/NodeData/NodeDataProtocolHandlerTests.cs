...
public class NodeDataProtocolHandlerTests
{
    ...
    {
        GetNodeDataMessage msg = new GetNodeDataMessage(new[] { Keccak.Zero, TestItem.KeccakA }.ToPooledList());
    ...
    {
        NodeDataMessage msg = new NodeDataMessage(new ByteArrayListAdapter(ArrayPoolList<byte[]>.Empty()));
