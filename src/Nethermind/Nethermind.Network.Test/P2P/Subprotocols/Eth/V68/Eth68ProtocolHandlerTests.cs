...
public class Eth68ProtocolHandlerTests
{
    ...
    public void Can_handle_NewPooledTransactions_message([Values(0, 1, 2, 100)] int txCount, [Values(true, false)] bool canGossipTransactions)
    {
        ...
        using NewPooledTransactionHashesMessage68 msg = new NewPooledTransactionHashesMessage68(types, sizes, hashes);
    ...
    public void Should_process_huge_transaction()
    {
        ...
        using NewPooledTransactionHashesMessage68 msg = new NewPooledTransactionHashesMessage68(new ArrayPoolList<byte>(1) { (byte)tx.Type },
