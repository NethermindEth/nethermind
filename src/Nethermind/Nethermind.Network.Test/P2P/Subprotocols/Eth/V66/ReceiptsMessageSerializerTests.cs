...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class ReceiptsMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            var serializer63 = new Network.P2P.Subprotocols.Eth.V63.ReceiptsMessageSerializer(MainnetSpecProvider.Instance);
            ReceiptsMessageSerializer serializer = new ReceiptsMessageSerializer(serializer63 as IZeroMessageSerializer<Network.P2P.Subprotocols.Eth.V63.ReceiptsMessage>);
            ...
            Network.P2P.Subprotocols.Eth.V63.ReceiptsMessage ethMessage = deserializedMessage.EthMessage;
