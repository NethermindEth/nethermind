...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class ReceiptsMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            Network.P2P.Subprotocols.Eth.V63.Messages.ReceiptsMessageSerializer serializer63 = new Network.P2P.Subprotocols.Eth.V63.Messages.ReceiptsMessageSerializer(MainnetSpecProvider.Instance);
