...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class GetNodeDataMessageSerializerTests
    {
        ...
        {
            Commitment[] keys = { new("0x00000000000000000000000000000000000000000000000000000000deadc0de"), new("0x00000000000000000000000000000000000000000000000000000000feedbeef") };
