...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class GetNodeDataMessageSerializerTests
    {
        ...
        public void Roundtrip()
        {
            ...
            using Network.P2P.Subprotocols.Eth.V63.Messages.GetNodeDataMessage ethMessage = new Network.P2P.Subprotocols.Eth.V63.Messages.GetNodeDataMessage(keys.ToPooledList());
