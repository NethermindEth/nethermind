...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class GetBlockBodiesMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            using Network.P2P.Subprotocols.Eth.V62.Messages.GetBlockBodiesMessage ethMessage = new Network.P2P.Subprotocols.Eth.V62.Messages.GetBlockBodiesMessage(new Hash256[] { a, b });
            GetBlockBodiesMessage message = new GetBlockBodiesMessage(1111, ethMessage);
