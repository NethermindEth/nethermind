...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class NodeDataMessageSerializerTests
    {
        ...
        public void Roundtrip()
        {
            ...
            using Network.P2P.Subprotocols.Eth.V63.Messages.NodeDataMessage ethMessage = new Network.P2P.Subprotocols.Eth.V63.Messages.NodeDataMessage(new ByteArrayListAdapter(data));
