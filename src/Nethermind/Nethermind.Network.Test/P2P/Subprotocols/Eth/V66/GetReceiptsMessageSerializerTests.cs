...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class GetReceiptsMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            Hash256[] hashes = { a, b };
            using Network.P2P.Subprotocols.Eth.V63.Messages.GetReceiptsMessage ethMessage = new Network.P2P.Subprotocols.Eth.V63.Messages.GetReceiptsMessage(hashes.ToPooledList());
