    ...
    public class BlockBodiesMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
                ...
                new byte[] { 0x77, 0x88 })
            {
                ...
                MixHash = Keccak.Zero,
                Nonce = 0,
                Hash = new Hash256("0x8c2f2af15b7b563b6ab1e09bed0e9caade7ed730aec98b70a993597a797579a9")
            };
            ...
            using Network.P2P.Subprotocols.Eth.V62.Messages.BlockBodiesMessage ethMessage = new()
            {
                Bodies = RlpBlockBodies.FromBodies([new BlockBody(new[] { tx1, tx2 }, new[] { header })])
            };
