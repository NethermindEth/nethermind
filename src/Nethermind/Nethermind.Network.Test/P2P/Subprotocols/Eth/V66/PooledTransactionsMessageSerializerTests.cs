...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class PooledTransactionsMessageSerializerTests
    {
        ...
        public void Roundtrip()
        {
            ...
            PooledTransactionsMessageSerializer serializer = new PooledTransactionsMessageSerializer(new Network.P2P.Subprotocols.Eth.V65.PooledTransactionsMessageSerializer());
