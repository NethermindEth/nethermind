...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class PooledTransactionsMessageSerializerTests
    {
        ...
        public void Roundtrip()
        {
            ...
            using Network.P2P.Subprotocols.Eth.V65.Messages.PooledTransactionsMessage ethMessage = new Network.P2P.Subprotocols.Eth.V65.Messages.PooledTransactionsMessage(new ArrayPoolList<Transaction>(2) { tx1, tx2 });
