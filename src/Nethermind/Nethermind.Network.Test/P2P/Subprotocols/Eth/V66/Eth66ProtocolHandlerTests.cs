...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class Eth66ProtocolHandlerTests
    {
        ...
        {
            using GetBlockHeadersMessage msg62 = new GetBlockHeadersMessage();
            using Network.P2P.Subprotocols.Eth.V66.Messages.GetBlockHeadersMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.GetBlockHeadersMessage(1111, msg62);
        ...
        {
            using BlockHeadersMessage msg62 = new BlockHeadersMessage(Build.A.BlockHeader.TestObjectNTimes(3).ToPooledList());
            using Network.P2P.Subprotocols.Eth.V66.Messages.BlockHeadersMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.BlockHeadersMessage(1111, msg62);
        ...
        {
            using GetBlockBodiesMessage msg62 = new GetBlockBodiesMessage(new[] { Keccak.Zero, TestItem.KeccakA });
            using Network.P2P.Subprotocols.Eth.V66.Messages.GetBlockBodiesMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.GetBlockBodiesMessage(1111, msg62);
        ...
        {
            using BlockBodiesMessage msg62 = new BlockBodiesMessage(Build.A.Block.TestObjectNTimes(3));
            using Network.P2P.Subprotocols.Eth.V66.Messages.BlockBodiesMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.BlockBodiesMessage(1111, msg62);
        ...
        {
            using Network.P2P.Subprotocols.Eth.V66.Messages.GetPooledTransactionsMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.GetPooledTransactionsMessage(new[] { Keccak.Zero, TestItem.KeccakA }.ToPooledList());
        ...
        public void Can_handle_pooled_transactions()
        {
            ...
            using PooledTransactionsMessage msg65 = new PooledTransactionsMessage(new ArrayPoolList<Transaction>(1) { tx });
            using Network.P2P.Subprotocols.Eth.V66.Messages.PooledTransactionsMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.PooledTransactionsMessage(1111, msg65);
        ...
        {
            using GetNodeDataMessage msg63 = new GetNodeDataMessage(new[] { Keccak.Zero, TestItem.KeccakA }.ToPooledList());
            using Network.P2P.Subprotocols.Eth.V66.Messages.GetNodeDataMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.GetNodeDataMessage(1111, msg63);
        ...
        {
            using NodeDataMessage msg63 = new NodeDataMessage(new ByteArrayListAdapter(ArrayPoolList<byte[]>.Empty()));
            using Network.P2P.Subprotocols.Eth.V66.Messages.NodeDataMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.NodeDataMessage(1111, msg63);
        ...
        {
            using GetReceiptsMessage msg63 = new GetReceiptsMessage(new[] { Keccak.Zero, TestItem.KeccakA }.ToPooledList());
            using Network.P2P.Subprotocols.Eth.V66.Messages.GetReceiptsMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.GetReceiptsMessage(1111, msg63);
        ...
        {
            using ReceiptsMessage msg63 = new ReceiptsMessage(ArrayPoolList<TxReceipt[]>.Empty());
            using Network.P2P.Subprotocols.Eth.V66.Messages.ReceiptsMessage msg66 = new Network.P2P.Subprotocols.Eth.V66.Messages.ReceiptsMessage(1111, msg63);
        ...
        {
            using StatusMessage statusMsg = new StatusMessage();
