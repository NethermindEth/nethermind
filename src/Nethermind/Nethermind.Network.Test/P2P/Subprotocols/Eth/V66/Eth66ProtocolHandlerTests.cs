...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V66
{
    ...
    public class Eth66ProtocolHandlerTests
    {
        ...
        {
            var msg62 = new GetBlockBodiesMessage(new[] { Keccak.Zero, TestItem._commitmentA });
        ...
        {
            var msg65 = new GetPooledTransactionsMessage(new[] { Keccak.Zero, TestItem._commitmentA });
        ...
        public void Can_handle_node_data()
        {
            ...
            HandleIncomingStatusMessage();
            ((ISyncPeer)_handler).GetNodeData(new List<Commitment>(new[] { Keccak.Zero }), CancellationToken.None);
        ...
        {
            var msg63 = new GetReceiptsMessage(new[] { Keccak.Zero, TestItem._commitmentA });
        ...
        public void Can_handle_receipts()
        {
            ...
            HandleIncomingStatusMessage();
            ((ISyncPeer)_handler).GetReceipts(new List<Commitment>(new[] { Keccak.Zero }), CancellationToken.None);
