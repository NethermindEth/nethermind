...
namespace Nethermind.Network.Test.P2P.Subprotocols.Eth.V62
{
    ...
    public class ZeroNewBlockMessageSerializerTests
    {
        ...
        {
            using DisposableByteBuffer byteBuffer = PooledByteBufferAllocator.Default.Buffer(1024).AsDisposable();
            ...
            Assert.That(bytes.ToHexString(), Is.EqualTo(expectedBytes.ToHexString()), "bytes");
        }
