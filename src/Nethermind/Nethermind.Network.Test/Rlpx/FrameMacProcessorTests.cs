...
namespace Nethermind.Network.Test.Rlpx
{
    ...
    public class FrameMacProcessorTests
    {
        ...
        public void Can_add_and_check_frame_mac()
        {
            ...
            FrameMacProcessor macProcessor = new FrameMacProcessor(TestObject.PublicKeyA,NetTestVectors.BuildSecretsWithSameIngressAndEgress());
        ...
        public void Egress_update_chunks_should_not_matter()
        {
            ...
            FrameMacProcessor macProcessorA = new FrameMacProcessor(TestObject.PublicKeyA,secretsA);
            ...
            FrameMacProcessor macProcessorB = new FrameMacProcessor(TestObject.PublicKeyA, secretsB);
