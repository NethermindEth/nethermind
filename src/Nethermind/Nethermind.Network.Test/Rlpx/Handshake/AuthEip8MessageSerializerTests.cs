...
public class AuthEip8MessageSerializerTests
{
    ...
    private void TestEncodeDecode(IEthereumEcdsa ecdsa)
    {
        ...
        Assert.That(Bytes.AreEqual(authMessage.Nonce, after.Nonce), Is.True);
    ...
    public void TestBadVersion()
    {
        ...
        using DisposableByteBuffer byteBuffer = Unpooled.Buffer().AsDisposable();
        byteBuffer.WriteBytes(Bytes.FromHexString(rawMsg));
