...
public record TransientResource(TransientResource.Size size) : IDisposable, IResettable
{
    ...
    public ShardedDictionary<HashedKey<TreePath>, TrieNode> ReadStateNodes = new();
    public ShardedDictionary<HashedKey<(Hash256AsKey, TreePath)>, TrieNode> ReadStorageNodes = new();
