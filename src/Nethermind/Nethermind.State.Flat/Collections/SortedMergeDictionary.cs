    ...
    where TKey : IEquatable<TKey>
{
    ...
    private static readonly ArrayPool<Entry> LargeEntryPool = ArrayPool<Entry>.Create(MaxPooledLargeArrayLength, MaxPooledLargeArraysPerSize);
    ...
    // Routed by length, so an array always goes back to the pool its length class rents from.
