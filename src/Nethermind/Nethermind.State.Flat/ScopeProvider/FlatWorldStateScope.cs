...
public sealed class FlatWorldStateScope : IWorldStateScopeProvider.IScope, ITrieWarmer.IAddressWarmer
{
    ...
    public void Commit(long blockNumber)
    {
        ...
        // Storage trees are already committed during WriteBatch disposal (commit: true in
        // StorageTreeBulkWriteBatch). Only the state tree still needs an explicit commit here.
        _stateTree.Commit();
