...
/// <summary>Read-only node source for the trie warmer: fills the shared committed-node cache without
/// touching a sparse arena, so warm-up stays lock-free across worker threads.</summary>
...
/// <inheritdoc cref="StateTrieStoreWarmerAdapter"/>
