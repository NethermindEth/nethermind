...
/// the account-count gauge and the account wipe counter form a sawtooth under sustained churn (slots likewise,
/// with their own gauge and wipe counter). A rising wipe rate for a kind is the signal that its cap is binding
/// and a warm working set is being discarded.
/// </remarks>
