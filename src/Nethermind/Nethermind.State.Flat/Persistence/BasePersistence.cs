...
public static class BasePersistence
{
    ...
    public interface IHashedFlatReader
    {
        ...
        /// <summary>Batched <see cref="TryGetStorage" />; default loops, RocksDB-backed readers override to coalesce.</summary>
    ...
    public interface IFlatReader
    {
        ...
        /// <summary>Batched <see cref="TryGetSlotRaw" />; default loops, RocksDB-backed readers override to coalesce.</summary>
