...
public class ResourcePool : IResourcePool
{
    ...
    public ResourcePool(IFlatDbConfig flatConfig)
    {
        ...
        _categories = new()
        {
            ...
            { Usage.MainBlockProcessing, new ResourcePoolCategory(Usage.MainBlockProcessing, Math.Max((int)flatConfig.CompactSize * 3, 8), 2, flat) },
            ...
            { Usage.Compact2, new ResourcePoolCategory(Usage.Compact2, 8, 1, flat) },
            { Usage.Compact4, new ResourcePoolCategory(Usage.Compact4, 6, 1, flat) },
            { Usage.Compact8, new ResourcePoolCategory(Usage.Compact8, 4, 1, flat) },
            { Usage.Compact16, new ResourcePoolCategory(Usage.Compact16, 4, 1, flat) },
            { Usage.Compact32, new ResourcePoolCategory(Usage.Compact32, 4, 1, flat) },
