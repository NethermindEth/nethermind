...
{
    internal class Tiger2 : BlockHash, ICryptoNotBuildIn
    {
        #region Consts

        private static readonly ulong[] s_T1 = 
        {
        ...
        private static readonly ulong[] s_T2 = 
        {
        ...
        private static readonly ulong[] s_T3 = 
        {
        ...
        private static readonly ulong[] s_T4 = 
        {
        ...
        private readonly ulong[] m_hash = new ulong[3];
        ...
        {
            return Converters.ConvertULongsToBytes(m_hash);
        }
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            c ^= data0;
            a -= s_T1[(byte)c] ^ s_T2[(byte)(c >> 16)] ^ s_T3[(byte)(c >> 32)] ^ s_T4[(byte)(c >> 48)];
            b += s_T4[(byte)(c >> 8)] ^ s_T3[(byte)(c >> 24)] ^ s_T2[(byte)(c >> 40)] ^ s_T1[(byte)(c >> 56)];
            b *= 5;

            a ^= data1;
            b -= s_T1[(byte)a] ^ s_T2[(byte)(a >> 16)] ^ s_T3[(byte)(a >> 32)] ^ s_T4[(byte)(a >> 48)];
            c += s_T4[(byte)(a >> 8)] ^ s_T3[(byte)(a >> 24)] ^ s_T2[(byte)(a >> 40)] ^ s_T1[(byte)(a >> 56)];
            c *= 5;

            b ^= data2;
            c -= s_T1[(byte)b] ^ s_T2[(byte)(b >> 16)] ^ s_T3[(byte)(b >> 32)] ^ s_T4[(byte)(b >> 48)];
            a += s_T4[(byte)(b >> 8)] ^ s_T3[(byte)(b >> 24)] ^ s_T2[(byte)(b >> 40)] ^ s_T1[(byte)(b >> 56)];
            a *= 5;
