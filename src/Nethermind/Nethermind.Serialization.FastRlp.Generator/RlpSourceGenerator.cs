...
public sealed class RlpSourceGenerator : IIncrementalGenerator
{
        ...
        List<(string Name, string TypeName)> parameters)
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine($"public static void Write(ref RlpWriter writer, {fullTypeName} value)");
        sb.AppendLine("{");
        sb.AppendLine("      throw new NotImplementedException();");
        sb.AppendLine("}");
        sb.AppendLine($"public static {fullTypeName} Read(ref RlpReader reader)");
        sb.AppendLine("{");
        sb.AppendLine("    return reader.ReadList(static (scoped ref RlpReader r) =>");
        sb.AppendLine("    {");
