...
{
    public sealed class ListValidator : AuRaValidatorProcessor
    {
        public ListValidator(AuRaParameters.Validator validator, ILogManager logManager) : base(logManager)
        {
