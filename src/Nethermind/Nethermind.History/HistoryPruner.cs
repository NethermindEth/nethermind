...
public class HistoryPruner : IHistoryPruner
{
    ...
    private bool TryLoadDeletePointers()
    {
        ...
        {
            UpdateBlocksDeletePointer(long.Max(blocksVal.AsRlpContext().DecodeLong(), _minDeletableBlockNumber));
        ...
        _balsDeletePointer = balsVal is null
            ...
            : long.Max(balsVal.AsRlpContext().DecodeLong(), _blocksDeletePointer);
