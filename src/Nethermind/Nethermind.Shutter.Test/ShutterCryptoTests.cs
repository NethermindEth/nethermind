...
class ShutterCryptoTests
{
    ...
    [Test]
    // todo: fix testcase
    // crypto version 3 probably causing problem
    [TestCase(
    ...
    {
        List<IdentityPreimage> identityPreimages = identityPreimagesHex.Select(i => new IdentityPreimage(Convert.FromHexString(i))).ToList();
