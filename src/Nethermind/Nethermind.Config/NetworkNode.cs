...
public class NetworkNode
{
    ...
    public IPAddress HostIp => IsEnode ? Enode.HostIp : Enr!.GetObj<IPAddress>(EnrContentKey.Ip) ?? IPAddress.None;
    public int Port => IsEnode ? Enode.Port : Enr!.GetValue<int>(EnrContentKey.Tcp) ?? 0;
