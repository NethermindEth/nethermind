    ...
    public class EthModuleBenchmarks
    {
        ...
        public void GlobalSetup()
        {
            ...
            BlockProcessor blockProcessor = new(specProvider, Always.Valid, new RewardCalculator(specProvider), transactionsExecutor,
                stateProvider, storageProvider, NullReceiptStorage.Instance, NullWitnessCollector.Instance, new ValidationWithdrawalApplier(stateProvider, LimboLogs.Instance), LimboLogs.Instance);
