...
{
    public class MeadowHashBenchmark
    {
        #region Constants
        ...
        #region Constructor
        private MeadowHashBenchmark(int size)
        {
            // Set the hash size
            HashSize = size;
        ...
        public static MeadowHashBenchmark Create(int size = HASH_SIZE)
        {
            return new MeadowHashBenchmark(size);
        }
