...
public class TrieNodeCacheTests
{
    ...
    {
        FlatDbConfig config = new FlatDbConfig { TrieCacheMemoryTarget = 0 };
    ...
    {
        FlatDbConfig config = new FlatDbConfig { TrieCacheMemoryTarget = 1 };
        Assert.DoesNotThrow(() => new TrieNodeCache(config, LimboLogs.Instance));
    }
    ...
    {
        FlatDbConfig zeroConfig = new FlatDbConfig { TrieCacheMemoryTarget = 0 };
