...
public class TrieNodeCacheTests
{
    ...
    public void Add_ThenTryGet_ReturnsNode()
    {
        ...
        transientResource.Nodes.SetAndLease(null, in path, hash, rlp).Dispose();
    ...
    public void Add_WithStorageAddress_ThenTryGet_ReturnsNode()
    {
        ...
        TransientResource transientResource = _resourcePool.GetCachedResource(ResourcePool.Usage.MainBlockProcessing);
        transientResource.Nodes.SetAndLease(address, in path, hash, rlp).Dispose();
        _cache.Add(transientResource);
    ...
    public void Add_MultipleNodes_AllRetrievable()
    {
        ...
        transientResource.Nodes.SetAndLease(null, in path1, hash1, rlp1).Dispose();
        transientResource.Nodes.SetAndLease(null, in path2, hash2, rlp2).Dispose();
        transientResource.Nodes.SetAndLease(null, in path3, hash3, rlp3).Dispose();
        _cache.Add(transientResource);
    ...
    public void Add_MixedStateAndStorageNodes_AllRetrievable()
    {
        ...
        transientResource.Nodes.SetAndLease(null, in statePath, stateHash, stateRlp).Dispose();
        transientResource.Nodes.SetAndLease(storageAddress, in storagePath, storageHash, storageRlp).Dispose();
        _cache.Add(transientResource);
    ...
    public void TryGet_ReturnsNull_WhenHashDoesNotMatch()
    {
        ...
        TransientResource transientResource = _resourcePool.GetCachedResource(ResourcePool.Usage.MainBlockProcessing);
        transientResource.Nodes.SetAndLease(null, in path, storedHash, rlp).Dispose();
        _cache.Add(transientResource);
    ...
    public void Add_OverwritesExistingNode_OnCollision()
    {
        ...
        transientResource1.Nodes.SetAndLease(null, in path, hash1, rlp1).Dispose();
        ...
        transientResource2.Nodes.SetAndLease(null, in path, hash2, rlp2).Dispose();
    ...
    public void Sharding_StorageNodes_ShardByAddressFirstByte()
    {
        ...
        TransientResource transientResource = _resourcePool.GetCachedResource(ResourcePool.Usage.MainBlockProcessing);
        transientResource.Nodes.SetAndLease(address1, in path, hash1, rlp1).Dispose();
        transientResource.Nodes.SetAndLease(address2, in path, hash2, rlp2).Dispose();
        _cache.Add(transientResource);
...
public class ChildCacheTests
{
    ...
    public void Set_ThenTryGet_ReturnsNode()
    {
        ...
        _cache.SetAndLease(null, in path, hash, rlp).Dispose();
    ...
    public void Set_WithStorageAddress_ThenTryGet_ReturnsNode()
    {
        ...
        _cache.SetAndLease(address, in path, hash, rlp).Dispose();
    ...
    public void TryGet_ReturnsNull_WhenHashMismatch()
    {
        ...
        _cache.SetAndLease(null, in path, storedHash, rlp).Dispose();
    ...
    public void Count_IncrementsOnSet()
    {
        ...
        _cache.SetAndLease(null, in path1, hash1, rlp1).Dispose();
        Assert.That(_cache.Count, Is.EqualTo(1));

        _cache.SetAndLease(null, in path2, hash2, rlp2).Dispose();
    ...
    public void Reset_ResizesCache_WhenCountExceedsCapacity()
    {
        ...
        for (int i = 0; i < initialCapacity * 3; i++)
        {
            ...
            Hash256 hash = Keccak.Compute(rlp);
            smallCache.SetAndLease(null, in path, hash, rlp).Dispose();
        }
    ...
    public void StateNodes_AndStorageNodes_AreSeparate()
    {
        ...
        _cache.SetAndLease(null, in path, stateHash, stateRlp).Dispose();
        _cache.SetAndLease(storageAddress, in path, storageHash, storageRlp).Dispose();
