...
public class BloomFilterTests
{
    ...
    {
        // Arrange
        using var bloom = new Nethermind.State.Flat.Persistence.BloomFilter.BloomFilter(capacity: 100, bitsPerKey: 10);
        ulong hash = 12345;
    ...
    {
        // Arrange
        using var bloom = new Nethermind.State.Flat.Persistence.BloomFilter.BloomFilter(capacity: 1000, bitsPerKey: 10);
        int threadsCount = 10;
    ...
    {
        // Arrange
        using var bloom = new Nethermind.State.Flat.Persistence.BloomFilter.BloomFilter(capacity: 10000, bitsPerKey: 10);
    ...
    {
        // Arrange
        var bloom = new Nethermind.State.Flat.Persistence.BloomFilter.BloomFilter(capacity: 100, bitsPerKey: 10);
    ...
    public void Add_LargeNumberOfItems_ShouldWork()
    {
        // Arrange
        int totalItems = 500;
        using var bloom = new Nethermind.State.Flat.Persistence.BloomFilter.BloomFilter(capacity: totalItems, bitsPerKey: 10);
