...
public class FlatWorldStateScopeProviderTests
{
    ...
    private static SnapshotBundle CreateSnapshotBundle(IResourcePool resourcePool, IPersistence.IPersistenceReader? persistenceReader = null)
    {
            ...
            _containerBuilder = new ContainerBuilder()
                    ...
                    .AddSingleton<IFlatDbManager>(_ =>
                    {
                        ...
                        flatDiff.GatherSnapshotBundle(Arg.Any<StateId>(), Arg.Any<ResourcePool.Usage>())
                            .Returns(_ => CreateSnapshotBundle(Container.Resolve<IResourcePool>()));
    ...
    public async Task TrieWarmupSession_IsSharedByOrdinaryHintsBalAndBorrowers()
    {
        ...
        scope.CreateStorageTree(TestItem.AddressA).HintSet((UInt256)2);
    ...
    public void TrieWarmupSession_StopsQueuedWarmupWhenMainWarmerStops()
    {
        ...
        using FlatScopeProvider provider = new(codeDb,
            ...
            new FlatDbConfig(), context.TrieWarmer, ResourcePool.Usage.MainBlockProcessing, UnavailableStateHeaderProvider.Instance,
    ...
    private sealed class RecordingPersistenceReader : IPersistence.IPersistenceReader
    {
        ...
        public bool TryGetSlot(Address requestedAddress, in UInt256 requestedSlot, ref UInt256 outValue) => false;
