...
public class FlatSnapServerTests
{
    ...
    public void SetUp()
    {
        ...
        _flatDbManager.GatherReadOnlySnapshotBundle(_stateId)
            .Returns(_ => new ReadOnlySnapshotBundle(new SnapshotPooledList(0), _persistence.CreateReader(), recordDetailedMetrics: false, PersistedSnapshotList.Empty(), new ArrayPoolList<PersistedSnapshotBloom>(0)));
