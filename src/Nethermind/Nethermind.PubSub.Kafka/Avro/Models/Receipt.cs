...
namespace Nethermind.PubSub.Kafka.Avro.Models
{
	...
	public partial class Receipt : ISpecificRecord
	{
		...
		private IList<Nethermind.PubSub.Kafka.Avro.Models.Log> _logs;
		...
		public IList<Nethermind.PubSub.Kafka.Avro.Models.Log> logs
		{
			get
			{
				return this._logs;
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			...
			case 6: this.logs = (IList<Nethermind.PubSub.Kafka.Avro.Models.Log>)fieldValue; break;
