...
namespace Nethermind.Network.Benchmarks
{
    public class Eth62ProtocolHandlerBenchmarks
    {
        ...
        public void SetUp()
        {
            ...
            _handler = new Eth62ProtocolHandler(session, _ser, stats, syncSrv, RunImmediatelyScheduler.Instance, txPool, Substitute.For<IBlockTree>(), Consensus.ShouldGossip.Instance, LimboLogs.Instance);
