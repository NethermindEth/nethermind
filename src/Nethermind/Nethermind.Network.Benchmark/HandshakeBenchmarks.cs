...
namespace Nethermind.Network.Benchmarks
{
    public class HandshakeBenchmarks
    {
        ...
        private readonly IEthereumEcdsa _ecdsa = new EthereumEcdsa(NetworkId.Ropsten, LimboLogs.Instance); // TODO: separate general crypto signer from Ethereum transaction signing
