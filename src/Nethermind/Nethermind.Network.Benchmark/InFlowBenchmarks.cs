...
namespace Nethermind.Network.Benchmarks
{
    public class InFlowBenchmarks
    {
        ...
        private readonly IByteBuffer _decoderBuffer = PooledByteBufferAllocator.Default.Buffer(MemorySizes.MiB);
        private NewBlockMessage _outputMessage = null!;

        private NewBlockMessageSerializer _newBlockMessageSerializer = null!;
        private Block _block = null!;
        private TestZeroMerger _zeroMerger = null!;
        private TestZeroDecoder _zeroDecoder = null!;
            ...
            : ZeroFrameDecoder(frameCipher, frameMacProcessor)
        {
            ...
            {
                List<object> result = [];
                base.Decode(CreateContext(), input, result);
