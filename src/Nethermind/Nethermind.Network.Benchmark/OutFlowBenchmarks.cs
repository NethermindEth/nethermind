...
namespace Nethermind.Network.Benchmarks
{
    public class OutFlowBenchmarks
    {
        ...
        private IByteBuffer _snappyBuffer = PooledByteBufferAllocator.Default.Buffer((int)MemorySizes.MiB);
        private IByteBuffer _splitterBuffer = PooledByteBufferAllocator.Default.Buffer((int)MemorySizes.MiB);
        private IByteBuffer _encoderBuffer = PooledByteBufferAllocator.Default.Buffer((int)MemorySizes.MiB);
        private IByteBuffer _outputBuffer = PooledByteBufferAllocator.Default.Buffer((int)MemorySizes.MiB);
