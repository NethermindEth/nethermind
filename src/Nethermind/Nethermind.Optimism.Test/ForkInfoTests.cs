...
public class ForkInfoTests
{
    ...
    [TestCase(38_950_927, 1_764_691_201ul, "0x1c215111", 0ul, "OP Mainnet - Jovian")]
    public void Fork_id_and_hash_as_expected(long head, ulong headTimestamp, string forkHashHex, ulong next, string description) =>
        Network.Test.ForkInfoTests.Test(head, headTimestamp, BaseMainnetGenesis, forkHashHex, next, description, "op-mainnet.json.zst");
