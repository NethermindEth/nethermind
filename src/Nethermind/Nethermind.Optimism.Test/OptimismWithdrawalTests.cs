...
public class OptimismWithdrawalTests
{
    ...
    public void WithdrawalsRoots_Should_Be_Set_According_To_Block_Timestamp(ulong timestamp, Hash256? withdrawalHash)
    {
        ...
        state.Set(new StorageCell(PreDeploys.L2ToL1MessagePasser, UInt256.One), new StorageValue([1]));
    ...
    public void WithdrawalsRoot_IsAlwaysUpToDate_PostIsthmus()
    {
        ...
        state.CreateAccount(PreDeploys.L2ToL1MessagePasser, 1, 1);
        state.Set(new StorageCell(PreDeploys.L2ToL1MessagePasser, UInt256.One), new StorageValue([10]));
        ...
        state.Set(new StorageCell(PreDeploys.L2ToL1MessagePasser, UInt256.One), new StorageValue([20]));
