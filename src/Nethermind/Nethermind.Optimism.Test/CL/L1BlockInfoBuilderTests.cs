...
public class L1BlockInfoBuilderTests
{
    ...
    public void MainnetSystemTx()
    {
        ...
        CLChainSpecEngineParameters parameters = new CLChainSpecEngineParameters { OptimismPortalProxy = TestItem.AddressA };
        DepositTransactionBuilder depositTransactionBuilder = new DepositTransactionBuilder(1, parameters);
