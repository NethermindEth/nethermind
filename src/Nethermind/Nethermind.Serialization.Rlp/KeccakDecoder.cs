...
namespace Nethermind.Serialization.Rlp
{
    ...
    public sealed class KeccakDecoder() : RlpDecoder<Hash256>
    {
        ...
        protected override Hash256? DecodeInternal(ref RlpReader decoderContext, RlpBehaviors rlpBehaviors = RlpBehaviors.None) => decoderContext.DecodeKeccak(allowNull: true);
