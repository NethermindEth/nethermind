...
public class BlockProcessingModule(IInitConfig initConfig, IBlocksConfig blocksConfig) : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        builder
            ...
            .AddScoped<IWorldState, IWorldStateScopeProvider, IBlocksConfig, ILogManager>((scope, blocksConfig, logManager) => new ParallelWorldState(new WorldState(scope, logManager), blocksConfig))
