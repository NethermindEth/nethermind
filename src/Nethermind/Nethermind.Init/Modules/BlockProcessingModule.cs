...
public class BlockProcessingModule(IInitConfig initConfig, IBlocksConfig blocksConfig) : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        builder
            ...
            // .AddDecorator<IWorldState>((IComponentContext ctx, IWorldState state) => new ParallelWorldState(state, true))
            .AddScoped<IWorldState, IWorldStateScopeProvider, ILogManager>((scope, logManager) => new ParallelWorldState(new WorldState(scope, logManager), true))
