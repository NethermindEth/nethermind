...
public class InitializeStateDb : IStep
{
    ...
    private void RunVerifyTrie()
    {
        try
        {
            ...
            IWorldState diagStateProvider = _worldStateManager.GlobalWorldState;
            diagStateProvider.StateRoot = _blockTree!.Head?.StateRoot ?? Keccak.EmptyTreeHash;
            TrieStats stats = diagStateProvider.CollectStats(_codeDb, _logManager);
