...
public interface ISnapshotConfig : IConfig
{
    ...
    [ConfigItem(Description = "The number of parallel connections the streaming snapshot download uses when the server supports range requests. Peak buffer memory is (connections + 1) x 64 MiB. Allowed range: 1-16.", DefaultValue = "4")]
