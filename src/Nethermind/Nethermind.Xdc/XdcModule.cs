...
public class XdcModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
            ...
            .AddSingleton<ISignTransactionManager, ISigner, ITxPool, IEpochSwitchManager, ISpecProvider, ILogManager>(CreateSignTransactionManager)
    ...
    private ISignTransactionManager CreateSignTransactionManager(ISigner signer, ITxPool txPool, IEpochSwitchManager epochSwitchManager, ISpecProvider specProvider, ILogManager logManager)
    {
        return new SignTransactionManager(signer, txPool, epochSwitchManager, specProvider, logManager.GetClassLogger<SignTransactionManager>());
    }
