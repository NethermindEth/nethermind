...
namespace Nethermind.Logging
{
    public class NLogLogger : ILogger
    {
        ...
        public NLogLogger(Type type, string fileName, string logDirectory = null, string loggerName = null)
        {
            ...
            var logsDir = string.IsNullOrEmpty(logDirectory) ? Path.Combine(Environment.CurrentDirectory, "logs") : logDirectory;
            ...
            {
                target.FileName = !Path.IsPathFullyQualified(fileName) ? Path.Combine(Path.Combine(Environment.CurrentDirectory, "logs"), fileName) : fileName;
            }
