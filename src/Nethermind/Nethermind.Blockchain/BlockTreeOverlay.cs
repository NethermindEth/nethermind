...
public class BlockTreeOverlay : IBlockTree
{
    ...
    public ulong BestKnownNumber => _overlayTree.BestKnownNumber > _baseTree.BestKnownNumber ? _overlayTree.BestKnownNumber : _baseTree.BestKnownNumber;
    public ulong BestKnownBeaconNumber => _overlayTree.BestKnownBeaconNumber > _baseTree.BestKnownBeaconNumber ? _overlayTree.BestKnownBeaconNumber : _baseTree.BestKnownBeaconNumber;
    public Hash256 HeadHash => _overlayTree.Head?.Hash ?? _baseTree.HeadHash;
