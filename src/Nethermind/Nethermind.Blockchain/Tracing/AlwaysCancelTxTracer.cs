...
public class AlwaysCancelTxTracer : ITxTracer
{
    ...
    public void MarkAsFailed(Address recipient, GasConsumed gasSpent, byte[] output, string? error, EvmExceptionType exceptionType, Hash256? stateRoot = null) => throw new OperationCanceledException(ErrorMessage);
