...
namespace Nethermind.Blockchain.Find
{
    ...
    public static class IBlockFinderExtensions
    {
        ...
        {
            return finder.FindHeader(header.ParentHash, options, blockNumber: (long)header.Number - 1);
        }
        ...
        public static Block? FindParent(this IBlockFinder finder, Block block, BlockTreeLookupOptions options)
        {
            ...
            return finder.FindBlock(block.Header.ParentHash, options, blockNumber: (long)block.Header.Number - 1);
        }
        ...
        public static Block? FindParent(this IBlockFinder finder, BlockHeader blockHeader, BlockTreeLookupOptions options)
        {
            ...
            return finder.FindBlock(blockHeader.ParentHash, options, blockNumber: (long)blockHeader.Number - 1);
        }
