...
namespace Nethermind.Blockchain.Contracts
{
    public abstract class CallableContract : Contract
    {
        ...
        protected object[] Call(BlockHeader header, string functionName, Address sender, long gasLimit,
            IWorldState worldState, params object[] arguments)
        {
        ...
        private bool TryCall(BlockHeader header, Transaction transaction, out byte[] result, IWorldState worldState)
        {
            ...
            try
            {
                _transactionProcessor.Execute(worldState, transaction, new BlockExecutionContext(header), tracer);
        ...
        protected bool TryCall(BlockHeader header, string functionName, Address sender, out object[] result,
            IWorldState worldState, params object[] arguments) =>
            TryCall(header, functionName, sender, DefaultContractGasLimit, worldState, out result, arguments);
        ...
        /// <param name="arguments">Arguments to the function.</param>
        /// <returns>true if function was <see cref="StatusCode.Success"/> otherwise false.</returns>
        protected bool TryCall(BlockHeader header, string functionName, Address sender, long gasLimit,
        ...
        public static void EnsureSystemAccount(IWorldState stateProvider)
        {
