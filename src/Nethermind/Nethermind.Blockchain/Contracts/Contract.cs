...
namespace Nethermind.Blockchain.Contracts
{
    ...
    public abstract partial class Contract
    {
        ...
        protected LogEntry GetSearchLogEntry(string eventName, byte[] data = null, params Commitment[] topics)
        {
            Commitment[] eventNameTopic = { AbiDefinition.GetEvent(eventName).GetHash() };
        ...
        protected LogEntry GetSearchLogEntry(string eventName, params Commitment[] topics) => GetSearchLogEntry(eventName, null, topics);
    }
}
