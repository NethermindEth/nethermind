...
namespace Nethermind.Blockchain
{
    ...
    public class ReadOnlyBlockTree : IReadOnlyBlockTree
    {
        ...
        public AddBlockResult SuggestBlock(Block block, bool shouldProcess = true, bool? setAsMain = null, bool poSEnabled = false) => throw new InvalidOperationException($"{nameof(ReadOnlyBlockTree)} does not expect {nameof(SuggestBlock)} calls");
