...
public class HeaderStore : IHeaderStore
{
    ...
    private static readonly ClockCache<Hash256AsKey, long> _numberCache = new(NumberCacheSize);
    private static readonly ClockCache<Hash256AsKey, BlockHeader> _headerCache = new(CacheSize);
    private static readonly ClockCache<Hash256AsKey, BlockHeader> _headerCanonicalCache = new(CacheSize);
    private static readonly ClockCache<Hash256AsKey, BlockHeader> _headerWithoutDifficultyCache = new(CacheSize);
    ...
    private static void CacheNumber(Hash256 blockHash, long blockNumber)
