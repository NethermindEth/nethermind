...
{
    public class BlockTransactionsExecutor : IBlockProcessor.IBlockTransactionsExecutor
    {
        private readonly ITransactionProcessorAdapter _transactionProcessor;
        private readonly IStateProvider _stateProvider;

        public BlockTransactionsExecutor(ITransactionProcessorAdapter transactionProcessor, IStateProvider stateProvider)
        {
