...
namespace Nethermind.Blockchain.Processing
{
    ...
    {
        public class StandardTransactionProcessor : IBlockProcessor.ITransactionProcessor
        {
            private readonly Evm.ITransactionProcessor _transactionProcessor;
            private readonly IStateProvider _stateProvider;
        
            public StandardTransactionProcessor(Evm.ITransactionProcessor transactionProcessor, IStateProvider stateProvider)
            {
