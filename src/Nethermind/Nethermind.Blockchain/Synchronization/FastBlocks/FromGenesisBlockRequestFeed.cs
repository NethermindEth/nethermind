...
{
    public class FromGenesisBlockRequestFeed : IBlockRequestFeed
    {
        ...
        public FromGenesisBlockRequestFeed(IBlockTree blockTree, IEthSyncPeerPool syncPeerPool, IBlockValidator blockValidator, ILogManager logManager)
        {
