...
namespace Nethermind.Blockchain.Synchronization
{
    public interface ISyncConfig : IConfig
    {
        ...
        [ConfigItem(Description = "[TECHNICAL] specify interval between malloc_trim during sync", DefaultValue = "300", DisabledForCli = true)]
        double MallocTrimIntervalSec { get; set; }
    }
}
