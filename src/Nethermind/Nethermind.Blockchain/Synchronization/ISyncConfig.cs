...
namespace Nethermind.Blockchain.Synchronization
{
    public interface ISyncConfig : IConfig
    {
        ...
        [ConfigItem(Description = "Max number of attempts to update pivot block basing on Forkchoice message from Consensus Layer. Only for PoS chains.", DefaultValue = "180")]
