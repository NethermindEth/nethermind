...
public interface ISyncConfig : IConfig
{
    ...
    [ConfigItem(Description = "_Technical._ Whether to enable the experimental `snap/2` protocol. Advertised alongside `snap/1` while snap serving is enabled.", DefaultValue = "false", HiddenFromDocs = true)]
