...
namespace Nethermind.Blockchain
{
    public interface IBlockTree : IBlockFinder
    {
        ...
        void UpdateHeadBlock(Commitment blockHash);
        ...
        bool IsKnownBlock(long number, Commitment blockHash);
        ...
        /// <param name="blockHash">Hash of the block to check</param>
        /// <returns><value>True</value> if known, otherwise <value>False</value></returns>
        bool IsKnownBeaconBlock(long number, Commitment blockHash);
        ...
        bool WasProcessed(long number, Commitment blockHash);
        ...
        (BlockInfo? Info, ChainLevelInfo? Level) GetInfo(long number, Commitment blockHash);

        ChainLevelInfo? FindLevel(long number);

        BlockInfo FindCanonicalBlockInfo(long blockNumber);

        Commitment FindHash(long blockNumber);
        ...
        void ForkChoiceUpdated(Commitment? finalizedBlockHash, Commitment? safeBlockBlockHash);
