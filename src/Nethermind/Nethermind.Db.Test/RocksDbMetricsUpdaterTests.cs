...
namespace Nethermind.Db.Test
{
    ...
    [NonParallelizable]
    public class RocksDbMetricsUpdaterTests
    {
        [TearDown]
        public void TearDow()
        {
        ...
        private static IEnumerable<TestCaseData> ProcessCompactionStatsTests
        {
            get
            {
                ...
                new RocksDbMetricsUpdater<DbOptions>("Test", null, null, null, null, new(logger)).ProcessCompactionStats(testDump);
        ...
        public void ProcessStats_AllDataExist()
        {
            ...
            new RocksDbMetricsUpdater<DbOptions>("Test", null, null, null, null, new(logger)).ProcessStatisticsString(testDump);
