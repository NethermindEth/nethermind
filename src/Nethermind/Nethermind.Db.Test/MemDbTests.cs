...
namespace Nethermind.Db.Test
{
    ...
    public class MemDbTests
    {
        ...
        public void Can_create_with_delays()
        {
            ...
            KeyValuePair<byte[], byte[]>[] some = memDb[new[] {TestItem.KeccakA.Bytes.ToArray()}];
        }
        ...
        public void Can_remove_key()
        {
            MemDb memDb = new();
            memDb.Set(TestItem.KeccakA, _sampleValue);
            memDb.Remove(TestItem.KeccakA.Bytes.ToArray());
        ...
        public void Can_get_some_keys()
        {
            ...
            memDb.Set(TestItem.KeccakA, _sampleValue);
            memDb.Set(TestItem.KeccakB, _sampleValue);
            KeyValuePair<byte[], byte[]>[] result = memDb[new[] {TestItem.KeccakB.Bytes.ToArray(), TestItem.KeccakB.Bytes.ToArray(), TestItem.KeccakC.Bytes.ToArray()}];
