...
public class RocksDbConfigFactoryTests
{
    ...
    public void CanFetchNormally()
    {
        ...
        RocksDbConfigFactory factory = new RocksDbConfigFactory(dbConfig, new PruningConfig(), new TestHardwareInfo(0), LimboLogs.Instance);
    ...
    public void WillOverrideStateConfigOnArchiveMode()
    {
        ...
        RocksDbConfigFactory factory = new RocksDbConfigFactory(dbConfig, pruningConfig, new TestHardwareInfo(0), LimboLogs.Instance);
        IRocksDbConfig config = factory.GetForDatabase("State0", null);
    ...
    {
        DbConfig dbConfig = new DbConfig();
        RocksDbConfigFactory factory = new RocksDbConfigFactory(dbConfig, new PruningConfig(), new TestHardwareInfo(100.GiB), LimboLogs.Instance);
        IRocksDbConfig config = factory.GetForDatabase("State0", null);
