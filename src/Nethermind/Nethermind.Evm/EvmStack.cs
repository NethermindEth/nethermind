...
public ref struct EvmStack
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        value = Bytes.ReverseEndianness(value);
        // ulong size
        if (TTracingInst.IsActive)
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        {
            ulong u3 = Bytes.ReverseEndianness(value.u3);
            ulong u2 = Bytes.ReverseEndianness(value.u2);
            ulong u1 = Bytes.ReverseEndianness(value.u1);
            ulong u0 = Bytes.ReverseEndianness(value.u0);
    ...
    public bool PopUInt256(out UInt256 result)
    {
        ...
        else
        {
            ...
            ulong u3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref bytes));
            ulong u2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, sizeof(ulong))));
            ulong u1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 2 * sizeof(ulong))));
            ulong u0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 3 * sizeof(ulong))));
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b)
    {
        ...
        else
        {
            ...
            ulong b3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref bytes));
            ulong a3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 32)));

            ulong b2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 8)));
            ulong a2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 40)));

            ulong b1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 16)));
            ulong a1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 48)));

            ulong b0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 24)));
            ulong a0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 56)));
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b, out UInt256 c)
    {
        ...
        else
        {
            ...
            ulong c3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref bytes));
            ulong b3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 32)));
            ulong a3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 64)));

            // Round 2: u2 from each value
            ulong c2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 8)));
            ulong b2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 40)));
            ulong a2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 72)));

            // Round 3: u1 from each value
            ulong c1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 16)));
            ulong b1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 48)));
            ulong a1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 80)));

            // Round 4: low qwords (u0) from each value
            ulong c0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 24)));
            ulong b0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 56)));
            ulong a0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 88)));
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b, out UInt256 c, out UInt256 d)
    {
        ...
        else
        {
            ...
            ulong d3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref bytes));
            ulong c3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 32)));
            ulong b3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 64)));
            ulong a3 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 96)));

            // Round 2: u2
            ulong d2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 8)));
            ulong c2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 40)));
            ulong b2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 72)));
            ulong a2 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 104)));

            // Round 3: u1
            ulong d1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 16)));
            ulong c1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 48)));
            ulong b1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 80)));
            ulong a1 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 112)));

            // Round 4: low qwords (u0)
            ulong d0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 24)));
            ulong c0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 56)));
            ulong b0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 88)));
            ulong a0 = Bytes.ReverseEndianness(Unsafe.ReadUnaligned<ulong>(ref Unsafe.Add(ref bytes, 120)));
    ...
    public bool TryPopSmallIndex(out uint value)
    {
        ...
        ulong low = Bytes.ReverseEndianness(
