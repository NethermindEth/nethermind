...
namespace Nethermind.Evm.TransactionProcessing
{
    public class TransactionProcessor : ITransactionProcessor
    {
        ...
        public TransactionResult BuildUp(Transaction transaction, BlockExecutionContext blCtx, ITxTracer txTracer)
        {
            ...
            return Execute(transaction, blCtx, txTracer, ExecutionOptions.None);
        }
            ...
            in UInt256 effectiveGasPrice)
        {
            ...
            TxExecutionContext executionContext = new(blCtx, tx.SenderAddress, effectiveGasPrice, tx.BlobVersionedHashes);
