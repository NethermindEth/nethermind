    ...
    where TGasPolicy : struct, IGasPolicy<TGasPolicy>
{
    ...
    protected override TransactionResult Execute<TLogTracing>(Transaction tx, ITxTracer tracer, ExecutionOptions opts)
    {
        ...
        return base.Execute<TLogTracing>(tx, tracer, (opts != ExecutionOptions.SkipValidation && !opts.HasFlag(ExecutionOptions.SkipValidationAndCommit) && !opts.HasFlag(ExecutionOptions.Warmup))
