    ...
    where TLogger : struct, IIsTracing
{
    ...
    private static readonly LruCache<ValueCommitment, CodeInfo> _codeCache = new(MemoryAllowance.CodeCacheSize, MemoryAllowance.CodeCacheSize, "VM bytecodes");
    ...
    public CodeInfo GetCachedCodeInfo(IWorldState worldState, Address codeSource, IReleaseSpec vmSpec)
    {
        ...
        Commitment codeHash = worldState.GetCodeHash(codeSource);
                ...
                case Instruction.BLOCKHASH:
                    {
                        ...
                        Commitment blockHash = _blockhashProvider.GetBlockhash(blkCtx.Header, number);
...
ReturnFailure:
        ...
        where TTracing : struct, IIsTracing
    {
        ...
        Commitment[] topics = new Commitment[topicsCount];
        for (int i = 0; i < topicsCount; i++)
        {
            topics[i] = new Commitment(stack.PopWord256());
        }
