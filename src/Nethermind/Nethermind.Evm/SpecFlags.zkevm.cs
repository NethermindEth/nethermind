...
// Do not edit by hand: SpecFlagsTests recomputes this and fails with the replacement text.
// To change the range, edit the Floor and Max constants in SpecFlagsTests and rerun it.
...
{
    /// <summary>Rules that hold the same value across every fork in the range, as constants.</summary>
    /// <remarks>
    ...
    // EIP-2780, EIP-7708, EIP-8037 and EIP-8038 activate at Amsterdam, inside the range, so they
    // stay dynamic. Raising the floor past Amsterdam would fold these too.
