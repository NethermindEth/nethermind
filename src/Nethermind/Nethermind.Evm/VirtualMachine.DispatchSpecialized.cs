...
/// <summary>
/// The tail-call opcode-table interpreter dispatch loop. Fork gates are compile-time <see cref="IFlag"/> type
/// args (<c>TShift</c>: EIP-145, <c>TPush0</c>: EIP-3855) that the JIT folds.
/// </summary>
public unsafe partial class VirtualMachine<TGasPolicy>
{
    ...
    /// <remarks>
    /// Implemented per build so the standard runtime and constrained guest can use different opcode-table
    /// lifetimes without branching in the instruction path.
    /// </remarks>
