...
namespace Nethermind.Evm.Tracing.ParityStyle
{
    ...
    {
        private readonly IDictionary<Commitment, ParityTraceTypes>? _typesByTransaction;
        private Block? _block;
        private readonly ParityTraceTypes _types;

        public ParityLikeBlockTracer(Commitment txHash, ParityTraceTypes types)
            : base(txHash)
        {
            _types = types;
        ...
        public ParityLikeBlockTracer(IDictionary<Commitment, ParityTraceTypes> typesByTransaction)
        {
