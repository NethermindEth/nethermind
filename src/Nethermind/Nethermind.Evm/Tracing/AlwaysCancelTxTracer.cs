...
namespace Nethermind.Evm.Tracing
{
    ...
    public class AlwaysCancelTxTracer : ITxTracer
    {
        ...
        public void StartOperation(int depth, long gas, Instruction opcode, int pc, bool isPostMerge = false, IReleaseSpec? spec = null) => throw new OperationCanceledException(ErrorMessage);
