...
public class CodeInfoRepository : ICodeInfoRepository
{
    ...
    private static CodeInfo InternalGetCachedCode(IWorldState worldState, Address codeSource, IReleaseSpec vmSpec)
    {
    ...
    private static CodeInfo InternalGetCachedCode(IReadOnlyStateProvider worldState, in ValueHash256 codeHash, IReleaseSpec vmSpec)
    {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        static CodeInfo GetCodeFromState(IReadOnlyStateProvider worldState, ValueHash256 codeHash, IReleaseSpec vmSpec)
        {
            ...
            CodeInfo cachedCodeInfo = CodeInfoFactory.CreateCodeInfo(code, vmSpec, ValidationStrategy.ExtractHeader);
    ...
    public ValueHash256 GetExecutableCodeHash(Address address, IReleaseSpec spec)
    {
        ...
        CodeInfo codeInfo = InternalGetCachedCode(_worldState, address, spec);
