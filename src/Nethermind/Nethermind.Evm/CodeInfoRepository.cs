...
public class CodeInfoRepository : ICodeInfoRepository
{
    ...
    private static CodeInfo InternalGetCachedCode(IAccountStateProviderWithCode worldState, Address codeSource)
    {
    ...
    public bool TryGetDelegation(IAccountStateProviderWithCode worldState, Address address, [NotNullWhen(true)] out Address? delegatedAddress) =>
