...
public struct EthereumGasPolicy : IGasPolicy<EthereumGasPolicy>
{
    ...
    public static IntrinsicGas<EthereumGasPolicy> CalculateIntrinsicGas(Transaction tx, IReleaseSpec spec)
    {
        ...
        long tokensInAccessList = IGasPolicy<EthereumGasPolicy>.CalculateTokensInAccessList(tx, spec);
        ...
        long regularGas = GasCostOf.Transaction
                          ...
                          + CreateCost(tx, spec)
                          + IGasPolicy<EthereumGasPolicy>.AccessListCost(tx, spec, tokensInAccessList)
                          + authRegularCost;
        long floorCost = IGasPolicy<EthereumGasPolicy>.CalculateFloorCost(tx, spec, tokensInCallData, tokensInAccessList);
