...
public static partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        if (!TGasPolicy.UpdateMemoryCost(ref gas, in result, 32UL, vmState.Memory))
        {
            goto OutOfGas;
        }
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        if (!TGasPolicy.UpdateMemoryCost(ref gas, in result, 1UL, vmState.Memory))
        {
            goto OutOfGas;
        }
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        if (!TGasPolicy.UpdateMemoryCost(ref gas, UInt256.Max(b, a), c, vmState.Memory))
        {
            goto OutOfGas;
        }
