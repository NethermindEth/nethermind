...
internal static partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        TGasPolicy.ConsumeCodeCopyGas(ref gas, isExternalCode: false, GasCostOf.VeryLow, GasCostOf.Memory * EvmCalculations.Div32Ceiling(in result, out bool outOfGas));
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        TGasPolicy.ConsumeCodeCopyGas(ref gas, isExternalCode: true, spec.GetExtCodeCost(), GasCostOf.Memory * EvmCalculations.Div32Ceiling(in result, out bool outOfGas));
        if (outOfGas) goto OutOfGas;
