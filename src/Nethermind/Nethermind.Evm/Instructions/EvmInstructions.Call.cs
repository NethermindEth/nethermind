...
internal static partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        // When EIP-7907 is inactive, defer the code lookup to after the depth/balance
        // check to avoid unnecessary cache misses for calls that will fail.
        CodeInfo codeInfo;
    ...
    /// <summary>
    /// EIP-7907: look up the code and charge for large contract access.
    /// Kept out-of-line so the JIT keeps InstructionCall lean on pre-Osaka networks.
    /// </summary>
    ...
    /// <summary>
    /// EIP-7907: look up the code and charge for large contract access in EXTCODECOPY.
    /// Kept out-of-line so the JIT keeps InstructionExtCodeCopy lean on pre-Osaka networks.
    /// </summary>
    [MethodImpl(MethodImplOptions.NoInlining)]
