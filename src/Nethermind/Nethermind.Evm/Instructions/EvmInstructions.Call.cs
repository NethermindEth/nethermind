...
public static partial class EvmInstructions
{
        ...
        where TEip7708 : struct, IFlag
    {
        ...
        if (!TGasPolicy.ConsumeCallBaseGas(ref gas, spec) ||
            !TGasPolicy.UpdateMemoryCost(ref gas, in dataOffset, dataLength, vm.VmState.Memory) ||
            !TGasPolicy.UpdateMemoryCost(ref gas, in outputOffset, outputLength, vm.VmState.Memory))
            goto OutOfGas;
        ...
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
    {
        ...
        if (!TGasPolicy.UpdateMemoryCost(ref gas, in position, in length, vm.VmState.Memory) ||
