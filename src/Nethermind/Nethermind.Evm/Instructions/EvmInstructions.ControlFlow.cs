...
internal static partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        TGasPolicy.ConsumeGas(ref gasState, GasCostOf.Base, Instruction.PC);
        ...
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
    {
        ...
        TGasPolicy.ConsumeGas(ref gasState, GasCostOf.JumpDest, Instruction.JUMPDEST);
        ...
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
    {
        ...
        {
            TGasPolicy.ConsumeGas(ref gasState, GasCostOf.SelfDestructEip150, Instruction.SELFDESTRUCT);
        }
        ...
        if (!EvmCalculations.ChargeAccountAccessGas(ref gasState, vm, inheritor, Instruction.SELFDESTRUCT, false))
            goto OutOfGas;
