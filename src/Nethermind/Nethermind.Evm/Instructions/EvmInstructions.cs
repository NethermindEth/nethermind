...
public static unsafe partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        delegate*<VirtualMachine<TGasPolicy>, ref EvmStack, ref TGasPolicy, int, OpcodeResult>[] lookup = new delegate*<VirtualMachine<TGasPolicy>, ref EvmStack, ref TGasPolicy, int, OpcodeResult>[byte.MaxValue + 1];
