...
internal static unsafe partial class EvmInstructions
{
    ...
    public static delegate*<VirtualMachine<TGasPolicy>, ref EvmStack, ref GasState<TGasPolicy>, ref int, EvmExceptionType>[] GenerateOpCodes<TGasPolicy, TTracingInst>(IReleaseSpec spec)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        // Allocate lookup table for all possible opcodes.
        var lookup = new delegate*<VirtualMachine<TGasPolicy>, ref EvmStack, ref GasState<TGasPolicy>, ref int, EvmExceptionType>[byte.MaxValue + 1];
        ...
        // Environment opcodes.
        lookup[(int)Instruction.ADDRESS] = &InstructionEnvAddress<TGasPolicy, OpAddress, TTracingInst>;
        ...
        lookup[(int)Instruction.CALLER] = &InstructionEnvAddress<TGasPolicy, OpCaller, TTracingInst>;
        lookup[(int)Instruction.CALLVALUE] = &InstructionEnvUInt256<TGasPolicy, OpCallValue, TTracingInst>;
        lookup[(int)Instruction.CALLDATALOAD] = &InstructionCallDataLoad<TGasPolicy, TTracingInst>;
        lookup[(int)Instruction.CALLDATASIZE] = &InstructionEnvUInt32<TGasPolicy, OpCallDataSize, TTracingInst>;
        lookup[(int)Instruction.CALLDATACOPY] =
            &InstructionCodeCopy<TGasPolicy, OpCallDataCopy<TGasPolicy>, TTracingInst>;
        lookup[(int)Instruction.CODESIZE] = &InstructionEnvUInt32<TGasPolicy, OpCodeSize, TTracingInst>;
        ...
        lookup[(int)Instruction.MSIZE] = &InstructionEnvUInt64<TGasPolicy, OpMSize, TTracingInst>;
