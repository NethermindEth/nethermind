...
internal static unsafe partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        // Jump instructions.
        lookup[(int)Instruction.JUMP] = &InstructionJump<TGasPolicy, TTracingInst>;
        lookup[(int)Instruction.JUMPI] = &InstructionJumpIf<TGasPolicy, TTracingInst>;
        ...
        switch (spec.IsEip150Enabled, spec.IsEip158Enabled, spec.IsEip7907Enabled, spec.IsEip2929Enabled)
        {
            case (true, true, true, true):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OnFlag, OnFlag, OnFlag>(lookup, spec);
                break;
            case (true, true, true, false):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OnFlag, OnFlag, OffFlag>(lookup, spec);
                break;
            case (true, true, false, true):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OnFlag, OffFlag, OnFlag>(lookup, spec);
                break;
            case (true, true, false, false):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OnFlag, OffFlag, OffFlag>(lookup, spec);
                break;
            case (true, false, true, true):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OffFlag, OnFlag, OnFlag>(lookup, spec);
                break;
            case (true, false, true, false):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OffFlag, OnFlag, OffFlag>(lookup, spec);
                break;
            case (true, false, false, true):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OffFlag, OffFlag, OnFlag>(lookup, spec);
                break;
            case (true, false, false, false):
                AddCalls<TGasPolicy, TTracingInst, OnFlag, OffFlag, OffFlag, OffFlag>(lookup, spec);
                break;
            case (false, true, true, true):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OnFlag, OnFlag, OnFlag>(lookup, spec);
                break;
            case (false, true, true, false):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OnFlag, OnFlag, OffFlag>(lookup, spec);
                break;
            case (false, true, false, true):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OnFlag, OffFlag, OnFlag>(lookup, spec);
                break;
            case (false, true, false, false):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OnFlag, OffFlag, OffFlag>(lookup, spec);
                break;
            case (false, false, true, true):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OffFlag, OnFlag, OnFlag>(lookup, spec);
                break;
            case (false, false, true, false):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OffFlag, OnFlag, OffFlag>(lookup, spec);
                break;
            case (false, false, false, true):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OffFlag, OffFlag, OnFlag>(lookup, spec);
                break;
            case (false, false, false, false):
                AddCalls<TGasPolicy, TTracingInst, OffFlag, OffFlag, OffFlag, OffFlag>(lookup, spec);
                break;
        }
    ...
    private static void AddCalls<TGasPolicy, TTracingInst, EIP150, EIP158, EIP7907, EIP2929>(delegate*<VirtualMachine<TGasPolicy>, ref EvmStack, ref TGasPolicy, int, OpcodeResult>[] lookup, IReleaseSpec spec)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    ...
    {
        lookup[(int)Instruction.CALL] = &InstructionCall<TGasPolicy, OpCall, TTracingInst, EIP150, EIP158, EIP7907, EIP2929>;
        lookup[(int)Instruction.CALLCODE] = &InstructionCall<TGasPolicy, OpCallCode, TTracingInst, EIP150, EIP158, EIP7907, EIP2929>;
        if (spec.DelegateCallEnabled)
        {
            lookup[(int)Instruction.DELEGATECALL] = &InstructionCall<TGasPolicy, OpDelegateCall, TTracingInst, EIP150, EIP158, EIP7907, EIP2929>;
        }
        if (spec.StaticCallEnabled)
        {
            lookup[(int)Instruction.STATICCALL] = &InstructionCall<TGasPolicy, OpStaticCall, TTracingInst, EIP150, EIP158, EIP7907, EIP2929>;
        }
    }
}
