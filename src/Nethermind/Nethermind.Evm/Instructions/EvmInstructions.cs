...
internal static unsafe partial class EvmInstructions
{
    ...
    public static Array GenerateOpCodes<TGasPolicy, TTracingInst>(IReleaseSpec spec)
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        {
            lookup[(int)Instruction.EXTCODEHASH] = spec.IsEofEnabled ? &InstructionExtCodeHashEof<TGasPolicy,
                    TTracingInst>
        ...
        lookup[(int)Instruction.SSTORE] = spec.UseNetGasMetering ?
            (spec.UseNetGasMeteringWithAStipendFix ? &InstructionSStoreMetered<TGasPolicy, TTracingInst, OnFlag>
