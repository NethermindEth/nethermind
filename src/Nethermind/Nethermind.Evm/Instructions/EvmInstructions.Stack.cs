...
internal static partial class EvmInstructions
{
        ...
        where TTracingInst : struct, IFlag
    {
                ...
                is Instruction.JUMP or Instruction.JUMPI))
        {
            ...
            if (!Jump<TTracingInst>((int)destination, ref programCounter, vm.CallFrame.CodeInfo))
        ...
        where TOpCount : struct, IOpCount
    {
        ...
        if (callFrame.IsStatic) goto StaticCallViolation;
        ...
        if (!TGasPolicy.UpdateMemoryCost(ref gas, in position, length, callFrame)) goto OutOfGas;
        ...
        if (!callFrame.Memory.TryLoad(in position, length, out ReadOnlyMemory<byte> data))
            goto OutOfGas;
        ...
        LogEntry logEntry = new(
            ...
            data.ToArray(),
            topics);
        vm.TrackingState.Logs.Add(logEntry);
