...
public partial class Secp256r1FastCryptoPrecompile : IPrecompile<Secp256r1FastCryptoPrecompile>
{
    private static readonly byte[] ValidResult = new byte[] { 1 }.PadLeft(32);

    public static readonly Secp256r1FastCryptoPrecompile Instance = new();
    ...
    private static unsafe partial byte VerifyBytesFast(byte* data, int length);
    ...
    public unsafe (byte[], bool) Run(ReadOnlyMemory<byte> input, IReleaseSpec releaseSpec)
    {
        ...
        {
            isValid = VerifyBytesFast(ptr, input.Length) != 0;
        }
