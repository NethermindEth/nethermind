...
public partial class Secp256r1RustPrecompile : IPrecompile<Secp256r1RustPrecompile>
{
    private static readonly byte[] ValidResult = new byte[] { 1 }.PadLeft(32);

    public static readonly Secp256r1RustPrecompile Instance = new();
    ...
    [LibraryImport("Binaries/rust/secp256r1", SetLastError = true)]
