...
public partial class Secp256r1GoBoringPrecompile : IPrecompile<Secp256r1GoBoringPrecompile>
{
    private static readonly byte[] ValidResult = new byte[] { 1 }.PadLeft(32);

    public static readonly Secp256r1GoBoringPrecompile Instance = new();
    ...
    [LibraryImport("Binaries/go/secp256r1-boring", SetLastError = true)]
