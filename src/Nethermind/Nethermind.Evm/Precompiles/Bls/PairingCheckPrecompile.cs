...
public class PairingCheckPrecompile : IPrecompile<PairingCheckPrecompile>
{
    ...
    public long BaseGasCost(IReleaseSpec releaseSpec) => 78000L;

    public long DataGasCost(ReadOnlyMemory<byte> inputData, IReleaseSpec releaseSpec) => 51600L * (inputData.Length / PairSize);
