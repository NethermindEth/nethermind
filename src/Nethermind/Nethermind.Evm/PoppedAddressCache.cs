...
/// direct-mapped table. Repeated addresses dominate real traffic, and multicalls and token loops cycle through a few
/// dozen, which overflowed the earlier four-entry FIFO and allocated on every pop.
/// Not thread-safe; owned by a single <see cref="VirtualMachine{TGasPolicy}"/>.
/// </summary>
