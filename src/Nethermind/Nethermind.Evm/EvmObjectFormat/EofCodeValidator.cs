...
public static class EofValidator
{
    ...
    {
        // Direct byte comparison avoids StartsWith overhead and static cctor check for MAGIC property
        if (container.Length > VERSION_OFFSET && container[0] == 0xEF && container[1] == 0x00)
        {
