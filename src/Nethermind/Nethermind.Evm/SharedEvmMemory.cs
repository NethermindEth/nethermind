...
{
    /// <summary>Fixed reserve size, in bytes. Frames beyond it spill to a private array. Backed by OS
    /// demand-zero pages, so untouched capacity costs address space, not physical RAM.</summary>
