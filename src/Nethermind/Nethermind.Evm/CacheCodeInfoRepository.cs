...
public class CacheCodeInfoRepository : ICodeInfoRepository
{
    ...
    private CodeInfo GetOrCacheCodeInfo(ValueHash256 codeHash, IReleaseSpec spec, int? blockAccessIndex = null)
    {
        ...
        {
            cachedCodeInfo = CodeInfoRepository.GetCodeInfo(_worldState, in codeHash, spec, blockAccessIndex);
