...
internal static class StreamInterpreter
{
    ...
    // four entries that stay on the direct/precharged path for each general boundary. MLOAD/MSTORE/MCOPY
    // are counted as direct entries because RunStream has dedicated handlers for them.
    internal const int MinFastEntriesPerGeneralBoundary = 4;
