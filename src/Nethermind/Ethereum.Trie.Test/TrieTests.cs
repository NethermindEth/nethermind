...
namespace Ethereum.Trie.Test
{
    public class TrieTests
    {
        ...
        {
            PatriciaTree patriciaTree = new PatriciaTree(_db, Keccak.EmptyTreeHash, false, true, NullLogManager.Instance);
            patriciaTree.Set(ValueKeccak.Compute("1").Bytes, new byte[0]);
        ...
        {
            PatriciaTree patriciaTree = new PatriciaTree(_db, Keccak.EmptyTreeHash, false, true, NullLogManager.Instance);
            patriciaTree.Set(ValueKeccak.Compute("1123").Bytes, new byte[] { 1 });
            patriciaTree.Set(ValueKeccak.Compute("1124").Bytes, new byte[] { 2 });
            Keccak rootBefore = patriciaTree.RootHash;
            patriciaTree.Set(ValueKeccak.Compute("1125").Bytes, new byte[0]);
        ...
        {
            PatriciaTree patriciaTree = new PatriciaTree(_db, Keccak.EmptyTreeHash, false, true, NullLogManager.Instance);
            patriciaTree.Set(ValueKeccak.Compute("1234567").Bytes, new byte[] { 1 });
            patriciaTree.Set(ValueKeccak.Compute("1234501").Bytes, new byte[] { 2 });
            patriciaTree.UpdateRootHash();
            Keccak rootBefore = patriciaTree.RootHash;
            patriciaTree.Set(ValueKeccak.Compute("1234502").Bytes, new byte[0]);
            patriciaTree.UpdateRootHash();
            Assert.AreEqual(rootBefore, patriciaTree.RootHash);
        }
