...
public class EthereumStepsLoaderTests
{
    ...
    public void BuildInSteps_IsCorrect()
    {
        ...
        HashSet<Type> optionalSteps = [typeof(RunVerifyTrie), typeof(ImportFlatDb), typeof(StartFlatOrphanStorageSweep), typeof(SeedFlatHistoryGenesis), typeof(StartHistoryWindowPruner), typeof(StartHistoryWalkVerification)];
