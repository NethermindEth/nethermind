...
public class TransactionComparisonTests
{
    ...
    private class TestingContext
    {
        ...
        public IComparer<Transaction> GetProducerComparer(BlockPreparationContext blockPreparationContext) => _transactionComparerProvider.GetDefaultProducerComparer(blockPreparationContext);
