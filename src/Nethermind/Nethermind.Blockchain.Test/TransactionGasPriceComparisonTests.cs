    ...
    public class TransactionComparisonTests
    {
        ...
        private class TestingContext
        {
            ...
            public TestingContext(bool isEip1559Enabled = false, long eip1559TransitionBlock = 0)
            {
                ...
                specProvider.GetSpec(Arg.Is<ForkActivation>(x => x >= new ForkActivation(eip1559TransitionBlock, null))).Returns(eip1559ReleaseSpec);
                specProvider.GetSpec(Arg.Is<ForkActivation>(x => x < new ForkActivation(eip1559TransitionBlock, null))).Returns(releaseSpec);
