...
namespace Nethermind.Blockchain.Test
{
    ...
    public class BlockTreeTests
    {
        private BlockTree BuildBlockTree()
        {
            ...
            return new BlockTree(_blocksDb, _headersDb, _blocksInfosDb, new BlockInfoRepository(_blocksInfosDb),  MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
        }
        ...
        public void Can_load_best_known_up_to_256million()
        {
            ...
            BlockTree blockTree = new BlockTree(_blocksDb, _headersDb, blocksInfosDb, new BlockInfoRepository(blocksInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
        ...
        public void Can_init_head_block_from_db_by_header()
        {
            ...
            BlockTree blockTree = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), OlympicSpecProvider.Instance, Substitute.For<ITxPool>(), LimboLogs.Instance);
        ...
        public void When_deleting_invalid_block_deletes_its_descendants()
        {
            ...
            MemDb blockInfosDb = new MemDb();
            MemDb headersDb = new MemDb();
            BlockTree tree = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
            Block block0 = Build.A.Block.WithNumber(0).WithDifficulty(1).TestObject;
            Block block1 = Build.A.Block.WithNumber(1).WithDifficulty(2).WithParent(block0).TestObject;
            Block block2 = Build.A.Block.WithNumber(2).WithDifficulty(3).WithParent(block1).TestObject;
            Block block3 = Build.A.Block.WithNumber(3).WithDifficulty(4).WithParent(block2).TestObject;
...
#pragma warning restore 4014
        ...
        public async Task Can_load_from_DB_when_there_is_an_invalid_block_in_DB_and_a_valid_branch()
        {
            ...
            MemDb blockInfosDb = new MemDb();
            MemDb headersDb = new MemDb();
            BlockTree tree1 = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
            ...
            BlockTree tree2 = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
...
#pragma warning restore 4014
        ...
        public void Loads_lowest_inserted_header_correctly(long beginIndex, long insertedBlocks)
        {
            ...
            BlockTree tree = new BlockTree(blocksDb, headersDb,blockInfosDb, new BlockInfoRepository(blockInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, syncConfig, LimboLogs.Instance);
            ...
            BlockTree loadedTree = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), MainNetSpecProvider.Instance, NullTxPool.Instance, syncConfig, LimboLogs.Instance);
        ...
        public void When_block_is_moved_to_main_transactions_are_removed_from_tx_pool()
        {
            ...
            BlockTree blockTree = new BlockTree(blocksDb, headersDb, blockInfosDb, new BlockInfoRepository(blockInfosDb), OlympicSpecProvider.Instance, txPoolMock, LimboLogs.Instance);
            Block block0 = Build.A.Block.WithNumber(0).WithDifficulty(1).TestObject;
