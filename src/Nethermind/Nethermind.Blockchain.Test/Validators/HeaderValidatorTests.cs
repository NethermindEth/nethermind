...
namespace Nethermind.Blockchain.Test.Validators
{
    ...
    public class HeaderValidatorTests
    {
        ...
        public void Setup()
        {
            EthashDifficultyCalculator calculator = new(new SingleReleaseSpecProvider(Frontier.Instance, TestBlockchainIds.NetworkId, TestBlockchainIds.ChainId));
            ...
            _specProvider = new SingleReleaseSpecProvider(Byzantium.Instance, TestBlockchainIds.NetworkId, TestBlockchainIds.ChainId);
