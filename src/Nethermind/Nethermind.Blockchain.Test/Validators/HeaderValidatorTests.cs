...
namespace Nethermind.Blockchain.Test.Validators
{
    ...
    public class HeaderValidatorTests
    {
        ...
        public void Setup()
        {
            EthashDifficultyCalculator calculator = new(new SingleReleaseSpecProvider(Frontier.Instance, TestChainIds.NetworkId, TestChainIds.ChainId));
            ...
            _specProvider = new SingleReleaseSpecProvider(Byzantium.Instance, TestChainIds.NetworkId, TestChainIds.ChainId);
