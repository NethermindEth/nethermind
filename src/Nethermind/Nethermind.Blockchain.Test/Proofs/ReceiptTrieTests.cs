...
namespace Nethermind.Blockchain.Test.Proofs
{
    public class ReceiptTrieTests
    {
        ...
        public void Can_calculate_root_no_eip_658()
        {
            ...
            Commitment rootHash = ReceiptTrie.CalculateRoot(MainnetSpecProvider.Instance.GetSpec((1, null)), new[] { receipt });
        ...
        {
            TxReceipt receipt = Build.A.Receipt.WithAllFieldsFilled.TestObject;
            Commitment rootHash = ReceiptTrie.CalculateRoot(MainnetSpecProvider.Instance.GetSpec((MainnetSpecProvider.MuirGlacierBlockNumber, null)), new[] { receipt });
        ...
        private static void VerifyProof(byte[][] proof, Commitment receiptRoot)
        {
