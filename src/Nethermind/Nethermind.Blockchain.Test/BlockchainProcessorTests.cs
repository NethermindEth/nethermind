...
public class BlockchainProcessorTests
{
    ...
    private class ProcessingTestContext
    {
        ...
        public ProcessingTestContext(bool startProcessor)
        {
            ...
            _processor = new BlockchainProcessor(_blockTree, _branchProcessor, Substitute.For<IBlockProcessor>(), _recoveryStep, _stateReader, LimboLogs.Instance, BlockchainProcessor.Options.Default, Substitute.For<IProcessingStats>());
