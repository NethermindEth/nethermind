...
//            private ILogManager _logManager = new OneLoggerLogManager(new ConsoleAsyncLogger(LogLevel.Debug));
            ...
            public ProcessingTestContext()
            {
                ...
                _blockTree = new BlockTree(blockDb, headersDb, blockInfoDb, new BlockInfoRepository(blockInfoDb), MainNetSpecProvider.Instance, NullTxPool.Instance, LimboLogs.Instance);
