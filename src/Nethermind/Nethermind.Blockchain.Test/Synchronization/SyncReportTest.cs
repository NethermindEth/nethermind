...
namespace Nethermind.Blockchain.Test.Synchronization
{
    ...
    public class SyncReportTest
    {
        ...
        public void Smoke()
        {
            SyncReport syncReport = new SyncReport(Substitute.For<IEthSyncPeerPool>(), Substitute.For<INodeStatsManager>(), new SyncConfig(), Substitute.For<ISyncModeSelector>(),  LimboLogs.Instance, 10);
            Thread.Sleep(20);
