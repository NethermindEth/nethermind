...
namespace Nethermind.Blockchain.Test
{
    ...
    public class WorldStateStab() : WorldState(Substitute.For<IWorldStateScopeProvider>(), Substitute.For<IKeyValueStoreWithBatching>(), LimboLogs.Instance), IWorldState
    {
