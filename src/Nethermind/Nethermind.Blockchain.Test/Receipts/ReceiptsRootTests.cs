...
namespace Nethermind.Blockchain.Test.Receipts
{
    public class ReceiptsRootTests
    {
        public static IEnumerable ReceiptsRootTestCases
        {
            get
            {
                Commitment skipHash = new("0x8f4aebb6fea8f70b5fb5fcc578d8ad7584caed6f662b475702ef964e95f8a885");
        ...
        public Commitment Should_Calculate_ReceiptsRoot(bool validateReceipts, Commitment suggestedRoot)
        {
