...
namespace Nethermind.Blockchain.Test.Find
{
    public class LogFinderTests
    {
        ...
        public void SetUp()
        {
            ...
            _logFinder = new LogFinder(_blockTree, _receiptStorage, _bloomStorage, LimboLogs.Instance);
        }
        ...
        public void filter_all_logs_should_throw_when_to_block_is_not_found([ValueSource(nameof(WithBloomValues))] bool withBloomDb)
        {
            ...
            _logFinder = new LogFinder(blockFinder, _receiptStorage, _bloomStorage, LimboLogs.Instance);
            var logFilter = AllBlockFilter().Build();
        ...
        {
            StoreTreeBlooms(withBloomDb);
            _logFinder = new LogFinder(_blockTree,  _receiptStorage, _bloomStorage, LimboLogs.Instance, 2);
