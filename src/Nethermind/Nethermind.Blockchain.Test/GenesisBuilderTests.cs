...
public class GenesisBuilderTests
{
    ...
    [Test, MaxTime(Timeout.MaxTestTime)]
    public void Can_load_sepolia_genesis()
    {
        ...
        Assert.That(block.Hash, Is.EqualTo(KnownHashes.SepoliaGenesis));
    }
