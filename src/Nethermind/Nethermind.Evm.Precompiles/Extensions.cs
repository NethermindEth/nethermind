...
public static class Extensions
{
    ...
    public static OrderedDictionary<string, Address> ListSystemContracts(this IReleaseSpec spec)
    {
        ...
        {
            systemContracts[Eip6110Constants.ContractAddressKey] = spec.DepositContractAddress
                ?? throw new InvalidOperationException($"{nameof(IReleaseSpec.DepositContractAddress)} is required when deposits are enabled.");
        }
