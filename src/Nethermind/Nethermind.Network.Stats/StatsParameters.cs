...
namespace Nethermind.Stats
{
    public class StatsParameters
    {
        ...
        {
            FailedConnectionDelays = new[] {100, 200, 500, 1000, 2000, 5000, 10000, 15000, 30000, 60000, 60000 * 5, 60000 * 30};
            DisconnectDelays = new[] {100, 200, 500, 1000, 2000, 5000, 10000, 15000, 30000, 60000, 60000 * 30, 60000 * 5};
        }
