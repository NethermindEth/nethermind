...
/// bounding the on-disk footprint to two generations.
/// </summary>
internal sealed class StateCompositionSnapshotStore
{
    ...
    // 8-byte sentinel outside the 6-byte gen-prefixed key namespace; cannot collide with
    // any main blob or chunk key. Value holds <gen:1><blockNumber:8>.
