...
public static class FlatDbConfigExtensions
{
    ...
    /// that serves it, are the narrower <c>HistoryRetention == Rolling</c> question. An extension rather than a
    /// member so it stays out of the options reference and cannot be stubbed away from the mode it reads.</summary>
