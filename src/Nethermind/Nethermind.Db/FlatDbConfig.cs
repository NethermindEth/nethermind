...
public class FlatDbConfig : IFlatDbConfig
{
    ...
    public long PersistedSnapshotBaseArenaPageCacheBytes { get; set; } = 1L * 1024 * 1024 * 1024;
    public long PersistedSnapshotCompactedArenaPageCacheBytes { get; set; } = 8L * 1024 * 1024 * 1024;
