...
public interface IFlatDbConfig : IConfig
{
    ...
    [ConfigItem(Description = "Persistent dedicated reader threads used to resolve hinted BAL read sets into the pre-block cache. -1 for 4x logical processor count capped at 64. 0 disables sink-driven warm reads entirely.", DefaultValue = "-1")]
