...
public partial class VerkleTree
{
    ...
    public bool InsertIntoStatelessTree(VerkleProof proof, List<byte[]> keys, List<byte[]?> values, byte[] root)
    {
    ...
    public bool CreateStatelessTreeFromRange(VerkleProof proof, byte[] rootPoint, Stem startStem, Stem endStem,
