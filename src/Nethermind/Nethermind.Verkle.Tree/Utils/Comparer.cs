...
public class ListEqualityComparer : EqualityComparer<byte[]>
{
    ...
    {
        return Bytes.EqualityComparer.Equals(x, y);
    }

    public override int GetHashCode(byte[] obj)
    {
        return obj.AsSpan().FastHash();
    }
}
...
public class ListWithByteEqualityComparer : EqualityComparer<(byte[], byte)>
{
    ...
    {
        var isBytesSame =
            Bytes.EqualityComparer.Equals(x.Item1, y.Item1);
    ...
    {
        return HashCode.Combine(obj.Item1.AsSpan().FastHash(),
