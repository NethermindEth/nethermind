...
public class KBucketTests
{
    ...
    {
        KBucket<ValueHash256> bucket = new(5, Substitute.For<IPingMessageSender<ValueHash256>>());
    ...
    public async Task WhenFull_OnPingTimeout_UseReplacementCache()
    {
        ...
        IPingMessageSender<ValueHash256> messageSender = Substitute.For<IPingMessageSender<ValueHash256>>();
        messageSender
