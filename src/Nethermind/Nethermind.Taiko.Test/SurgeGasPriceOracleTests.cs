...
public class SurgeGasPriceOracleTests
{
    ...
    public async ValueTask GetGasPriceEstimate_WithEmptyFeeHistory_ReturnsMinGasPrice()
    {
        ...
        L1FeeHistoryResults feeHistory = new L1FeeHistoryResults
        {
            BaseFeePerGas = [],
            BaseFeePerBlobGas = []
        };
    ...
    public async ValueTask GetGasPriceEstimate_WithValidL1FeeHistory_CalculatesCorrectGasPrice()
    {
        ...
        L1FeeHistoryResults lowFeeHistory = new L1FeeHistoryResults
        {
        ...
        SurgeGasPriceOracle oracleLowFee = new SurgeGasPriceOracle(
        ...
        L1FeeHistoryResults highFeeHistory = new L1FeeHistoryResults
        {
        ...
        SurgeGasPriceOracle oracleHighFee = new SurgeGasPriceOracle(
            _blockFinder, _logManager, _specProvider, MinGasPrice, _l1RpcClient, _surgeConfig);
    ...
    public async ValueTask GetGasPriceEstimate_WhenInboxBufferFull_UsesReducedProposalGas()
    {
        ...
        SurgeGasPriceOracle oracleNotFull = new SurgeGasPriceOracle(
            _blockFinder, _logManager, _specProvider, MinGasPrice, _l1RpcClient, _surgeConfig);
        ...
        SurgeGasPriceOracle oracleFull = new SurgeGasPriceOracle(
            _blockFinder, _logManager, _specProvider, MinGasPrice, _l1RpcClient, _surgeConfig);
    ...
    public async ValueTask GetGasPriceEstimate_ComputesAverageGasFromRecentBlocks()
    {
        ...
        SurgeGasPriceOracle oracleLowGas = new SurgeGasPriceOracle(
            _blockFinder, _logManager, _specProvider, MinGasPrice, _l1RpcClient, _surgeConfig);
        ...
        SurgeGasPriceOracle oracleHighGas = new SurgeGasPriceOracle(
            _blockFinder, _logManager, _specProvider, MinGasPrice, _l1RpcClient, _surgeConfig);
