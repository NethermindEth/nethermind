...
public class BlockHeaderTests
{
    ...
    public void Hash_as_expected()
    {
        BlockHeader header = new()
        {
            ...
            MixHash = new Commitment(Bytes.FromHexString("0x00be1f287e0911ea2f070b3650a1a0346535895b6c919d7e992a0c255a83fc8b")),
            Nonce = (ulong)Bytes.FromHexString("0xa0ddc06c6d7b9f48").ToUnsignedBigInteger(),
            Number = (long)Bytes.FromHexString("0x01").ToUInt256(),
            ParentHash = new Commitment(Bytes.FromHexString("0x5a39ed1020c04d4d84539975b893a4e7c53eab6c2965db8bc3468093a31bc5ae")),
            ReceiptsRoot = new Commitment(Bytes.FromHexString("0x056b23fbba480696b65fe5a59b8f2148a1299103c4f57df839233af2cf4ca2d2")),
            StateRoot = new Commitment(Bytes.FromHexString("0x5c2e5a51a79da58791cdfe572bcfa3dfe9c860bf7fad7d9738a1aace56ef9332")),
            Timestamp = (ulong)Bytes.FromHexString("0x59d79f18").ToUnsignedBigInteger(),
            TxRoot = new Commitment(Bytes.FromHexString("0x5c9151c2413d1cd25c51ffb4ac38948acc1359bf08c6b49f283660e9bcf0f516")),
            UnclesHash = new Commitment(Bytes.FromHexString("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347"))
        };

        Assert.That(header.CalculateHash(), Is.EqualTo(new Commitment(Bytes.FromHexString("0x19a24085f6b1fb174aee0463264cc7163a7ffa165af04d3f40431ab3c3b08b98"))));
    }
    ...
    public void Hash_as_expected_2()
    {
        BlockHeader header = new()
        {
            ...
            GasLimit = (long)Bytes.FromHexString("0x2fefba").ToUnsignedBigInteger(),
            GasUsed = (long)Bytes.FromHexString("0x5208").ToUnsignedBigInteger(),
            MixHash = new Commitment(Bytes.FromHexString("0x615bbf44eb133eab3cb24d5766ae9617d9e45ee00e7a5667db30672b47d22149")),
            Nonce = (ulong)Bytes.FromHexString("0x4c4f3d3e055cb264").ToUnsignedBigInteger(),
            Number = (long)Bytes.FromHexString("0x03").ToUInt256(),
            ParentHash = new Commitment(Bytes.FromHexString("0xde1457da701ef916533750d46c124e9ae50b974410bd590fbcf4c935a4d19465")),
            ReceiptsRoot = new Commitment(Bytes.FromHexString("0x056b23fbba480696b65fe5a59b8f2148a1299103c4f57df839233af2cf4ca2d2")),
            StateRoot = new Commitment(Bytes.FromHexString("0xfb4084a7f8b57e370fefe24a3da3aaea6c4dd8b6f6251916c32440336035160b")),
            Timestamp = (ulong)Bytes.FromHexString("0x59d79f1c").ToUnsignedBigInteger(),
            TxRoot = new Commitment(Bytes.FromHexString("0x1722b8a91bfc4f5614ce36ee77c7cce6620ab4af36d3c54baa66d7dbeb7bce1a")),
            UnclesHash = new Commitment(Bytes.FromHexString("0xe676a42c388d2d24bb2927605d5d5d82fba50fb60d74d44b1cd7d1c4e4eee3c0"))
        };
        header.Hash = header.CalculateHash();

        Assert.That(header.Hash, Is.EqualTo(new Commitment(Bytes.FromHexString("0x1423c2875714c31049cacfea8450f66a73ecbd61d7a6ab13089406a491aa9fc2"))));
    }
