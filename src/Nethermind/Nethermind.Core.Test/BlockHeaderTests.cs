...
namespace Nethermind.Core.Test
{
    ...
    public class BlockHeaderTests
    {
        ...
        public void Hash_as_expected()
        {
            ...
            header.Difficulty = Bytes.FromHexString("0x020000").ToUnsignedBigInteger();
            ...
            header.Number = Bytes.FromHexString("0x01").ToUnsignedBigInteger();
            ...
            header.Timestamp = Bytes.FromHexString("0x59d79f18").ToUnsignedBigInteger();
        ...
        public void Hash_as_expected_2()
        {
            ...
            header.Bloom = new Bloom(
                Bytes.FromHexString("")
                    .ToBigEndianBitArray2048());
            header.Beneficiary = new Address("0x8888f1f195afa192cfee860698584c030f4c9db1");
            header.Difficulty = Bytes.FromHexString("0x020080").ToUnsignedBigInteger();
            header.ExtraData = Bytes.Empty;
            header.GasLimit = (long)Bytes.FromHexString("0x2fefba").ToUnsignedBigInteger();
            header.GasUsed = (long)Bytes.FromHexString("0x5208").ToUnsignedBigInteger();
            ...
            header.Number = Bytes.FromHexString("0x03").ToUnsignedBigInteger();
            ...
            header.Timestamp = Bytes.FromHexString("0x59d79f1c").ToUnsignedBigInteger();
