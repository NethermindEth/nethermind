...
namespace Nethermind.Core.Test.Caching
{
    ...
    public class ConcurrentLruCacheTests<TCache>
    {
        ...
        public void Delete_keeps_internal_structure()
        {
            ...
            ConcurrentLruCache<int, int> cache = new(maxCapacity, "test");
        ...
        public void Wrong_capacity_number_at_constructor()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                {
                    ConcurrentLruCache<int, int> unused = new(maxCapacity, "test");
                });
