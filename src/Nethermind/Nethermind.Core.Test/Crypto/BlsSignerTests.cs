...
public class BlsTests
{
    ...
    public void Calculate_signature()
    {
        ...
        BlsSigner.Signature s = BlsSigner.Sign(new(_skBytes), _msgBytes);
    ...
    public void Public_key_from_private_key()
    {
        ...
        Assert.That(BlsSigner.GetPublicKey(new(_skBytes)).Compress(), Is.EqualTo(expected));
    }
}
