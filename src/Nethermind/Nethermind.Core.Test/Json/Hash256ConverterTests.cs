...
public class Hash256ConverterTests
{
    ...
    [Test]
    public void Reads_valid_32_byte_hash()
    {
        Hash256? result = JsonSerializer.Deserialize<Hash256>(
            "\"0x45102190bcfd53cc6a15761c9d2da43a628d0ca713bfad5a1e311b531c294b77\"", options);
        Assert.That(result, Is.EqualTo(new Hash256("0x45102190bcfd53cc6a15761c9d2da43a628d0ca713bfad5a1e311b531c294b77")));
    }
