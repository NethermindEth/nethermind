...
namespace Nethermind.Core.Test.Encoding
{
    ...
    public class TxDecoderTests
    {
        ...
        public void CanCorrectlyCalculateTxHash_when_called_concurrently((Transaction Tx, string Description) testCase)
        {
            ...
            IEnumerable<Task<AndConstraint<ComparableTypeAssertions<Commitment>>>> tasks = Enumerable
                .Range(0, 32)
                .Select((_) =>
                    Task.Factory
        ...
        public void Roundtrip_yolo_v3((string IncomingRlpHex, Commitment Hash) testCase)
        {
        ...
        public void CalculateHash_and_tx_hash_after_decoding_return_the_same_value(
            (string IncomingRlpHex, Commitment Hash) testCase)
        {
            TestContext.Out.WriteLine($"Testing {testCase.Hash}");
            RlpStream incomingTxRlp = Bytes.FromHexString(testCase.IncomingRlpHex).AsRlpStream();
            Transaction decoded = _txDecoder.Decode(incomingTxRlp)!;
        ...
        [TestCaseSource(nameof(YoloV3TestCases))]
        public void Hash_calculation_do_not_change_after_roundtrip((string IncomingRlpHex, Commitment Hash) testCase)
        {
            TestContext.Out.WriteLine($"Testing {testCase.Hash}");
            RlpStream incomingTxRlp = Bytes.FromHexString(testCase.IncomingRlpHex).AsRlpStream();
            Transaction decoded = _txDecoder.Decode(incomingTxRlp)!;
        ...
        [TestCaseSource(nameof(YoloV3TestCases))]
        public void Hash_calculation_do_not_change_after_roundtrip2((string IncomingRlpHex, Commitment Hash) testCase)
        {
            TestContext.Out.WriteLine($"Testing {testCase.Hash}");
            RlpStream incomingTxRlp = Bytes.FromHexString(testCase.IncomingRlpHex).AsRlpStream();
            Transaction decoded = _txDecoder.Decode(incomingTxRlp)!;
        ...
        private void ValueDecoderContext_return_the_same_transaction_as_rlp_stream(
            (string IncomingRlpHex, Commitment Hash) testCase, bool wrapping)
        {
            TestContext.Out.WriteLine($"Testing {testCase.Hash}");
            RlpStream incomingTxRlp = Bytes.FromHexString(testCase.IncomingRlpHex).AsRlpStream();
        ...
        public static IEnumerable<(string, Commitment)> SkipTypedWrappingTestCases()
        {
            yield return
            (
                ...
                new Commitment("0x212a85be428a85d00fb5335b013bc8d3cf7511ffdd8938de768f4ca8bf1caf50")
            );
            yield return
            (
                ...
                new Commitment("0x8204f9c9043f170ab4c061c60e690a79f3bdb88d4af69c69d67248b25fb6a4a7")
            );
            yield return
            (
                ...
                new Commitment("0x2c876e955d2b656d858cdad0400920fba877b807c70b36ca18b67db96865f6a0")
            );
            ...
            (
                ...
                new Commitment("0x449556a7ee5a1e708a0afcc5110507c6a45e894a3ad6d7e21c50bbe521626229")
            );
            yield return
            (
                ...
                new Commitment("0x70c0d568f790ee752c9f86073f7687e286b919add9e1d768dc6c5f1812a364f7")
            );
            yield return
            (
                ...
                new Commitment("0x593dd0e1bf113b762674470741817c4d823c73fb7377da4f6073c7885585ae92")
            );
            yield return
            (
                ...
                new Commitment("0x5cb00d928abf074cb81fc5e54dd49ef541afa7fc014b8a53fb8c29f3ecb5cadb")
            );
            yield return
            (
                ...
                new Commitment("0xd570bbb09f5bd9abf8fdc6ec7e036612bcb6b02b25f51ef0e1544f2a539ca3ac")
            );
            yield return
            (
                ...
                new Commitment("0x0a956694228afe4577bd94fcf8a3aa8544bbadcecfe0d66ccad8ec7ae56c025f")
            );
            yield return
            (
                ...
                new Commitment("0x64450bbd000900379235ca8cad7c6f04288b9a9044967e1e1d63c0bc352624e0")
            );
        }

        public static IEnumerable<(string, Commitment)> YoloV3TestCases()
        {
            yield return
            (
