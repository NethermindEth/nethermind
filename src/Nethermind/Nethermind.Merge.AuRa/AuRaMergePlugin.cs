    ...
    public class AuRaMergePlugin : MergePlugin, IInitializationPlugin
    {
        ...
        protected override BlockProducerEnv CreateBlockProducerEnv()
        {
            ...
            if (_shutterConfig!.Enabled)
            {
                ...
                shutterTxSource = new ShutterTxSource(new ShutterTxLoader(_api.LogFinder!, _shutterConfig, _api.SpecProvider!, _api.EthereumEcdsa!, readOnlyBlockTree, _api.LogManager), _shutterConfig, _api.SpecProvider!, _api.Sealer!, _api.LogManager);
