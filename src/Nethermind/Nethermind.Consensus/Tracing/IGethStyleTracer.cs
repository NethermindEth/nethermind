...
public interface IGethStyleTracer
{
    ...
    IReadOnlyCollection<GethLikeTxTrace> TraceBlock(BlockParameter blockParameter, GethTraceOptions options, CancellationToken cancellationToken, string? forkName = null);
