...
public class GethStyleTracer : IGethStyleTracer
{
    ...
    public GethLikeTxTrace Trace(Commitment blockHash, int txIndex, GethTraceOptions options, CancellationToken cancellationToken)
    {
    ...
    public GethLikeTxTrace? Trace(Rlp block, Commitment txHash, GethTraceOptions options, CancellationToken cancellationToken)
    {
    ...
    public GethLikeTxTrace? Trace(Commitment txHash, GethTraceOptions traceOptions, CancellationToken cancellationToken)
    {
        Commitment? blockHash = _receiptStorage.FindBlockHash(txHash);
    ...
    public IEnumerable<string> TraceBlockToFile(Commitment blockHash, GethTraceOptions options, CancellationToken cancellationToken)
    {
    ...
    private GethLikeTxTrace? Trace(Block block, Commitment? txHash, CancellationToken cancellationToken, GethTraceOptions options)
    {
