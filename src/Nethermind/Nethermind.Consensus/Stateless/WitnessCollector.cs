...
public class WitnessCollector(WitnessGeneratingBlockHashProvider blockFinder, WitnessGeneratingWorldState worldState, IBlockProcessor blockProcessor, ISpecProvider specProvider) : IWitnessCollector
{
