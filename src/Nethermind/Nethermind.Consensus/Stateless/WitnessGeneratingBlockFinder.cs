...
public class WitnessGeneratingBlockFinder(IBlockFinder inner, IBlockhashCache blockhashCache) : IBlockFinder, IBlockhashCache
{
    ...
    {
        return blockhashCache.Prefetch(blockHeader, cancellationToken);
    }
