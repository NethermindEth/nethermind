...
public class WitnessGeneratingWorldState(WorldState inner) : IWorldState
{
    ...
    public byte[] GetOriginal(in StorageCell storageCell)
    {
        ...
        {
            _storageSlots.Add(storageCell.Address, [storageCell.Index]);
        }
    ...
    public void CreateEmptyAccountIfDeleted(Address address) => inner.CreateEmptyAccountIfDeleted(address);
