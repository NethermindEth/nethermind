...
namespace Nethermind.Consensus.Producers
{
    ...
    public abstract class BlockProducerBase : IBlockProducer
    {
        ...
        protected virtual Block PrepareBlock(BlockHeader parent, PayloadAttributes? payloadAttributes = null)
        {
            ...
            return new BlockToProduce(header, transactions, Array.Empty<BlockHeader>(), payloadAttributes?.Withdrawals, payloadAttributes?.GetInclusionListTransactions(_specProvider.ChainId));
        }
    }
}
