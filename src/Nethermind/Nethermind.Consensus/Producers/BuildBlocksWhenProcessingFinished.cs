...
namespace Nethermind.Consensus.Producers
{
    public class BuildBlocksWhenProcessingFinished : IManualBlockProductionTrigger, IDisposable
    {
        ...
        public Task<Block?> BuildBlock(BlockHeader? parentHeader = null, CancellationToken? cancellationToken = null, IBlockTracer? blockTracer = null, PayloadAttributes? payloadAttributes = null)
        {
            lock (_locker)
            {
