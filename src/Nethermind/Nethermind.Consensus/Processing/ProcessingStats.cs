...
namespace Nethermind.Consensus.Processing
{
    ...
    public class ProcessingStats : IProcessingStats
    {
        ...
        public void CaptureStartStats()
        {
            ...
            _startAccountCacheHits = DbMetrics.MainStateTreeCacheHits;
            _startAccountCacheMisses = DbMetrics.MainStateTreeReads;
            _startStorageCacheHits = DbMetrics.MainStorageTreeCache;
            _startStorageCacheMisses = DbMetrics.MainStorageTreeReads;
            _startCodeCacheHits = Evm.Metrics.MainThreadCodeDbCache;
            _startCodeCacheMisses = Evm.Metrics.MainCodeReads;
        ...
        public void UpdateStats(IReadOnlyList<Block> blocks, BlockHeader? baseBlock, long blockProcessingTimeInMicros)
        {
            ...
            if (_slowBlockThresholdMs >= 0)
            {
                ...
                blockData.DeltaAccountCacheHits = DbMetrics.MainStateTreeCacheHits - _startAccountCacheHits;
                blockData.DeltaAccountCacheMisses = DbMetrics.MainStateTreeReads - _startAccountCacheMisses;
                blockData.DeltaStorageCacheHits = DbMetrics.MainStorageTreeCache - _startStorageCacheHits;
                blockData.DeltaStorageCacheMisses = DbMetrics.MainStorageTreeReads - _startStorageCacheMisses;
                blockData.DeltaCodeCacheHits = Evm.Metrics.MainThreadCodeDbCache - _startCodeCacheHits;
                blockData.DeltaCodeCacheMisses = Evm.Metrics.MainCodeReads - _startCodeCacheMisses;
