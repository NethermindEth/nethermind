...
{
    internal static void BuildWindowsSelections(List<Cpu> cpus, Selection?[] selections, out PrewarmSplit? prewarm)
    {
        prewarm = null;
        ...
        if (selections[(int)ProcessingCores.Performance] is { } near
            ...
            prewarm = new PrewarmSplit(near, CreateSelection(far, cpus), near.Cpus.Length - 1);
    }
