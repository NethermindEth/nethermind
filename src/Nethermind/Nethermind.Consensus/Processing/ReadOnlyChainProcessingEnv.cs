...
namespace Nethermind.Consensus.Processing
{
    ...
    public class ReadOnlyChainProcessingEnv : IDisposable
    {
            ...
            IBlockProcessor.IBlockTransactionsExecutor? blockTransactionsExecutor = null)
        {
            ...
            _blockProcessingQueue = new BlockchainProcessor(_txEnv.BlockTree, BlockProcessor, recoveryStep, dbProvider.StateDb, logManager, BlockchainProcessor.Options.NoReceipts);
