...
public class PrewarmerEnvFactory(IWorldStateManager worldStateManager, ILogManager logManager, ILifetimeScope parentLifetime, CrossBlockCaches? crossBlockCaches = null)
{
