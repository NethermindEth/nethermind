    ...
    : IBlockProcessor
{
    ...
    private static void CalculateBlooms(TxReceipt[] receipts)
    {
        ...
        // For small blocks the bloom work is cheaper than queuing ProcessorCount-1 ThreadPool
        // items, so run sequentially to avoid the ParallelUnbalancedWork scheduling overhead.
