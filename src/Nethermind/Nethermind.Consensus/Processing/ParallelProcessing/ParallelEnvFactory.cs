...
{
    public ParallelAutoReadOnlyTxProcessingEnv Create(Version version, MultiVersionMemory multiVersionMemory, PreBlockCaches preBlockCaches, FeeAccumulator feeAccumulator)
    {
