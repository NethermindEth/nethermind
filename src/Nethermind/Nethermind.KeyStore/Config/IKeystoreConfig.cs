...
public static class KeyStoreConfigExtensions
{
    ...
    {
        string?[]? unlockAccounts = keyStoreConfig.UnlockAccounts;
        if (unlockAccounts is null)
        {
            return -1;
        }
        ...
        {
            if (string.Equals(unlockAccounts[i], addressString, StringComparison.OrdinalIgnoreCase))
            {
                return i;
            }
        }
