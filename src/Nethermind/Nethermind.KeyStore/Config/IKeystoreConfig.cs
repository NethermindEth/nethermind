...
namespace Nethermind.KeyStore.Config
{
    ...
    public interface IKeyStoreConfig : IConfig
    {
        ...
        [ConfigItem(Description = "Account to be used by the block author / coinbase, to be loaded from keystore", DefaultValue = "")]
        ...
        [ConfigItem(Description = "Account to be used by the node for network communication (enode), to be loaded from keystore. " +
                                  "If neither this nor EnodeKeyFile is specified, the key for network communication will be autogenerated in 'node.key.plain' file.", DefaultValue = "" )]
        ...
        [ConfigItem(Description = "Path to key file to be used by the node for network communication (enode). " +
                                  ...
                                  "If the file does not exist it will be generated.", DefaultValue = "")]
