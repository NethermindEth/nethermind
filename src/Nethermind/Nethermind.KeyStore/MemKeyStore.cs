...
namespace Nethermind.KeyStore
{
    ...
    public class MemKeyStore : IKeyStore
    {
        ...
        {
            return _privateKeys.TryGetValue(address, out PrivateKey value) ? (new ProtectedPrivateKey(value, _ketStoreDir), Result.Success) : (null, Result.Fail("Can't unlock key."));
        }
