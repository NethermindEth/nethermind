...
namespace Nethermind.Clique.Test
{
    ...
    public class CliqueSealEngineTests
    {
        ...
        private const ulong ChainId = 0x85; // random chain id, should be independent of test.
        ...
        {
            IEthereumEcdsa ecdsa = new EthereumEcdsa(ChainId, LimboLogs.Instance);
            ...
            _clique = new CliqueSealer(new Signer(ChainId, _currentSigner, LimboLogs.Instance), config,
