...
namespace Nethermind.Clique.Test
{
    ...
    public class CliqueSealEngineTests
    {
        ...
        {
            IEthereumEcdsa ecdsa = new EthereumEcdsa(NetworkId.Rinkeby, LimboLogs.Instance);
            ...
            _clique = new CliqueSealer(new Signer(NetworkId.Rinkeby, _currentSigner, LimboLogs.Instance), config,
