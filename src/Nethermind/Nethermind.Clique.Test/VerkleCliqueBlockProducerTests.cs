...
namespace Nethermind.Clique.Test
{
    ...
    public class VerkleCliqueBlockProducerTests
    {
        private class On
        {
...
//                _logManagers[privateKey] = new OneLoggerLogManager(new ConsoleAsyncLogger(LogLevel.Debug, $"{privateKey.Address} "));
                ...
                var trieStore = new VerkleTrieStore(DatabaseScheme.MemoryDb, nodeLogManager);
                VerkleStateReader stateReader = new(trieStore, codeDb, nodeLogManager);
                VerkleStateProvider stateProvider = new(trieStore, nodeLogManager, codeDb);
                ...
                VerkleStorageProvider storageProvider = new(stateProvider, nodeLogManager);
                ...
                VerkleStateProvider minerStateProvider = new(minerTrieStore, nodeLogManager, codeDb);
                VerkleStorageProvider minerStorageProvider = new(minerStateProvider, nodeLogManager);
