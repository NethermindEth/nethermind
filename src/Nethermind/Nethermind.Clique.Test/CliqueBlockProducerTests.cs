...
//                _logManagers[privateKey] = new OneLoggerLogManager(new ConsoleAsyncLogger(LogLevel.Debug, $"{privateKey.Address} "));
                ...
                BlockTree blockTree = new BlockTree(blocksDb, headersDb, blockInfoDb, new BlockInfoRepository(blockInfoDb), GoerliSpecProvider.Instance, txPool, nodeLogManager);
