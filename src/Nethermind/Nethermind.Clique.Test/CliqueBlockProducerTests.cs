...
public class CliqueBlockProducerTests
{
    private class On
    {
        ...
        public On CreateNode(PrivateKey privateKey, bool withGenesisAlreadyProcessed = false)
        {
            ...
            var spec = goerliSpecProvider.GetFinalSpec();
            if (spec.WithdrawalsEnabled is true)
            {
                ...
                stateProvider.InsertCode(Eip7002Constants.WithdrawalRequestPredeployAddress, code, goerliSpecProvider.GenesisSpec);
            }
            ...
            if (spec.ConsolidationRequestsEnabled is true)
            {
                ...
                stateProvider.InsertCode(Eip7251Constants.ConsolidationRequestPredeployAddress, code, goerliSpecProvider.GenesisSpec);
            }
