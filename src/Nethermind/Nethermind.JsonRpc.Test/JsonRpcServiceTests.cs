...
public class JsonRpcServiceTests
{
    ...
    [TestCase("""["0xcf1dc766fc2c62bef0b67a8de666c8e67acf35f6",""]""", TestName = "ExplicitEmptyString")]
    public void Required_state_block_parameter_rejects_nullable_trailing_markers(string rawParameters)
    {
        IEthRpcModule ethRpcModule = Substitute.For<IEthRpcModule>();
