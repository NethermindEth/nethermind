...
namespace Nethermind.JsonRpc.Test
{
    ...
    public class JsonRpcProcessorTests
    {
        ...
        {
            JsonRpcResult result = await _jsonRpcProcessor.ProcessAsync("[{\"id\":67,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionCount\",\"params\":[{\"a\":\"0x7f01d9b227593e033bf8d6fc86e634d27aa85568\",\"b\":\"0x668c24\"}]},{\"id\":67,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionCount\",\"params\":[{\"a\":\"0x7f01d9b227593e033bf8d6fc86e634d27aa85568\",\"b\":\"0x668c24\"}]}]");
        ...
        {
            JsonRpcResult result = await _jsonRpcProcessor.ProcessAsync("[{\"id\":67,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionCount\",\"params\":\"0x7f01d9b227593e033bf8d6fc86e634d27aa85568\"},{\"id\":67,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionCount\",\"params\":\"0x668c24\"}]");
            result.Response.Should().NotBeNull();
            result.Response.Should().BeOfType<JsonRpcErrorResponse>();
        }
        ...
        {
            JsonRpcResult result = await _jsonRpcProcessor.ProcessAsync("invalid");
        ...
        {
            JsonRpcResult result = await _jsonRpcProcessor.ProcessAsync("\"aaa\"");
            result.Response.Should().NotBeNull();
            result.Responses.Should().BeNull();
            result.Response.Should().BeSameAs(_errorResponse);
        }
