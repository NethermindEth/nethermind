...
namespace Nethermind.JsonRpc.Test.Modules.Trace
{
    ...
    public class ParityStyleTracerTests
    {
        ...
        public void Setup()
        {
            ...
            _processor = new BlockchainProcessor(_blockTree, blockProcessor, new CompositeDataRecoveryStep(new TxSignaturesRecoveryStep(specProvider, new EthereumEcdsa(ChainId.Mainnet, LimboLogs.Instance), NullTxPool.Instance, LimboLogs.Instance)), LimboLogs.Instance, false);
