...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class SingletonModulePoolTests
    {
        ...
        public async Task Initialize()
        {
            ...
            BlockTree blockTree = new(dbProvider.BlocksDb, dbProvider.HeadersDb, dbProvider.BlockInfosDb, dbProvider.MetadataDb, new ChainLevelInfoRepository(dbProvider.BlockInfosDb), specProvider, NullBloomStorage.Instance, new SyncConfig(), LimboLogs.Instance);
