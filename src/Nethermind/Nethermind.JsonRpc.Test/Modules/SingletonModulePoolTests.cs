...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class SingletonModulePoolTests
    {
        ...
        public void Initialize()
        {
            ...
            _factory = new EthModuleFactory(dbProvider, txPool, NullWallet.Instance, blockTree, new EthereumEcdsa(MainNetSpecProvider.Instance, LimboLogs.Instance), NullBlockProcessor.Instance, new InMemoryReceiptStorage(), specProvider, LimboLogs.Instance);
        }
