...
public partial class DebugRpcModuleTests
{
    ...
    public async Task Debug_traceCallMany_with_single_bundle_single_transaction()
    {
        ...
        ResultWrapper<IEnumerable<IEnumerable<GethLikeTxTrace>>> result = await ctx.DebugRpcModule.debug_traceCallMany([bundle], BlockParameter.Latest);
    ...
    public async Task Debug_traceCallMany_with_multiple_bundles()
    {
        ...
        ResultWrapper<IEnumerable<IEnumerable<GethLikeTxTrace>>> result = await ctx.DebugRpcModule.debug_traceCallMany([CreateBundle(CreateTransaction()), CreateBundle(CreateTransaction(to: TestItem.AddressD))], BlockParameter.Latest);
    ...
    public async Task Debug_traceCallMany_with_trace_options()
    {
        ...
        ResultWrapper<IEnumerable<IEnumerable<GethLikeTxTrace>>> result = await ctx.DebugRpcModule.debug_traceCallMany([bundle], BlockParameter.Latest, options);
    ...
    public async Task Debug_traceCallMany_mixed_bundles_preserves_order()
    {
        ...
        ResultWrapper<IEnumerable<IEnumerable<GethLikeTxTrace>>> result = await ctx.DebugRpcModule.debug_traceCallMany([simple, withOverride], BlockParameter.Latest);
