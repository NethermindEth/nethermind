    ...
    public class TestRpcBlockchain : TestBlockchain
    {
        ...
        public async Task RestartBlockchainProcessor()
        {
            ...
            _currentBlockchainProcessor = new BlockchainProcessor(BlockTree, BranchProcessor,
                BlockPreprocessorStep, StateReader, SkipIndexedBlockInfoStore, LimboLogs.Instance, Nethermind.Consensus.Processing.BlockchainProcessor.Options.Default, Substitute.For<IProcessingStats>());
