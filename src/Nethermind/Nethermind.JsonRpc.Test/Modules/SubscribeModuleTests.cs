...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class SubscribeModuleTests
    {
        ...
        public void NewHeadSubscription_should_send_notifications_when_adding_multiple_blocks_at_once_and_after_reorgs()
        {
            ...
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Last().Response!.Value.Response);
        ...
        public void NewHeadSubscription_should_send_notifications_in_order()
        {
            ...
            for (int i = 0; i < 21; i++)
            {
                ...
                ((BlockForRpc)((JsonRpcSubscriptionResponse)result.Response.Value.Response).Params.Result).Difficulty.Should().Be((UInt256)i);
            }
        }
        ...
        public void LogsSubscription_with_null_arguments_on_NewHeadBlock_event()
        {
            ...
            string serialized = _jsonSerializer.Serialize(jsonRpcResults[0].Response!.Value.Response);
        ...
        public void LogsSubscription_with_null_arguments_on_NewHeadBlock_event_with_one_TxReceipt_with_few_logs()
        {
            ...
            serialized = _jsonSerializer.Serialize(jsonRpcResults[1].Response!.Value.Response);
            ...
            serialized = _jsonSerializer.Serialize(jsonRpcResults[2].Response!.Value.Response);
        ...
        public void LogsSubscription_with_null_arguments_on_NewHeadBlock_event_with_few_TxReceipts_with_few_logs()
        {
            ...
            serialized = _jsonSerializer.Serialize(jsonRpcResults[3].Response!.Value.Response);
            ...
            serialized = _jsonSerializer.Serialize(jsonRpcResults[4].Response!.Value.Response);
