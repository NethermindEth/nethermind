...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class SubscribeModuleTests
    {
        ...
        public void NewPendingTransactionsSubscription_on_NewPending_event()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"result\":\"", TestItem.KeccakA, "\",\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
        ...
        public void NewPendingTransactionsSubscription_on_NewPending_event_with_null_transactions_hash()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
        ...
        public void SyncingSubscription_on_NewHeadBlock_event_when_sync_changed_to_false()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"result\":{\"isSyncing\":false,\"startingBlock\":\"0x0\",\"currentBlock\":\"0x2738\",\"highestBlock\":\"0x273a\"},\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
        ...
        public void SyncingSubscription_on_NewBestSuggestedBlock_event_when_sync_changed_to_false()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"result\":{\"isSyncing\":false,\"startingBlock\":\"0x0\",\"currentBlock\":\"0x2728\",\"highestBlock\":\"0x272e\"},\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
        ...
        public void SyncingSubscription_on_NewHeadBlock_event_when_sync_changed_to_true()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"result\":{\"isSyncing\":true,\"startingBlock\":\"0x0\",\"currentBlock\":\"0x2728\",\"highestBlock\":\"0x273a\"},\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
        ...
        public void SyncingSubscription_on_NewBestSuggestedBlock_event_when_sync_changed_to_true()
        {
            ...
            jsonRpcResult.Response.Should().NotBeNull();
            string serialized = _jsonSerializer.Serialize(jsonRpcResult.Response);
            var expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"params\":{\"result\":{\"isSyncing\":true,\"startingBlock\":\"0x0\",\"currentBlock\":\"0x2738\",\"highestBlock\":\"0x2773\"},\"subscription\":\"", serialized.Substring(serialized.Length - 47,34), "\"},\"id\":null}");
            expectedResult.Should().Be(serialized);
        }
    }
}
