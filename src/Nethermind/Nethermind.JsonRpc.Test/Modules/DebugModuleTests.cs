...
public class DebugModuleTests
{
    ...
    public async Task Get_from_db()
    {
        ...
        DebugRpcModule rpcModule = new(LimboLogs.Instance, debugBridge, jsonRpcConfig, specProvider, _blockFinder, _stateReader);
        using var response =
    ...
    public async Task Migrate_receipts()
    {
        ...
        IDebugRpcModule rpcModule = new DebugRpcModule(LimboLogs.Instance, debugBridge, jsonRpcConfig, specProvider, _blockFinder, _stateReader);
    ...
    public void TraceBlock_Success()
    {
        ...
        var rpcModule = new DebugRpcModule(LimboLogs.Instance, debugBridge, jsonRpcConfig, specProvider, _blockFinder, _stateReader);
