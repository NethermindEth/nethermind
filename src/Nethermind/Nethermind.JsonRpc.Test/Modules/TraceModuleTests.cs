...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class TraceModuleTests
    {
        ...
        private void Initialize(bool auRa = false)
        {
            ...
            BlockchainProcessor blockchainProcessor = new BlockchainProcessor(blockTree, blockProcessor, new TxSignaturesRecoveryStep(ethereumEcdsa, txPool, LimboLogs.Instance), LimboLogs.Instance, BlockchainProcessor.Options.Default);
