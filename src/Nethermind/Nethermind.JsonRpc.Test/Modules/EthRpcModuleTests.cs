...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public partial class EthRpcModuleTests
    {
        ...
        {
            using EthRpcModuleTests.Context ctx = await Context.Create();
        ...
        {
            using EthRpcModuleTests.Context ctx = eip1559 ? await Context.CreateWith1559Enabled() : await Context.Create();
        ...
        private class Context : IDisposable
        {
            ...
            public static async Task<EthRpcModuleTests.Context> CreateWith1559Enabled()
            {
            ...
            public static async Task<EthRpcModuleTests.Context> Create(ISpecProvider specProvider = null)
            {
                EthRpcModuleTests.Context ctx = new EthRpcModuleTests.Context();
