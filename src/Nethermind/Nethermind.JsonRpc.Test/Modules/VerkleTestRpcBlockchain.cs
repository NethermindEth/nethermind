...
{
    public class VerkleTestRpcBlockchain : VerkleTestBlockchain
    {
        ...
        public static Builder<T> ForTest<T>(string sealEngineType) where T : VerkleTestRpcBlockchain, new() => 
            new(new T {SealEngineType = sealEngineType});
        
        public static Builder<T> ForTest<T>(T blockchain) where T : VerkleTestRpcBlockchain=> 
            new(blockchain);

        public class Builder<T>  where T : VerkleTestRpcBlockchain
        {
            private readonly VerkleTestRpcBlockchain _blockchain;
        ...
        protected override async Task<VerkleTestBlockchain> Build(ISpecProvider? specProvider = null, UInt256? initialValues = null)
        {
