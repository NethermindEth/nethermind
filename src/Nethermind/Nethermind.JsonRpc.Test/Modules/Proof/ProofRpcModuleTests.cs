...
namespace Nethermind.JsonRpc.Test.Modules.Proof
{
    ...
    public class ProofRpcModuleTests
    {
        ...
        {
            Commitment txHash = _blockTree.FindBlock(1)!.Transactions[0].Hash!;
        ...
        public async Task Get_receipt_when_block_has_few_receipts(bool withHeader, string expectedResult)
        {
            ...
            Commitment txHash = _blockTree.FindBlock(1)!.Transactions[1].Hash!;
            TxReceipt[] receipts = { receipt1, receipt2 };
            _receiptFinder.Get(Arg.Any<Block>()).Returns(receipts);
            _receiptFinder.Get(Arg.Any<Commitment>()).Returns(receipts);
            _receiptFinder.FindBlockHash(Arg.Any<Commitment>()).Returns(_blockTree.FindBlock(1)!.Hash);
        ...
        public async Task Can_call()
        {
            ...
            Commitment root = stateProvider.StateRoot;
