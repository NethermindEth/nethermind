...
public class EthSimulateTestsBlocksAndTransactions
{
    ...
    public async Task Test_eth_simulateV1_gap_expansion_exceeding_cap_returns_error()
    {
        ...
        SimulatePayload<TransactionForRpc> payload = new()
        {
            BlockStateCalls =
            [
                new() { BlockOverrides = new BlockOverride { Number = checked((ulong)(chain.Bridge.HeadBlock.Number + 130)) }, Calls = [] },
                new() { BlockOverrides = new BlockOverride { Number = checked((ulong)(chain.Bridge.HeadBlock.Number + 260)) }, Calls = [] }
            ]
        };
