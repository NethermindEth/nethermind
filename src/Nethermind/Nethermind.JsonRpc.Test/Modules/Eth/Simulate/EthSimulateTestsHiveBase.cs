...
public class EthSimulateTestsHiveBase
{
    ...
    public async Task TestsimulateAddMoreNonDefinedBlockStateCallsThanFitButNowWithFit()
    {
        ...
        Console.WriteLine("current test: simulateAddMoreNonDefinedBlockStateCallsThanFitButNowWithFit");
    ...
    [Test]
    public async Task TestsimulateAddMoreNonDefinedBlockStateCallsThanFit()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateBasefeeTooLowWithoutValidation38012()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateBasefeeTooLowWithoutValidation38012");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateBlockNumOrder38020()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateBlockhashComplex()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateBlockhashComplex");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateBlockhashSimple()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateBlockhashSimple");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateBlockhashStartBeforeHead()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateBlockhashStartBeforeHead");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    public async Task TestsimulateEmptyCallsAndOverrides()
    {
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEmptyCallsAndOverrides");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateEthSendShouldNotProduceLogsByDefault()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEthSendShouldNotProduceLogsByDefault");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateEthSendShouldNotProduceLogsOnRevert()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEthSendShouldNotProduceLogsOnRevert");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    public async Task TestsimulateEthSendShouldProduceLogs()
    {
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEthSendShouldProduceLogs");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateEthSendShouldProduceMoreLogsOnForward()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEthSendShouldProduceMoreLogsOnForward");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    public async Task TestsimulateEthSendShouldProduceNoLogsOnForwardRevert()
    {
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateEthSendShouldProduceNoLogsOnForwardRevert");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    public async Task TestsimulateGetBlockProperties()
    {
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateGetBlockProperties");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    public async Task TestsimulateLogs()
    {
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateLogs");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateMoveAccountTwice()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateMoveEcrecoverAndCall()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateMoveEcrecoverAndCall");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateMoveToAddressItselfReference38022()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateMoveToAddressItselfReference38022");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateMoveTwoAccountsToSame38023()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateMoveTwoNonPrecompilesAccountsToSame()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateOverrideAddressTwiceInSeparateBlockStateCalls()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateOverrideAddressTwiceInSeparateBlockStateCalls");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateOverrideBlockNum()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateOverrideBlockNum");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateOverrideEcrecover()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateOverrideEcrecover");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateOverrideIdentity()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateOverrideIdentity");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateOverrideSha256()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateOverrideSha256");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulatePrecompileIsSendingTransaction()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulatePrecompileIsSendingTransaction");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateRunOutOfGasInBlock38015()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateSelfDestructingStateOverride()
    {
        EthereumJsonSerializer serializer = new();
    ...
    [Test]
    public async Task TestsimulateSetReadStorage()
    {
        EthereumJsonSerializer serializer = new();
        ...
        var payload = serializer.Deserialize<SimulatePayload<TransactionForRpc>>(input);
        TestRpcBlockchain chain = await EthRpcSimulateTestsBase.CreateChain();
        Console.WriteLine("current test: simulateSetReadStorage");
        var result = chain.EthRpcModule.eth_simulateV1(payload!, BlockParameter.Latest);
        Assert.That(result.Result.ResultType, Is.EqualTo(ResultType.Success));
        Assert.IsNotNull(result.Data);
    }
    ...
    [Test]
    public async Task TestsimulateTransferOverBlockStateCalls()
    {
        EthereumJsonSerializer serializer = new();
