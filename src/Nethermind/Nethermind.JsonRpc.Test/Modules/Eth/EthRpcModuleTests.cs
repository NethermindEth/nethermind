...
public partial class EthRpcModuleTests
{
    ...
    public async Task Eth_get_filter_changes_with_log_filter()
    {
        ...
        using JsonRpcResponse newFilterResp = await RpcTest.TestRequest(test.EthRpcModule, "eth_newFilter", new { });
    ...
    [TestCase("""{"fromBlock":"0x10","address":"0x0000000000000000000000000000000000000001","topics":["0x0000000000000000000000000000000000000001"]}""", """{"jsonrpc":"2.0","error":{"code":-32602,"message":"requested block range is in the future"},"id":67}""")]
    ...
    [TestCase("{}", "{\"jsonrpc\":\"2.0\",\"error\":{\"code\":-32000,\"message\":\"resource not found message\"},\"id\":67}")]
