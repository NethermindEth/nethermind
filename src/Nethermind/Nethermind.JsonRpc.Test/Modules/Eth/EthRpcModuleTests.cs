        ...
        private class Context : IDisposable
        {
            ...
            public static async Task<Context> Create(ISpecProvider? specProvider = null) =>
                new()
                {
                    ...
                    _auraTest = await TestRpcBlockchain.ForTest(SealEngineType.AuRa).Build(specProvider)
                };
