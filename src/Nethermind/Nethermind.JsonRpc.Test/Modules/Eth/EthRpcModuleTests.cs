...
public partial class EthRpcModuleTests
{
    ...
    [Test]
    public async Task Eth_getBlockReceiptsWithStandardizationRules()
    {
        using Context ctx = await Context.Create(followStandardizationRules: true);
        string serialized = await ctx.Test.TestEthRpc("eth_getBlockReceipts", "latest");
        string expectedResult = "{\"jsonrpc\":\"2.0\",\"result\":[{\"transactionHash\":\"0x681c2b6f99e37fd6fe6046db8b51ec3460d699cacd6a376143fd5842ac50621f\",\"transactionIndex\":\"0x0\",\"blockHash\":\"0x29f141925d2d8e357ae5b6040c97aa12d7ac6dfcbe2b20e7b616d8907ac8e1f3\",\"blockNumber\":\"0x3\",\"cumulativeGasUsed\":\"0x5208\",\"gasUsed\":\"0x5208\",\"effectiveGasPrice\":\"0x1\",\"from\":\"0xb7705ae4c6f81b66cdb323c65f4e8133690fc099\",\"to\":\"0x942921b14f1b1c385cd7e0cc2ef7abe5598c8358\",\"contractAddress\":null,\"logs\":[],\"logsBloom\":\"\",\"type\":\"0x0\"},{\"transactionHash\":\"0x7126cf20a0ad8bd51634837d9049615c34c1bff5e1a54e5663f7e23109bff48b\",\"transactionIndex\":\"0x1\",\"blockHash\":\"0x29f141925d2d8e357ae5b6040c97aa12d7ac6dfcbe2b20e7b616d8907ac8e1f3\",\"blockNumber\":\"0x3\",\"cumulativeGasUsed\":\"0xa410\",\"gasUsed\":\"0x5208\",\"effectiveGasPrice\":\"0x1\",\"from\":\"0xb7705ae4c6f81b66cdb323c65f4e8133690fc099\",\"to\":\"0x942921b14f1b1c385cd7e0cc2ef7abe5598c8358\",\"contractAddress\":null,\"logs\":[],\"logsBloom\":\"\",\"type\":\"0x0\"}],\"id\":67}";
    ...
    protected class Context : IDisposable
    {
        ...
        public static Task<Context> Create(ISpecProvider? specProvider = null,
            ...
            bool followStandardizationRules = false)
        {
            ...
            return Task.FromResult(new Context
            {
                TestFactory = () => TestRpcBlockchain.ForTest(SealEngineType.NethDev)
                    ...
                    .WithConfig(new JsonRpcConfig { EstimateErrorMargin = 0, FollowStandardizationRules = followStandardizationRules })
                    .Build(wrappedConfigurer).Result,

                AuraTestFactory = () => TestRpcBlockchain.ForTest(SealEngineType.AuRa)
                    .WithConfig(new JsonRpcConfig { FollowStandardizationRules = followStandardizationRules })
