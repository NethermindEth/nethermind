...
public partial class EthRpcModuleTests
{
    ...
    public async Task EthGetHeaderByHash_WhenAuraBlock_EmitsAuraFields()
    {
        ...
        Assert.That(result["step"]!.Type, Is.EqualTo(JTokenType.String));
        Assert.That(result["step"]!.Value<string>(), Is.EqualTo("0x0"));
