...
public class JsonRpcSocketsClientTests
{
    ...
    public class UsingWebSockets
    {
        ...
        /// <summary>
        /// Probes for a free loopback port. <see cref="HttpListener"/> prefixes cannot ask for port 0, so the port
        /// has to be named up front; this at least keeps two concurrent runs of the suite off the same one.
        /// </summary>
