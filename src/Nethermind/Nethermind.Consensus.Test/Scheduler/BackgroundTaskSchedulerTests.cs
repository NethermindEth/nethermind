...
public class BackgroundTaskSchedulerTests
{
    ...
    public async Task Test_task_will_execute()
    {
        ...
        await using BackgroundTaskScheduler scheduler = new BackgroundTaskScheduler(_blockProcessor, 1, 1_000_000, LimboLogs.Instance);
    ...
    {
        await using BackgroundTaskScheduler scheduler = new BackgroundTaskScheduler(_blockProcessor, 2, 1_000_000, LimboLogs.Instance);
