...
public sealed partial class KeccakHash
{
    ...
    [SkipLocalsInit]
    internal static unsafe void ComputePaddedBlocks4Avx2(ref byte input, ref byte output)
    {
        ...
        Vector256<ulong> a15;
        Vector256<ulong> a16;
        // Each gather stays within the caller's four complete 136-byte rate blocks.
        fixed (byte* inputPtr = &input)
        {
            a0 = GatherRateLane4(inputPtr, 0);
            a1 = GatherRateLane4(inputPtr, 1);
            a2 = GatherRateLane4(inputPtr, 2);
            a3 = GatherRateLane4(inputPtr, 3);
            a4 = GatherRateLane4(inputPtr, 4);
            a5 = GatherRateLane4(inputPtr, 5);
            a6 = GatherRateLane4(inputPtr, 6);
            a7 = GatherRateLane4(inputPtr, 7);
            a8 = GatherRateLane4(inputPtr, 8);
            a9 = GatherRateLane4(inputPtr, 9);
            a10 = GatherRateLane4(inputPtr, 10);
            a11 = GatherRateLane4(inputPtr, 11);
            a12 = GatherRateLane4(inputPtr, 12);
            a13 = GatherRateLane4(inputPtr, 13);
            a14 = GatherRateLane4(inputPtr, 14);
            a15 = GatherRateLane4(inputPtr, 15);
            a16 = GatherRateLane4(inputPtr, 16);
        }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    // The caller supplies four 136-byte blocks; lane 16 ends at the final byte of the fourth block.
    private static unsafe Vector256<ulong> GatherRateLane4(byte* input, int lane) =>
        Avx2.GatherVector256((ulong*)(input + lane * sizeof(ulong)), Vector256.Create(0L, 17L, 34L, 51L), 8);
