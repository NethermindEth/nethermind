...
namespace Nethermind.Core.Crypto
{
    ...
    public static class Keccak
    {
        ...
        ///     <string>0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470</string>
        /// </returns>
        public static readonly Hash256 OfAnEmptyString = new(ValueKeccak.InternalCompute([]));

        /// <returns>
        ///     <string>0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347</string>
        /// </returns>
        public static readonly Hash256 OfAnEmptySequenceRlp = new(ValueKeccak.InternalCompute([192]));

        /// <summary>
        ///     0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421
        /// </summary>
        public static Hash256 EmptyTreeHash = new(ValueKeccak.InternalCompute([128]));
