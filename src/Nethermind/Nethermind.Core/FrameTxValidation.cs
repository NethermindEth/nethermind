...
public static class FrameTxValidation
{
    ...
    /// </summary>
    /// <remarks>
    /// A recognized EIP-8141 validation prefix provably ends at a protocol-approved <c>VERIFY</c> frame; under any
    /// other layout approval rests on attacker-chosen code, so the whole frame list is charged.
    /// </remarks>
