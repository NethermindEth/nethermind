...
namespace Nethermind.Core
{
    public static class KeyValueStoreExtensions
    {
        ...
        {
            return db.KeyExists(key.MutateToBigEndianSpanWithoutLeadingZeros());
        }

        public static byte[]? Get(this IReadOnlyKeyValueStore db, long key) => db[key.MutateToBigEndianSpanWithoutLeadingZeros()];
        ...
        /// <param name="key"></param>
        /// <returns>Can return null or empty Span on missing key</returns>
        public static Span<byte> GetSpan(this IReadOnlyKeyValueStore db, long key) => db.GetSpan(key.MutateToBigEndianSpanWithoutLeadingZeros());
        ...
        {
            db.Remove(key.MutateToBigEndianSpanWithoutLeadingZeros());
        }
        ...
        {
            db[key.MutateToBigEndianSpanWithoutLeadingZeros()] = value;
        }
