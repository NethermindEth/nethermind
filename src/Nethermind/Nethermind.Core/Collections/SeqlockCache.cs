...
/// <summary>Default 16K sets x 2 ways = 32K entries (~2 MB).</summary>
public struct DefaultCacheSets : ICacheSets
{
    public static int SetsLog2 => 14;
}

/// <summary>64K sets x 2 ways = 128K entries (~8 MB). Intended for cross-block caches.</summary>
...
/// <c>TSets.SetsLog2</c> so all derived masks compile to immediate operands.
/// </summary>
