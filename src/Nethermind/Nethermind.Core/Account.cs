...
namespace Nethermind.Core
{
    public class Account
    {
        ...
        public bool HasCode => CodeHash != null && !CodeHash.Equals(Keccak.OfAnEmptyString);

        public bool HasStorage => StorageRoot != null && !StorageRoot.Equals(Keccak.EmptyTreeHash);
