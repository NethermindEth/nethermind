...
namespace Nethermind.Core
{
    public static class ClientVersion
    {
        static ClientVersion()
        {
            ...
            Description = $"Nethermind/v1.0.0-rc23dev-{gitHash}/{RuntimeInformation.OSArchitecture}-{osDescription}/{RuntimeInformation.FrameworkDescription.Trim().Replace(".NET ", "").Replace(" ", "")}";
        }
