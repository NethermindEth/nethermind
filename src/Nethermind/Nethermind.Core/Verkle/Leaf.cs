...
public readonly struct Leaf : IEquatable<Leaf>, IComparable<Leaf>
{
    ...
    {
        return Nethermind.Core.Extensions.Bytes.BytesComparer.Compare(BytesAsSpan, other.BytesAsSpan);
    }
...
public readonly struct LeafKey:  IEquatable<LeafKey>, IComparable<LeafKey>
{
    ...
    {
        return Core.Extensions.Bytes.BytesComparer.Compare(Bytes, other.Bytes);
    }
