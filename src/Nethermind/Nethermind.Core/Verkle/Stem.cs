...
public readonly struct StemKey : IEquatable<StemKey>, IComparable<StemKey>
{
    ...
    {
        return Nethermind.Core.Extensions.Bytes.BytesComparer.Compare(Bytes, other.Bytes);
    }
...
public class Stem : IEquatable<Stem>, IComparable<Stem>
{
    ...
    {
        return Nethermind.Core.Extensions.Bytes.BytesComparer.Compare(k1?.Bytes, k2?.Bytes) > 0;
    }
