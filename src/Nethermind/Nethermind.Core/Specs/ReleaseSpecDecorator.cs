...
public class ReleaseSpecDecorator(IReleaseSpec spec) : IReleaseSpec
{
    ...
    public virtual bool IsEip7002Enabled => spec.IsEip7002Enabled;
    public virtual Address? Eip7002ContractAddress => spec.Eip7002ContractAddress;
    public virtual bool IsEip7251Enabled => spec.IsEip7251Enabled;
    public virtual Address? Eip7251ContractAddress => spec.Eip7251ContractAddress;
