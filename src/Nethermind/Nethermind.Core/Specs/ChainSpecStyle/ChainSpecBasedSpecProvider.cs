    ...
    public class ChainSpecBasedSpecProvider : ISpecProvider
    {
        ...
        private void BuildTransitions()
        {
            ...
            foreach (long releaseStartBlock in transitionBlocks)
            {
                ...
                releaseSpec.IsEip1283Enabled = (_chainSpec.Parameters.Eip1283Transition ?? 0) <= releaseStartBlock && (_chainSpec.Parameters.Eip1283DisableTransition ?? long.MaxValue) > releaseStartBlock;
