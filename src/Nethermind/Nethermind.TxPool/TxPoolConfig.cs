...
namespace Nethermind.TxPool
{
    public class TxPoolConfig : ITxPoolConfig
    {
        ...
        public bool PersistentBlobPoolEnabled { get; set; } = false;
        public int PersistentBlobPoolSize { get; set; } = 128 * 1024; // we need some limit of blob txs, but extremely high to be limitless in practice
