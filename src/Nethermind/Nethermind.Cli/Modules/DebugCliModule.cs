...
public class DebugCliModule : CliModuleBase
{
    ...
    [CliFunction("debug", "standardTraceBlockToFile")]
    public JsValue TraceBlockToFile(string hash, object options)
    {
        return NodeManager.PostJint("debug_standardTraceBlockToFile", hash, options).Result;
    }
