...
namespace Nethermind.JsonRpc
{
    public class JsonRpcRequest
    {
        ...
        /// Read it before the parameters are bound and disposed: once the backing document is gone the parsed path
        /// throws <see cref="ObjectDisposedException"/> and the raw path reads zero.
        /// </remarks>
