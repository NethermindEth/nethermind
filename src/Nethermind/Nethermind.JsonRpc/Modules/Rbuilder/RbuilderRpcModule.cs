        ...
        IDictionary<Address, AccountChange> accountDiff)
    {
        ...
        try
        {
            ...
            foreach (KeyValuePair<Address, AccountChange> kv in accountDiff)
            {
                ...
                {
                    Console.WriteLine("!!!!! SELF DESTRUCTED !!!!!");
                ...
                {
                    foreach (KeyValuePair<UInt256, ValueHash256> changedSlot in accountChange.ChangedSlots)
                    {
                        ...
                        worldState.Set(new StorageCell(address, changedSlot.Key), changedSlot.Value.ToByteArray());
                    }
                }
            }
