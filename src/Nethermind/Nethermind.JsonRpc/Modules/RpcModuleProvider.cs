...
namespace Nethermind.JsonRpc.Modules
{
    public class RpcModuleProvider : IRpcModuleProvider
    {
        ...
        public class ResolvedMethodInfo
        {
            ...
            /// <summary>Whether the method is flagged <see cref="JsonRpcMethodAttribute.IsEvmExecution"/> and is therefore admitted through <see cref="EvmExecutionGate"/>.</summary>
