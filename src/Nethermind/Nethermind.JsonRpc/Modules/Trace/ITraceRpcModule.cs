...
namespace Nethermind.JsonRpc.Modules.Trace
{
    ...
    public interface ITraceRpcModule : IRpcModule
    {
        ...
        ResultWrapper<ParityTxTraceFromReplay[]> trace_callMany((TransactionForRpc message, string[] traceTypes)[] calls, BlockParameter numberOrTag);
        ...
        [JsonRpcMethod(Description = "", IsImplemented = true, IsSharable = false)]
        ResultWrapper<ParityTxTraceFromStore[]> trace_filter(TraceFilterForRpc traceFilterForRpc);
        ...
        ResultWrapper<ParityTxTraceFromStore[]> trace_transaction([JsonRpcParameter(ExampleValue = "[\"0x203abf19610ce15bc509d4b341e907ff8c5a8287ae61186fd4da82146408c28c\"]")] Keccak txHash);
    }
}
