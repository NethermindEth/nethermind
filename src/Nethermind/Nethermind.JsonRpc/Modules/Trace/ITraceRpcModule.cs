...
namespace Nethermind.JsonRpc.Modules.Trace
{
    ...
    public interface ITraceRpcModule : IRpcModule
    {
        ...
        ResultWrapper<IEnumerable<ParityTxTraceFromStore>> trace_block([JsonRpcParameter(ExampleValue = "\"latest\"")] BlockParameter numberOrTag, ForkActivationParameter? forkActivation = null);
