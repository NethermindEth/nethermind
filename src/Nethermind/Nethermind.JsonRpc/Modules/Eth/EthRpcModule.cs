    ...
    ulong? secondsPerSlot) : IEthRpcModule
{
    ...
    public virtual Task<ResultWrapper<AccessListResultForRpc?>> eth_createAccessList(TransactionForRpc transactionCall, BlockParameter? blockParameter = null, bool optimize = true) =>
