...
namespace Nethermind.JsonRpc.Modules.Eth
{
    public class EthRpcModuleProxy : IEthRpcModule
    {
        ...
        public async Task<ResultWrapper<Commitment>> eth_sendTransaction(TransactionForRpc rpcTx)
        {
            ...
            return ResultWrapper<Commitment>.From(await _proxy.eth_sendRawTransaction(Rlp.Encode(transaction).Bytes));
        }

        public async Task<ResultWrapper<Commitment>> eth_sendRawTransaction(byte[] transaction)
            => ResultWrapper<Commitment>.From(await _proxy.eth_sendRawTransaction(Rlp.Encode(transaction).Bytes));
        ...
        public async Task<ResultWrapper<TransactionForRpc>> eth_getTransactionByHash(Commitment transactionHash)
        {
        ...
        public async Task<ResultWrapper<ReceiptForRpc>> eth_getTransactionReceipt(Commitment txHashData)
        {
        ...
        public ResultWrapper<BlockForRpc> eth_getUncleByBlockHashAndIndex(Commitment blockHashData, UInt256 positionIndex)
        {
            throw new NotSupportedException();
        }
        ...
        public ResultWrapper<bool?> eth_submitWork(byte[] nonce, Commitment headerPowHash, byte[] mixDigest)
        {
            throw new NotSupportedException();
        }
