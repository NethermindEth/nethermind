...
namespace Nethermind.JsonRpc.Modules.Eth
{
    ...
    public interface IEthRpcModule : IRpcModule
    {
        ...
        [JsonRpcMethod(IsImplemented = true,
            Description = "Returns the values of multiple storage slots for multiple accounts in a single request.",
            IsSharable = true,
        ...
        ResultWrapper<Dictionary<Address, byte[][]>> eth_getStorageValues(Dictionary<Address, UInt256[]> requests, BlockParameter? blockParameter = null);
