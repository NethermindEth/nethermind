...
namespace Nethermind.JsonRpc.Modules.Eth
{
    ...
    public interface IEthRpcModule : IRpcModule
    {
        ...
        Task<ResultWrapper<Hash256>> eth_sendTransaction([JsonRpcParameter(ExampleValue = "[{\"From\": \"0xc2208fe87805279b03c1a8a78d7ee4bfdb0e48ee\", \"Gas\":\"21000\",\"GasPrice\":\"20000000000\", \"Nonce\":\"23794\", \"To\":\"0x2d44c0e097f6cd0f514edac633d82e01280b4a5c\"}]")] RpcNethermindTransaction rpcTx);
        ...
        [JsonRpcMethod(IsImplemented = true,
            ...
            IsSharable = false,
            ExampleResponse = "0x")]
        ResultWrapper<UInt256?> eth_estimateGas([JsonRpcParameter(ExampleValue = "[\"{\"from\": \"0x0001020304050607080910111213141516171819\", \"gasPrice\": \"1048576\", \"to\": \"0x0d8775f648430679a709e98d2b0cb6250d2887ef\"}\"]")] RpcNethermindTransaction transactionCall, BlockParameter? blockParameter = null);
        ...
        ResultWrapper<RpcAccessListResult?> eth_createAccessList(
        ...
        ResultWrapper<RpcNethermindTransaction?> eth_getTransactionByHash(
        ...
        [JsonRpcMethod(IsImplemented = true,
            ...
            IsSharable = true,
            ExampleResponse = "[]")]
        ResultWrapper<RpcNethermindTransaction[]> eth_pendingTransactions();
        ...
        ResultWrapper<RpcNethermindTransaction> eth_getTransactionByBlockHashAndIndex(
        ...
        ResultWrapper<RpcNethermindTransaction> eth_getTransactionByBlockNumberAndIndex(
        ...
        ResultWrapper<ReceiptForRpc?> eth_getTransactionReceipt([JsonRpcParameter(ExampleValue = "[\"0x80757153e93d1b475e203406727b62a501187f63e23b8fa999279e219ee3be71\"]")] Hash256 txHashData);
