...
namespace Nethermind.JsonRpc.Modules.Eth
{
    ...
    public interface IEthRpcModule : IRpcModule
    {
        ...
        [JsonRpcMethod(IsImplemented = true,
            ...
            IsSharable = false,
            ExampleResponse = "0x")]
        Task<ResultWrapper<UInt256?>> eth_estimateGas([JsonRpcParameter(ExampleValue = "[\"{\"from\": \"0x0001020304050607080910111213141516171819\", \"gasPrice\": \"1048576\", \"to\": \"0x0d8775f648430679a709e98d2b0cb6250d2887ef\"}\"]")] TransactionForRpc transactionCall, BlockParameter? blockParameter = null, Dictionary<Address, AccountOverride>? stateOverride = null);
        ...
        Task<ResultWrapper<AccessListResultForRpc?>> eth_createAccessList(
