...
namespace Nethermind.JsonRpc.Modules.Web3
{
    ...
    public interface IWeb3RpcModule : IRpcModule
    {
        ...
        ResultWrapper<Commitment> web3_sha3([JsonRpcParameter(ExampleValue = "[\"0x47767638636211111a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01abc\"]")] byte[] data);
    }
}
