...
namespace Nethermind.JsonRpc.Modules.Proof
{
    ...
    public interface IProofModule : IModule
    {
        ...
        ResultWrapper<object> proof_getTransactionByHash(Keccak txHash, bool includeHeader = true);
        ...
        ResultWrapper<object> proof_getTransactionReceipt(Keccak txHash, bool includeHeader = true);
    }
}