...
namespace Nethermind.JsonRpc.Modules.Personal
{
    ...
    public interface IPersonalRpcModule : IRpcModule
    {
        ...
        ResultWrapper<string> personal_sign([JsonRpcParameter(ExampleValue = "[\"0xdeadb 3f\", \"0x9b2055d370f73ec7d8a03e965129118dc8f5bf83\"]")] byte[] message, Address address, string passphrase = null);
    }
}
