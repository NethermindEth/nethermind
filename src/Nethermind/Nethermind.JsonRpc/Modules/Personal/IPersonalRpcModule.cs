...
namespace Nethermind.JsonRpc.Modules.Personal
{
    ...
    public interface IPersonalRpcModule : IRpcModule
    {
        ...
        ResultWrapper<Signature> personal_sign([JsonRpcParameter(ExampleValue = "[\"0xdeadbeaf\", \"0x9b2055d370f73ec7d8a03e965129118dc8f5bf83\"]")] byte[] message, Address address, string passphrase = null);
    }
}
