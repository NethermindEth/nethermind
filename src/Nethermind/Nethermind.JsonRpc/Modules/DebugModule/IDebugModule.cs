...
namespace Nethermind.JsonRpc.Modules.DebugModule
{
    ...
    {
        [JsonRpcMethod(
            Description = "Retrieves a representation of tree branches on a given chain level (Nethermind specific).",
            Returns = "Object",
            IsImplemented = true,
            IsReadOnly = true)]
        ...
        [JsonRpcMethod(
            Description = "Deletes a slice of a chain from the tree on all branches (Nethermind specific).",
            Returns = "Quantity",
            IsImplemented = true,
            IsReadOnly = true)]
        ...
        [JsonRpcMethod(
            Description = "This method will attempt to run the transaction in the exact same manner as it was executed on the network. " +
            ...
            IsImplemented = true,
            IsReadOnly = true)]
        ResultWrapper<GethLikeTxTrace> debug_traceTransaction(
            Keccak transactionHash,
            GethTraceOptions options = null);
        
        [JsonRpcMethod(Description = "", IsReadOnly = true)]
        ResultWrapper<GethLikeTxTrace> debug_traceTransactionByBlockAndIndex(
        ...
        [JsonRpcMethod(
            Description = "",
            IsReadOnly = true)]
        ResultWrapper<GethLikeTxTrace> debug_traceTransactionByBlockhashAndIndex(
            Keccak blockHash,
            int txIndex,
            GethTraceOptions options = null);
        
        [JsonRpcMethod(
            Description = "Returns a full stack trace of all invoked opcodes of all transaction that were included included in this block. The parent of this block must be present or it will fail.",
            Returns = "Array",
            IsImplemented = true,
            IsReadOnly = true)]
        ResultWrapper<GethLikeTxTrace[]> debug_traceBlock(byte[] blockRlp, GethTraceOptions options = null);
        
        [JsonRpcMethod(Description = "", IsImplemented = true, IsReadOnly = true)]
        ...
        [JsonRpcMethod(
            Description = "Retrieves a block in the RLP-serialized form.",
            IsImplemented = true,
            IsReadOnly = true)]
        ...
        [JsonRpcMethod(
            Description = "Retrieves the Nethermind configuration value, e.g. JsonRpc.Enabled",
            IsImplemented = true,
            IsReadOnly = true)]
        ...
        ResultWrapper<GethLikeTxTrace> debug_traceTransactionInBlockByHash(
            byte[] blockRlp,
            Keccak transactionHash,
            GethTraceOptions options = null);
        
        [JsonRpcMethod(Description = "", IsImplemented = true, IsReadOnly = false)]
        ResultWrapper<GethLikeTxTrace> debug_traceTransactionInBlockByIndex(
            byte[] blockRlp,
            int txIndex,
            GethTraceOptions options = null);
        ...
        [JsonRpcMethod(
            Description = "Requests retrieval of receipts from the network (resync of particular range) (Nethermind specific).",
            IsImplemented = true,
            IsReadOnly = false)]
        ResultWrapper<bool> debug_refillReceipts(long startBlockNumber, long endBlockNumber);
    }
}
