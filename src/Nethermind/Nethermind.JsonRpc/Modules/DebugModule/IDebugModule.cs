...
namespace Nethermind.JsonRpc.Modules.DebugModule
{
    ...
    {
        [JsonRpcMethod(Description = "Retrieves a representation of tree branches on a given chain level (Nethermind specific).", IsImplemented = true, IsReadOnly = true)]
        ResultWrapper<ChainLevelForRpc> debug_getChainLevel(in long number);

        [JsonRpcMethod(Description = "Deletes a slice of a chain from the tree on all branches (Nethermind specific).", IsImplemented = true, IsReadOnly = true)]
        ...
        [JsonRpcMethod(Description = "Returns a full stack trace of all invoked opcodes of all transaction that were included included in this block. The parent of this block must be present or it will fail.", IsImplemented = true, IsReadOnly = true)]
