...
namespace Nethermind.JsonRpc.Modules.DebugModule
{
    public class DebugModuleFactory : ModuleFactoryBase<IDebugRpcModule>
    {
        ...
        public override IDebugRpcModule Create()
        {
            ...
            BlockProcessor.BlockValidationTransactionsExecutor transactionsExecutor = new(transactionProcessorAdapter, new WorldState(txEnv.StateProvider, txEnv.StorageProvider));
