...
public interface IDebugRpcModule : IRpcModule
{
    ...
    ResultWrapper<IReadOnlyCollection<GethLikeTxTrace>> debug_traceBlockByNumber(BlockParameter blockParameter, GethTraceOptions options = null, string? forkName = null);
