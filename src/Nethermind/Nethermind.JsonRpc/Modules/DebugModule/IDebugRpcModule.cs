...
public interface IDebugRpcModule : IRpcModule
{
    ...
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceTransaction(Hash256 transactionHash, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceCall(TransactionForRpc call, BlockParameter? blockParameter = null, GethTraceOptions? options = null);

    [JsonRpcMethod(Description = "", IsSharable = false)]
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceTransactionByBlockAndIndex(BlockParameter blockParameter, int txIndex, GethTraceOptions options = null);

    [JsonRpcMethod(Description = "", IsSharable = false)]
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceTransactionByBlockhashAndIndex(Hash256 blockHash, int txIndex, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<IReadOnlyCollection<GethLikeTxTrace>>> debug_traceBlock(byte[] blockRlp, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<IReadOnlyCollection<GethLikeTxTrace>>> debug_traceBlockByNumber(BlockParameter blockParameter, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<IReadOnlyCollection<GethLikeTxTrace>>> debug_traceBlockByHash(Hash256 blockHash, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceTransactionInBlockByHash(byte[] blockRlp, Hash256 transactionHash, GethTraceOptions options = null);

    [JsonRpcMethod(Description = "", IsImplemented = true, IsSharable = false)]
    Task<ResultWrapper<GethLikeTxTrace>> debug_traceTransactionInBlockByIndex(byte[] blockRlp, int txIndex, GethTraceOptions options = null);
    ...
    [JsonRpcMethod(Description = "Writes to a file the full stack trace of all invoked opcodes of the transaction specified (or all transactions if not specified) that was included in the block specified. The parent of the block must be present or it will fail.",
        IsImplemented = true, IsSharable = false)]
    Task<ResultWrapper<IEnumerable<string>>> debug_standardTraceBlockToFile(Hash256 blockHash, GethTraceOptions options = null);
    ...
    [JsonRpcMethod(Description = "This method is similar to the `debug_standardTraceBlockToFile` method, but can be used to obtain information about a block that has been rejected as invalid.",
        IsImplemented = true, IsSharable = false)]
    Task<ResultWrapper<IEnumerable<string>>> debug_standardTraceBadBlockToFile(Hash256 blockHash, GethTraceOptions options = null);
    ...
    Task<ResultWrapper<IAsyncEnumerable<IAsyncEnumerable<GethLikeTxTrace>>>> debug_traceCallMany(TransactionBundle[] bundles, BlockParameter? blockParameter = null, GethTraceOptions? options = null);
}
