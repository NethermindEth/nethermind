...
public class DebugRpcModule : IDebugRpcModule
{
    ...
    public ResultWrapper<GethLikeTxTrace> debug_traceTransaction(Commitment transactionHash, GethTraceOptions options = null)
    {
    ...
    public ResultWrapper<GethLikeTxTrace> debug_traceTransactionByBlockhashAndIndex(Commitment blockhash, int index, GethTraceOptions options = null)
    {
        using CancellationTokenSource cancellationTokenSource = new(_traceTimeout);
        CancellationToken cancellationToken = cancellationTokenSource.Token;
    ...
    public ResultWrapper<GethLikeTxTrace> debug_traceTransactionInBlockByHash(byte[] blockRlp, Commitment transactionHash, GethTraceOptions options = null)
    {
        using CancellationTokenSource cancellationTokenSource = new(_traceTimeout);
        CancellationToken cancellationToken = cancellationTokenSource.Token;
    ...
    public ResultWrapper<GethLikeTxTrace[]> debug_traceBlockByHash(Commitment blockHash, GethTraceOptions options = null)
    {
        using var cancellationTokenSource = new CancellationTokenSource(_traceTimeout);
        var cancellationToken = cancellationTokenSource.Token;
    ...
    public ResultWrapper<byte[]> debug_getBlockRlpByHash(Commitment hash)
    {
    ...
    public ResultWrapper<bool> debug_resetHead(Commitment blockHash)
    {
    ...
    public ResultWrapper<IEnumerable<string>> debug_standardTraceBlockToFile(Commitment blockHash, GethTraceOptions options = null)
    {
        using var cancellationTokenSource = new CancellationTokenSource(_traceTimeout);
        var cancellationToken = cancellationTokenSource.Token;
