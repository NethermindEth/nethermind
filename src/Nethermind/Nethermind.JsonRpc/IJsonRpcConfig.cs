...
public interface IJsonRpcConfig : IConfig
{
    ...
    [ConfigItem(
        Description = "The number of concurrent instances of the Trace RPC module (`trace_block`, `trace_transaction`, `trace_replay*`, etc.). Calls beyond this cap return `LimitExceeded`. Defaults to the number of logical processors.")]
