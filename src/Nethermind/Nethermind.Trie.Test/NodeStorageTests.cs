...
public class NodeStorageTests
{
    ...
    [TestCase(false, 5, "012222200000000000053333333333333333333333333333333333333333333333333333333333333333")]
    ...
    [TestCase(true, 0, "0211111111111111111111111111111111111111110000000000000000003333333333333333333333333333333333333333333333333333333333333333")]
    [TestCase(true, 1, "0211111111111111111111111111111111111111112000000000000000013333333333333333333333333333333333333333333333333333333333333333")]
    [TestCase(true, 5, "0211111111111111111111111111111111111111112222200000000000053333333333333333333333333333333333333333333333333333333333333333")]
    [TestCase(true, 10, "02111111111111111111111111111111111111111122222222220000000a3333333333333333333333333333333333333333333333333333333333333333")]
    [TestCase(true, 32, "0211111111111111111111111111111111111111112222222222222222203333333333333333333333333333333333333333333333333333333333333333")]
    ...
    public void Test_WhenReadaheadUseDifferentReadaheadOnDifferentSection(bool hasAddress, int pathLength, ReadFlags expectedReadFlags)
    {
        ...
        nodeStorage.Set(address, path, Keccak.Zero, [1]);
