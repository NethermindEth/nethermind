...
public class VisitorProgressTrackerTests
{
    ...
    {
        // Arrange
        VisitorProgressTracker tracker = new VisitorProgressTracker("Test", LimboLogs.Instance, reportingInterval: 1000);
    ...
    {
        // Arrange
        VisitorProgressTracker tracker = new VisitorProgressTracker("Test", LimboLogs.Instance, reportingInterval: 100000);
