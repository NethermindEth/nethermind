...
namespace Nethermind.Trie.Test
{
    ...
    public class TrieTests
    {
        ...
        [TestCase(96, 192, 96, 1541344441, Explicit = true)]
        [TestCase(128, 256, 128, 988091870, Explicit = true)]
        [TestCase(128, 256, 128, 2107374965, Explicit = true)]
        [TestCase(128, 256, 128, null)]
        [TestCase(4, 16, 4, 1242692908)]
        [TestCase(8, 32, 8, 1543322391, Explicit = true)]
