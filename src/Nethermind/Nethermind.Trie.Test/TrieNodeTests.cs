...
namespace Nethermind.Trie.Test
{
    ...
    public class TrieNodeTests
    {
        ...
        {
            Context ctx = new();
            Assert.That(ctx.HeavyLeaf.GetMemorySize(false), Is.EqualTo(256));
        }
        ...
        {
            Context ctx = new();
            Assert.That(ctx.TiniestLeaf.GetMemorySize(false), Is.EqualTo(192));
        }
        ...
        public void Size_of_a_branch_is_correct()
        {
            ...
            Assert.That(node.GetMemorySize(true), Is.EqualTo(4432));
