...
namespace Nethermind.Trie.Test
{
    ...
    public class TrieNodeTests
    {
        ...
        {
            Context ctx = new();
            Assert.That(ctx.HeavyLeaf.GetMemorySize(false), Is.EqualTo(264));
        }
        ...
        {
            Context ctx = new();
            Assert.That(ctx.TiniestLeaf.GetMemorySize(false), Is.EqualTo(200));
        }
        ...
        public void Size_of_a_branch_is_correct()
        {
            ...
            Assert.That(node.GetMemorySize(true), Is.EqualTo(4560));
        ...
        public void Size_of_unknown_node_is_correct()
        {
            ...
            Assert.That(trieNode.GetMemorySize(true), Is.EqualTo(352));
            Assert.That(trieNode.GetMemorySize(false), Is.EqualTo(152));
        }
        ...
        public void Branch_child_as_keccak_resolved()
        {
            ...
            trieStore.FindCachedOrUnknown(Arg.Any<Hash256>()).Returns(child);
        ...
        public void Batch_not_db_regression()
        {
            ...
            trieStore.FindCachedOrUnknown(Arg.Any<Hash256>()).Returns(new TrieNode(NodeType.Unknown, child.Keccak!));
