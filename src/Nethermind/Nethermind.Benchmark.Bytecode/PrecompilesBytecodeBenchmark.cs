...
namespace Nethermind.Benchmark.Bytecode
{
    public class PrecompilesBytecodeBenchmark
    {
        ...
        public void Setup()
        {
            Console.WriteLine("executing: " + Input.Name + " " + Bytes.ToHexString(Input.Bytecode));
            ...
            Console.WriteLine("executing: " + Bytes.ToHexString(_environment.CodeInfo.MachineCode));
        }
        ...
        public IEnumerable<BenchmarkParam> Inputs
        {
            get
            {
                ...
                foreach (string file in Directory.GetFiles($"bytecodes/precompiles", "*.json", SearchOption.TopDirectoryOnly))
                {
                    ...
                    //Console.WriteLine(jsonSerializer.Serialize(jsonInputs));
                }

                //Console.WriteLine("found " + inputs.Count.ToString() + " entries");
                //var inp = inputs.FirstOrDefault();
                //Console.WriteLine($"found: {inp.Name}, {inp.NominalGasCost}, {Bytes.ToHexString(inp.Bytecode)}");
                ...
                //        "EcRecover",
                //        "ValidKey1",
                //        Bytes.FromHexString(""),
                //        Bytes.FromHexString(""),
                //        1000
                //    ),
                //    new BenchmarkParam(
                //        "EcRecover",
                //        "ValidKey1a",
                //        Bytes.FromHexString("7F18C547E4F7B0F325AD1E56F57E26C745B09A3E503D86E00E5255FF7F715D3D1C600052601C6020527F73B1693892219D736CABA55BDB67216E485557EA6B6AF75F37096C9AA6A5A75F6040527FEEB940B1D03B21E36B0E47E79769F095FE2AB855BD91E3A38756B7D75A9C45496060526028610200608060008060015AF1"),
                //        Bytes.FromHexString(""),
                //        1000
                //    ),
                //};
