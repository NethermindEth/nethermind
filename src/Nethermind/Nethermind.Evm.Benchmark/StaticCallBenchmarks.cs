...
namespace Nethermind.Evm.Benchmark
{
    ...
    public class StaticCallBenchmarks
    {
        ...
        public void GlobalSetup()
        {
            ...
            _evmState = VmState<EthereumGasPolicy>.RentTopLevel(EthereumGasPolicy.FromLong(100_000_000L), ExecutionType.TRANSACTION, new EvmMemoryArena(), _environment, new StackAccessTracker(), _stateProvider.TakeSnapshot());
        }
