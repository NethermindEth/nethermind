...
/// only wins on wide vectors with a native vector rotate (AVX-512 vprolq); a ratio &lt; 1.0 for Batched
/// vs the Scalar baseline confirms the win. Run on x86 with and without
/// <c>DOTNET_MaxVectorTBitwidth=512</c> to compare lanes=4 (AVX2/AVX-512VL) vs lanes=8 (AVX-512).
/// </summary>
