...
public class RecordedBalStoreTests
{
    ...
    public void InsertAndGet_RoundTrip()
    {
        ...
        try
        {
            RecordedBalStore store = new(dir, new BalRecorderConfig { ReplayEnabled = true, RecordingEnabled = true });
    ...
    {
        RecordedBalStore store = new(TempDir(), new BalRecorderConfig { ReplayEnabled = true, RecordingEnabled = true });
