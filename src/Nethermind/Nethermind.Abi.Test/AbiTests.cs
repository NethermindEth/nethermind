...
namespace Nethermind.Abi.Test
{
    ...
    public class AbiTests
    {
        ...
        {
            AbiType type = new AbiArray(new AbiTuple(new AbiType[]{AbiType.Address, AbiType.UInt256, AbiType.DynamicBytes, AbiType.DynamicBytes, AbiType.UInt256, AbiType.UInt256, AbiType.UInt256, AbiType.UInt256, AbiType.Address, AbiType.DynamicBytes, AbiType.Address, AbiType.DynamicBytes}));

            AbiSignature signature = new AbiSignature("handleOps", type, AbiType.Address);
            
            object[] objects = _abiEncoder.Decode(AbiEncodingStyle.IncludeSignature, signature, Bytes.FromHexString(""));

            objects.Should().HaveCount(2);
            // objects should have 12 elements, not sure how to write this test
            objects[1].GetType().Should().Be(typeof(Address));
        }
