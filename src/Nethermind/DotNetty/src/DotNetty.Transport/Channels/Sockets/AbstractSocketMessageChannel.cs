    ...
    public abstract class AbstractSocketMessageChannel : AbstractSocketChannel
    {
        ...
        protected class SocketMessageUnsafe : AbstractSocketUnsafe
        {
            ...
            public override void FinishRead(SocketChannelAsyncOperation operation)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        if (exception != null)
                        {
                            ...
                            string msg = $"Discovery error: {exception.GetType().Name} {exception.Message} {operation.Channel.Id} {operation.RemoteEndPoint} at {exception.StackTrace}";
                            pipeline.FireExceptionCaught(new IndexOutOfRangeException(msg));
                        }
                ...
                {
                    string msg = $"Discovery error: {ex.Message} {operation.Channel.Id} {operation.RemoteEndPoint}";
