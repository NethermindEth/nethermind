...
namespace Nethermind.AuRa.Test.Contract
{
    public class TxPriorityContractTests
    {
        ...
        public class TxPermissionContractBlockchainWithBlocksAndLocalData : TxPermissionContractBlockchainWithBlocks
        {
            ...
            protected override Task<TestBlockchain> Build(ISpecProvider specProvider = null, UInt256? initialValues = null, bool addBlockOnStart = true, bool usePrunningAndPersistenceStrategies = false)
            {
