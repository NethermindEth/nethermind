...
namespace Nethermind.AuRa.Test.Contract
{
    ...
    public class ValidatorContractTests
    {
        ...
        public void SetUp()
        {
            ...
            _readOnlyTxProcessorSource.Build(TestItem.KeccakA, TODO).Returns(new ReadOnlyTxProcessingScope(_transactionProcessor, _stateProvider, Keccak.EmptyTreeHash));
        }
