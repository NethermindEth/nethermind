...
namespace Nethermind.AuRa.Test.Contract
{
    ...
    public class ValidatorContractTests
    {
        ...
        public void SetUp()
        {
            ...
            _readOnlyTxProcessorSource.Build(TestItem.KeccakA).Returns(new ReadOnlyTxProcessingScope(_codeInfoRepository, _transactionProcessor, _stateProvider, Keccak.EmptyTreeHash));
        }
