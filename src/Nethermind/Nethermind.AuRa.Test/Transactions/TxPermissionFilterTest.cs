...
public class TxPermissionFilterTest
{
    ...
    public bool allows_transactions_before_transitions(long blockNumber)
    {
        VersionedTransactionPermissionContract transactionPermissionContract = new(AbiEncoder.Instance,
            TestItem.AddressA,
            5,
            Substitute.For<IReadOnlyTxProcessorSource>(), new ConcurrentLruCache<ValueHash256, UInt256>(100, "TestCache"),
            LimboLogs.Instance,
    ...
    public class TestTxPermissionsBlockchain : TestContractBlockchain
    {
        ...
        public ConcurrentLruCache<ValueHash256, UInt256> TransactionPermissionContractVersions { get; private set; }
        ...
        protected override BlockProcessor CreateBlockProcessor()
        {
            ...
            TransactionPermissionContractVersions =
                new ConcurrentLruCache<ValueHash256, UInt256>(PermissionBasedTxFilter.Cache.MaxCacheSize, nameof(TransactionPermissionContract));
