...
public class ContractBasedValidatorTests
{
    ...
    public void SetUp()
    {
        ...
        _validatorContract = new ValidatorContract(_transactionProcessor, GnosisSpecProvider.Instance, _abiEncoder, _contractAddress, _stateProvider, _readOnlyTxProcessorSource, new Signer(0, TestItem.PrivateKeyD, LimboLogs.Instance));
    }
