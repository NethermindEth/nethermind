...
namespace Nethermind.Merge.Plugin.Test
{
    public partial class EngineModuleTests
    {
        ...
        private IEngineRpcModule CreateEngineModule(MergeTestBlockchain chain)
        {
            ...
            BeaconSync beaconSync = new(beaconPivot, chain.BlockTree, new SyncConfig(), syncProgressResolver, blockCacheService, chain.BlockValidator, chain.BlockchainProcessor, chain.LogManager);
