    ...
    public partial class EngineModuleTests
    {
        ...
        private IEngineRpcModule CreateEngineModule(MergeTestBlockchain chain)
        {
            ...
            return new EngineRpcModule(
                ...
                new ExecutePayloadV1Handler(chain.HeaderValidator, chain.BlockTree, chain.BlockchainProcessor, chain.EthSyncingInfo, new InitConfig(), chain.SpecProvider, chain.BlockPreprocessorStep, chain.LogManager),
