    ...
    public partial class EngineModuleTests
    {
        ...
        private IEngineRpcModule CreateEngineModule(MergeTestBlockchain chain, IPayloadService? mockedPayloadService = null)
        {
            ...
            BeaconBlocksQueue beaconBlocksQueue =
                new BeaconBlocksQueue(chain.PoSSwitcher, chain.BlockTree, chain.BlockProcessingQueue);
            ...
            return new EngineRpcModule(
                ...
                new ExecutePayloadV1Handler(chain.BlockValidator, chain.BlockTree, chain.BlockchainProcessor, chain.EthSyncingInfo, new InitConfig(), chain.MergeConfig, synchronizer, chain.StateDb, beaconBlocksQueue, chain.LogManager),
