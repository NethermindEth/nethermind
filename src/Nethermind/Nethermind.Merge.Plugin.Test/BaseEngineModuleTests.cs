    ...
    public class MergeTestBlockchain : TestBlockchain
    {
        ...
        protected override ContainerBuilder ConfigureContainer(ContainerBuilder builder, IConfigProvider configProvider) =>
            base.ConfigureContainer(builder, configProvider)
                ...
                .AddSingleton<IPayloadPreparationService, IBlockProducer, ITxPool, IBlockImprovementContextFactory, ITimerFactory, ILogManager, ISpecProvider, IBlocksConfig>(
                    (producer, txPool, ctxFactory, timer, logManager, specProvider, blocksConfig) =>
