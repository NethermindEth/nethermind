...
namespace Nethermind.Ssz
{
    public partial class Ssz
    {
        ...
        {
            CommitteeIndex committeeIndex = new CommitteeIndex(BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(offset, ByteLength.CommitteeIndex)));BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(offset, ByteLength.CommitteeIndex));
            offset += ByteLength.CommitteeIndex;
