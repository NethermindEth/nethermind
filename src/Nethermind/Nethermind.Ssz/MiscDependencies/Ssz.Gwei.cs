...
namespace Nethermind.Ssz
{
    public static partial class Ssz
    {
        ...
        public static void Encode(Span<byte> span, Gwei[]? value)
        {
            ...
            {
                Encode(span.Slice(i * ByteLength.Gwei, ByteLength.Gwei), value[i].Amount);    
            }
        }
        ...
        public static Gwei[] DecodeGweis(Span<byte> span)
        {
            ...
            int count = span.Length / ByteLength.Gwei;
            Gwei[] result = new Gwei[count];
            for (int i = 0; i < count; i++)
            {
                Span<byte> current = span.Slice(i * ByteLength.Gwei, ByteLength.Gwei);
