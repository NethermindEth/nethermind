...
namespace Nethermind.Facade
{
    public interface IBlockchainBridge : ILogFinder
    {
        ...
        public SimulateOutput<TTrace> Simulate<TTracer, TTrace>(BlockHeader header, SimulatePayload<TransactionWithSourceDetails> payload, CancellationToken cancellationToken) where TTracer : class, IBlockTracer<SimulateBlockResult<TTrace>>;
