...
//                 if (variable != null)
//                 {
//                     var modifiers = fieldDeclaration.Modifiers.ToFullString();
...
//                     var generatedCode = GenerateFieldCode(namespaceName, className, modifiers, fieldName, fieldType, fieldInitializer);
//                     spc.AddSource($"{className}_{fieldName}_field_generated.cs", SourceText.From(generatedCode, Encoding.UTF8));
//                 }
//             }
//         });

//     context.RegisterSourceOutput(structDeclarations, (spc, structNode) =>
//     {
//         if (structNode is StructDeclarationSyntax structDeclaration)
//         {
//             var structName = structDeclaration.Identifier.Text;
//             var namespaceName = GetNamespace(structDeclaration);
//             var generatedCode = GenerateStructCode(namespaceName, structName, structDeclaration, spc);
//             spc.AddSource($"{structName}_struct_generated.cs", SourceText.From(generatedCode, Encoding.UTF8));
//         }
//     });
...
//     private static string GenerateFieldCode(string namespaceName, string className, string modifiers, string fieldName, string fieldType, string fieldInitializer)
//     {
//         return $@"
//             namespace {namespaceName}
//             {{
//                 public partial class {className}
//                 {{
//                     {modifiers}{fieldType} G_{fieldName} {fieldInitializer};
//                 }}
//             }}
//             ";
//     }

//     private static string GenerateStructCode(string namespaceName, string structName, StructDeclarationSyntax structDeclaration, SourceProductionContext context)
//     {

//         var fieldsCode = new StringBuilder();

//         foreach (var field in structDeclaration.Members)
//         {
//             fieldsCode.AppendLine(field.ToFullString());
//         }

//         // // Add diagnostic logging to ensure fields are captured
//         // if (structDeclaration.Members.Count == 0)
//         // {
//         //     var diagnostic = Diagnostic.Create(new DiagnosticDescriptor(
//         //         "SSZGenerator001",
//         //         "No fields found",
//         //         "No fields were found in struct '{0}'",
//         //         "SSZGenerator",
//         //         DiagnosticSeverity.Warning,
//         //         isEnabledByDefault: true), structDeclaration.GetLocation(), structName);
