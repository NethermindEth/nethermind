...
namespace Nevermind.Evm.Test
{
    ...
    public class StorageProviderTests
    {
        ...
        private readonly IWorldStateProvider _stateProvider = new WorldStateProvider(new StateTree(new InMemoryDb()));
        ...
        {
            StorageProvider provider = new StorageProvider(new InMemoryDb());
