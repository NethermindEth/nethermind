...
public abstract class AmsterdamBalBlockChainValidationFixture : BlockchainTestBase
{
    ...
    protected static IEnumerable<BlockchainTest> LoadBlockChainTests(string path) =>
        new TestsSourceLoader(Constants.Strategy, path).LoadTests<BlockchainTest>();
}
...
public sealed class Push0ValidationBlockChainTests : AmsterdamBalBlockChainValidationFixture
{
    ...
    public static IEnumerable<BlockchainTest> LoadTests() =>
        LoadBlockChainTests("fixtures/blockchain_tests/for_amsterdam/shanghai/eip3855_push0");
}
...
public sealed class ReturnDataValidationBlockChainTests : AmsterdamBalBlockChainValidationFixture
{
    ...
    public static IEnumerable<BlockchainTest> LoadTests() =>
        LoadBlockChainTests("fixtures/blockchain_tests/for_amsterdam/ported_static/stReturnDataTest");
}
...
public sealed class WalletValidationBlockChainTests : AmsterdamBalBlockChainValidationFixture
{
    ...
    public static IEnumerable<BlockchainTest> LoadTests() =>
        LoadBlockChainTests("fixtures/blockchain_tests/for_amsterdam/ported_static/stWalletTest");
}
