...
IGNORED_L1S = ["sepolia-dev-0", "sepolia-devnet-2", "sepolia-devnet-3"]
...
def to_nethermind_chainspec(chain_name, l1, superchain, chain, genesis):
    ...
    nethermind = {
        ...
        "engine": {
            "Optimism": {
                "params": filter_none({
                    ...
                    "karstTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
        ...
        "params": filter_none({
            ...
            "opKarstTransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            ...
            "eip7642TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7823TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7825TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7883TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7910TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7939TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "eip7951TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
