...
def to_nethermind_chainspec(chain_name, l1, superchain, chain, genesis):
    ...
    nethermind = {
        ...
        "params": {
            ...
            "opIsthmusTransitionTimestamp": hex(lookup(config, ["hardforks", "isthmus_time"])),
            "eip2537TransitionTimestamp": hex(lookup(config, ["hardforks", "isthmus_time"])),
            "eip2935TransitionTimestamp": hex(lookup(config, ["hardforks", "isthmus_time"])),
            "eip6110TransitionTimestamp": hex(lookup(config, ["hardforks", "isthmus_time"])),
            "eip7002TransitionTimestamp": hex(lookup(config, ["hardforks", "isthmus_time"])),
