    ...
    nethermind = {
        ...
        "engine": {
            ...
            "OptimismCL": {
                ...
                "batchSubmitter": lookup(config, ["genesis", "system_config", "batcherAddress"]),
                "unsafeBlockSigner": lookup(config, ["roles", "UnsafeBlockSigner"]),
                "optimismPortalProxy": lookup(config, ["addresses", "OptimismPortalProxy"]),
                "systemConfigProxy": lookup(config, ["addresses", "SystemConfigProxy"]),
