...
internal static class Program
{
    private static int Main(string[] args)
    {
        try
        {
            ...
            ExtractionResult result = CallCreateOpcodeProfile.Extract(
                arguments.RepoRoot,
                arguments.OutputDirectory,
                arguments.LeanOutputPath);
            Console.WriteLine($"Extracted {result.OpcodeCount} opcodes, {result.SpecializationCount} closed roots, and {result.AdmissionCount} exact syntax admissions.");
