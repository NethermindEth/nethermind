...
{
    internal const string InventoryPath = SourceAdmission.PackagePath + "/Admission/COMPILER_REFERENCE_PINS.json";
    ...
    private static Dictionary<string, string> ResolveBuildInputs(string root, SourceAdmission.SourcePins pins)
    {
        ...
        foreach (string argument in new[]
        {
            ...
            "-p:Configuration=Release", "-p:EnableZkEvm=false", "-p:BuildProjectReferences=false",
