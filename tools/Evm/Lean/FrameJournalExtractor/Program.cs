...
internal static class Program
{
    private static int Main(string[] args)
    {
        try
        {
            ...
            ExtractionResult result = FrameJournalProfile.Extract(
                arguments.RepoRoot,
                arguments.OutputDirectory,
                arguments.LeanOutputPath);
            Console.WriteLine($"Validated {result.SourceCount} sources, {result.MemberCount} exact members, and {result.DependencyCount} proof dependencies.");
