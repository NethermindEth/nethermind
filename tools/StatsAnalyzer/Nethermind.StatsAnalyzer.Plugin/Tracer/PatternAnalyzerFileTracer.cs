...
public class PatternAnalyzerFileTracer : BlockTracerBase<PatternAnalyzerTxTrace, PatternAnalyzerTxTracer>
{
    ...
    public PatternAnalyzerFileTracer(int processingQueueSize, int bufferSize, PatternStatsAnalyzer patternStatsAnalyzer,
        ...
        string fileName, CancellationToken ct)
    {
        ...
        _ignore = ignore;
        _tracer = new PatternAnalyzerTxTracer(_buffer, _ignore, _bufferSize, _processingLock, _patternStatsAnalyzer, sort, ct);
    ...
    public override void EndBlockTrace()
    {
        ...
        _tracer = new PatternAnalyzerTxTracer(_buffer, _ignore, _bufferSize, _processingLock, _patternStatsAnalyzer, _sort,
            _ct);
