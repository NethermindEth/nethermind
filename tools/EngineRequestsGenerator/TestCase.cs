...
public enum TestCase
{
    ...
    [TestCaseMetadata("Modexp Pawel 4", "Modexp precompile consuming 318 gas, with base and modulo byte size equal 16 and exponent equal 2^240 - 1 (240x 1s in binary)")]
    ModexpPawel4,
