#!/bin/bash
# Start Nethermind-XDC with static peers from running geth nodes
#
# This script launches Nethermind connected to your 3 existing geth nodes
# for peer discovery and block sync.
...
echo "==================================================================="
echo "Starting Nethermind-XDC with static peers"
echo "==================================================================="
...
# Launch Nethermind with static peers
